# Scheduler card — usage & configuration

Card usage, configuration options and troubleshooting. For installation see the [main README](../README.md); for the backend (entities, services, storage format) see [integration.md](integration.md).

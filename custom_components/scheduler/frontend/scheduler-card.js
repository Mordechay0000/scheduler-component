...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=ms(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const d=r.fields[t];if(null===bs(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(d.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&d.supported_features)>0}))return!1}return!("light"==Qi(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"==t?s.filter(e=>"onoff"!=e).length:"color_temp_kelvin"!=t||s.includes("color_temp")}))});var Ca;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(Ca||(Ca={}));const Ea=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Te(i.start,t),o=void 0===i.stop?a:Te(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Te(e.start,t)>=o})})?null:Ca.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,Ca.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=ms(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?Ca.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>za(e,s,t,i)).every(([s,a])=>{var o,n;let r=bs(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const d=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!d)&&!(!Ke(e.service_data[s])&&!d)})?Ca.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},Aa=(e,t)=>{const i=Da(t);return e.callApi("POST","scheduler/add",i)},Da=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(Ta),timeslots:e.entries[0].slots.map(Ma),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},Ta=e=>{switch(e){case _e.Monday:return"mon";case _e.Tuesday:return"tue";case _e.Wednesday:return"wed";case _e.Thursday:return"thu";case _e.Friday:return"fri";case _e.Saturday:return"sat";case _e.Sunday:return"sun";case _e.Workday:return"workday";case _e.Weekend:return"weekend";default:return"daily"}},Ma=e=>({start:e.start,stop:e.stop,name:e.name,color:e.color,enforce:e.enforce,track:e.track,priority:e.priority,start_date:e.start_date,end_date:e.end_date,actions:e.actions.map(e=>Pa(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ge.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),Pa=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>Ke(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}))}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},La=(e,t,i)=>{const s={title:ns("state_badge.default.error",i),description:R`
  ...
  ha-list-item.warning, ha-list-item.warning ha-icon {
    ...
    `}_renderWizardDevices(){const e=new Set(this._wizard.entities),t=e=>{this._wizard=Object.assign(Object.assign({},this._wizard),{entities:[...new Set(e)]})},i=(e,t)=>{var i;return t||(null===(i=this.hass.states[e])||void 0===i?void 0:i.attributes.friendly_name)||e};return R`
      <div class="wizard-devices">
        ...
        <div class="field">
          ...
          <div class="member-chips">
            ${this._book.groups.map(e=>R`
            <button class="chip" @click=${()=>t([...this._wizard.entities,...e.devices])}>
              <ha-svg-icon .path=${Xs}></ha-svg-icon>${e.name}
              <span class="chip-action">
                ${this._t("group.members","{n}",String(e.devices.length))}
              </span>
    ...
    `:q}_endPicker(e,t){return R`
      ...
      />
    `}_renderWizardMoment(e){const t=this._moment(this._momentBoundary(e)),i=this._momentCaution(e),s=!!(t&&this._bandStart&&this._bandEnd&&(t<=this._bandStart||t>=this._bandEnd));return R`
      <div class="moment ${!t||s?"wrong":""}">
        <input
          class="moment-name"
          .value=${e.name}
    ...
    `}};t([le({attribute:!1})],tn.prototype,"hass",void 0),t([ce()],tn.prototype,"_params",void 0),t([ce()],tn.prototype,"_plan",void 0),t([ce()],tn.prototype,"_selected",void 0),t([ce()],tn.prototype,"_error",void 0),t([ce()],tn.prototype,"_help",void 0),t([ce()],tn.prototype,"_wizardStep",void 0),t([ce()],tn.prototype,"_offerWizard",void 0),t([ce()],tn.prototype,"_wizard",void 0),t([ce()],tn.prototype,"_wizardAdvanced",void 0),t([ce()],tn.prototype,"_history",void 0),t([ce()],tn.prototype,"_future",void 0),t([ce()],tn.prototype,"_keys",void 0),t([ce()],tn.prototype,"_book",void 0),t([ce()],tn.prototype,"_bookOpen",void 0),t([ce()],tn.prototype,"_newGroup",void 0),t([ce()],tn.prototype,"_prefs",void 0),t([ce()],tn.prototype,"_plainColours",void 0),t([ce()],tn.prototype,"_settingsOpen",void 0),t([ce()],tn.prototype,"_helpKey",void 0),t([ce()],tn.prototype,"_membersAdvanced",void 0),t([ce()],tn.prototype,"_report",void 0),t([ce()],tn.prototype,"_saved",void 0),tn=t([re("dialog-scheduler-plan")],tn);var sn=Object.freeze({__proto__:null,get DialogSchedulerPlan(){return tn}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class an extends oa{constructor(e){if(super(e),this.et=q,e.type!==sa)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===q||null==e)return this.ft=void 0,this.et=e;if(e===H)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}an.directiveName="unsafeHTML",an.resultType=1;const on=aa(an);var nn=window&&window.__assign||function(){return(nn=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)};var rn={second:45,minute:45,hour:22,day:5};const dn=(e,t,i)=>{if(i===Pe.am_pm||!i&&t.time_format===Pe.am_pm){const t=Ie(e.getHours()).am_pm;return`${Ie(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Pe.twenty_four||!i&&t.time_format===Pe.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:Le(t)}):Le(t)?dn(e,t,Pe.am_pm):dn(e,t,Pe.twenty_four)};let ln=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return bo[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Yi("ui.components.date.next_week_day",this._hass,"{weekday}",Es(e,"long",this._hass)):1==s?a=Yi("ui.components.date.tomorrow",this._hass):s>0&&(a=Es(e,"long",this._hass));let o=Yi("ui.components.time.absolute",this._hass,"{time}",dn(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Yi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Yi("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=ns("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=ns("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=nn(nn({},rn),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var d=new Date(e),l=new Date(t),c=d.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var h=12*c+d.getMonth()-l.getMonth();if(Math.round(Math.abs(h))>0)return{value:Math.round(h),unit:"month"};var u=a/604800;return{value:Math.round(u),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return R``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),R`
      ${os(this.relativeTime(this.datetime))}
    `}};t([le()],ln.prototype,"_hass",void 0),t([le()],ln.prototype,"datetime",void 0),ln=t([re("scheduler-relative-time")],ln);let cn=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return R``;const n=["off","completed"].includes(o.state),r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let d=Fa(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Qi(r.service))&&(e=r.service),e&&(d=pa(e,this.config.customize,this.hass))}const l=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return l&&(d="mdi:help"),R`
      <ha-icon
        icon="${d}"
    ...
    `}catch(e){return R`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return R`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return R`
          ...
          </div>`}return on(e)};return Ps(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>R`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_toggleEnableDisable(e){const t=e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};t([le({attribute:!1})],bn.prototype,"hass",void 0),t([le({attribute:!1})],bn.prototype,"action",void 0),t([le()],bn.prototype,"entityId",void 0),bn=t([re("scheduler-overview-action-panel")],bn);let yn=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this.spanDays=1,this._saveState=null,this._selectedSlot=null,this._undoStack=[]}render(){var e,t,i;try{const s=this.hass.states[this.schedule.entity_id];if(!s)return R``;const a=["off","completed"].includes(s.state),{entry:o,index:n}=un(this.schedule.entries,this.date),r=this.date||new Date,d=mn(o,r),l=new Date(r.getTime()+864e5),c=2===this.spanDays?un(this.schedule.entries,l):null,h=!!c&&mn(c.entry,l),u=2===this.spanDays?this.viewportWidth/2:this.viewportWidth,p=null===(e=o.slots.find(e=>e.actions.length))||void 0===e?void 0:e.actions[0];let m="mdi:calendar-clock";if(p){let e=[(null===(t=p.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Qi(p.service))&&(e=p.service),e&&(m=pa(e,this.config.customize,this.hass))}const _=p?Ms(["script","notify"].includes(Qi(p.service))?p.service:[(null===(i=p.target)||void 0===i?void 0:i.entity_id)||[]].flat()[0]||"",this.hass,this.config.customize):this.schedule.name||this.schedule.entity_id;return R`
    ...
    `}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".ruler");t&&(t.style.direction=getComputedStyle(this).direction)}};t([le({attribute:!1})],wn.prototype,"hass",void 0),t([le({attribute:!1})],wn.prototype,"now",void 0),t([le({type:Number})],wn.prototype,"zoom",void 0),t([le({type:Number})],wn.prototype,"panPx",void 0),t([le({type:Number})],wn.prototype,"minZoom",void 0),t([le({type:Number})],wn.prototype,"maxZoom",void 0),t([le({type:Number})],wn.prototype,"spanDays",void 0),t([le({attribute:!1})],wn.prototype,"dayLabels",void 0),t([ce()],wn.prototype,"_width",void 0),wn=t([re("scheduler-overview-ruler")],wn);const kn=()=>({type:ge.Or,items:[],track_changes:!1}),xn=e=>({service:Qi(e)+".turn_on",service_data:{},target:{entity_id:e}}),$n=e=>({service:Qi(e)+".turn_off",service_data:{},target:{entity_id:e}});let Sn=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this._picking=!1,this._entityId=null,this._slots=[],this._selectedSlot=null,this._saving=!1}_reset(){this._picking=!1,this._entityId=null,this._slots=[],this._selectedSlot=null}_startPicking(){this._picking=!0}_handleEntityPicked(e){var t;const i=null===(t=e.detail)||void 0===t?void 0:t.value,s=Array.isArray(i)?i[i.length-1]:i;s&&(this._entityId=s,this._picking=!1,this._slots=[{start:"00:00:00",stop:"08:00:00",actions:[$n(s)],conditions:kn()},{start:"08:00:00",stop:"16:00:00",actions:[xn(s)],conditions:kn()},{start:"16:00:00",stop:"00:00:00",actions:[$n(s)],conditions:kn()}],this._selectedSlot=null)}_handleSlotsChanged(e){e.stopPropagation(),this._slots=e.detail.slots}_handleSlotSelected(e){e.stopPropagation(),this._selectedSlot=e.detail.index}_handleActionChanged(e){const t=this._selectedSlot;null!==t&&(this._slots=Object.assign([...this._slots],{[t]:Object.assign(Object.assign({},this._slots[t]),{actions:[e.detail.action]})}))}async _save(){if(!this._slots.length)return;this._saving=!0;const e={entries:[{weekdays:[_e.Daily],slots:this._slots}],repeat_type:ye.Repeat,next_entries:[],timestamps:[],enabled:!0};try{await Aa(this.hass,e),this._reset()}catch(e){La(e,this,this.hass)}finally{this._saving=!1}}render(){var e,t;if(!this.hass)return R``;const i=this._selectedSlot;return R`
      <div class="row">
        <div class="device">
    ...
    `}};t([le({attribute:!1})],Sn.prototype,"hass",void 0),t([le({attribute:!1})],Sn.prototype,"config",void 0),t([le({type:Number})],Sn.prototype,"zoom",void 0),t([le({type:Number})],Sn.prototype,"panPx",void 0),t([le({type:Number})],Sn.prototype,"viewportWidth",void 0),t([le({type:Boolean})],Sn.prototype,"editable",void 0),t([ce()],Sn.prototype,"_picking",void 0),t([ce()],Sn.prototype,"_entityId",void 0),t([ce()],Sn.prototype,"_slots",void 0),t([ce()],Sn.prototype,"_selectedSlot",void 0),t([ce()],Sn.prototype,"_saving",void 0),Sn=t([re("scheduler-overview-add-row")],Sn);let jn=class extends oe{constructor(){super(...arguments),this.date=new Date,this.spanDays=1}_select(e){this.dispatchEvent(new CustomEvent("date-changed",{detail:{date:e},bubbles:!0,composed:!0}))}_toggleSpan(){this.dispatchEvent(new CustomEvent("span-changed",{detail:{spanDays:2===this.spanDays?1:2},bubbles:!0,composed:!0}))}render(){if(!this.hass)return R``;const e=new Date;e.setHours(0,0,0,0);const t=As(this.hass),i=(e.getDay()-t+7)%7,s=new Date(e.getTime()-864e5*i),a=Array.from({length:7},(e,t)=>new Date(s.getTime()+864e5*t)),o=new Date(this.date);return o.setHours(0,0,0,0),R`
      <div class="daybar">
        <div class="days">

...
/**
    ...
    `}};t([le({attribute:!1})],ga.prototype,"hass",void 0),t([le({type:String})],ga.prototype,"icon",void 0),t([le({type:Boolean})],ga.prototype,"useStateIcon",void 0),t([le({type:Boolean})],ga.prototype,"selectable",void 0),t([le({type:Boolean})],ga.prototype,"removable",void 0),t([le({type:Boolean})],ga.prototype,"toggleable",void 0),t([le({type:Boolean})],ga.prototype,"active",void 0),t([le({type:String})],ga.prototype,"badge",void 0),t([le({type:String})],ga.prototype,"value",void 0),t([le({type:Boolean})],ga.prototype,"disabled",void 0),ga=t([re("scheduler-chip")],ga);let va=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?R`
  ...
  `,t([le({attribute:!1})],ba.prototype,"hass",void 0),t([le()],ba.prototype,"domain",void 0),t([le()],ba.prototype,"config",void 0),t([le({type:Array})],ba.prototype,"value",void 0),t([le({type:Boolean})],ba.prototype,"multiple",void 0),t([le({type:Boolean})],ba.prototype,"disabled",void 0),t([ce()],ba.prototype,"multipleMode",void 0),t([ce()],ba.prototype,"scheduleEntities",void 0),ba=t([re("scheduler-entity-picker")],ba);let ya=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return R`
      <div
    ...
    `}};t([le()],wa.prototype,"disabled",void 0),t([ce()],wa.prototype,"_openedItem",void 0),t([ce()],wa.prototype,"_numItems",void 0),wa=t([re("scheduler-collapsible-group")],wa);const ka="__NONE_OPTION__";let xa=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),Rs(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return R`
        ...
        `)},l=e=>{let t=e.target,i=t.querySelector("ha-picker-field");this.style.setProperty("--select-menu-width",i.offsetWidth+"px"),t.classList.add("opened")},c=e=>{e.target.classList.remove("opened")},h=e=>{const t=e.detail.item.value;(t!=ka&&!Array.isArray(this.value)||(e.target.value=void 0,t!=ka))&&this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))},u=()=>{this._valueChanged(new CustomEvent("value-changed",{detail:{value:void 0}}))},p=Ke(this.value)&&!Array.isArray(this.value)?n.find(e=>e.id===this.value):void 0,m=p?p.primary||p.id:Ke(this.value)&&!Array.isArray(this.value)?this.value:void 0;return R`
      ...
      `}return R``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t]}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;Rs(this,"value-changed",{value:this.value})}};xa.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
        ...
        <div class="column">
          <ha-formfield label="${Yi("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",this.hass)}">
            <ha-checkbox
              ...
              ?checked=${[(null===(a=this._config.display_options)||void 0===a?void 0:a.secondary_info)||Be].flat().includes("relative-time")}
            >
            </ha-checkbox>
          </ha-formfield>
          ...
          <ha-formfield label="${Yi("ui.panel.card_editor.fields.display_format_secondary.options.time",this.hass)}">
            <ha-checkbox
              value="time"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(o=this._config.display_options)||void 0===o?void 0:o.secondary_info)||Be].flat().includes("time")}
            >
            </ha-checkbox>
          </ha-formfield>
        ...
        <div class="column">
          <ha-formfield label="${Yi("ui.panel.card_editor.fields.display_format_secondary.options.days",this.hass)}">
            <ha-checkbox
              value="days"
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(n=this._config.display_options)||void 0===n?void 0:n.secondary_info)||Be].flat().includes("days")}
            >
            </ha-checkbox>
          </ha-formfield>
          ...
          <ha-formfield label="${Yi("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",this.hass)}">
            <ha-checkbox
              ...
              @change=${this._setDisplayOptionsSecondary}
              ?checked=${[(null===(r=this._config.display_options)||void 0===r?void 0:r.secondary_info)||Be].flat().includes("additional-tasks")}
            >
            </ha-checkbox>
          </ha-formfield>
        </div>
...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=ms(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const d=r.fields[t];if(null===bs(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(d.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&d.supported_features)>0}))return!1}return!("light"==Qi(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"==t?s.filter(e=>"onoff"!=e).length:"color_temp_kelvin"!=t||s.includes("color_temp")}))});var Oa;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(Oa||(Oa={}));const za=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Te(i.start,t),o=void 0===i.stop?a:Te(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Te(e.start,t)>=o})})?null:Oa.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,Oa.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=ms(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?Oa.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>ja(e,s,t,i)).every(([s,a])=>{var o,n;let r=bs(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const d=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!d)&&!(!Ke(e.service_data[s])&&!d)})?Oa.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},Ca=(e,t)=>{const i=Ea(t);return e.callApi("POST","scheduler/add",i)},Ea=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(Da),timeslots:e.entries[0].slots.map(Aa),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},Da=e=>{switch(e){case _e.Monday:return"mon";case _e.Tuesday:return"tue";case _e.Wednesday:return"wed";case _e.Thursday:return"thu";case _e.Friday:return"fri";case _e.Saturday:return"sat";case _e.Sunday:return"sun";case _e.Workday:return"workday";case _e.Weekend:return"weekend";default:return"daily"}},Aa=e=>({start:e.start,stop:e.stop,name:e.name,color:e.color,enforce:e.enforce,track:e.track,priority:e.priority,start_date:e.start_date,end_date:e.end_date,actions:e.actions.map(e=>Ta(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ge.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),Ta=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>Ke(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}))}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},Ma=(e,t,i)=>{const s={title:ns("state_badge.default.error",i),description:R`
  ...
  `,primaryButtonLabel:ns("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};Rs(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return jo})),dialogParams:s})},La=(e,t)=>e.callApi("POST","scheduler/remove",{schedule_id:t}),Pa=(e,t)=>{const i=Ea(t);return e.callApi("POST","scheduler/edit",i)},Na=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},Ia=e=>JSON.stringify(Object.fromEntries(Object.entries(e||{}).sort(([e],[t])=>e.localeCompare(t)))),Ra=(e,t)=>e.length===t.length&&e.every((e,i)=>{const s=t[i];return e.service===s.service&&Ia(e.service_data)===Ia(s.service_data)&&Ia(e.target)===Ia(s.target)}),Ha=e=>{const t=[];for(const i of e){const e=t[t.length-1];e&&void 0!==e.stop&&Ra(e.actions,i.actions)&&JSON.stringify(e.conditions)===JSON.stringify(i.conditions)?t[t.length-1]=Object.assign(Object.assign({},e),{stop:i.stop}):t.push(i)}return t},qa=(e,t)=>{const i=ms(e,t),s=Qi(e.service),a=Ji(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(fs).includes(s)&&Object.keys(fs[s].services).includes(a)){if(void 0!==fs[s].attributes){let t=fs[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return fs[s].services[a]}return Object.keys(fs).includes(s)&&Object.keys(fs[s].services).includes("{entity_id}")?fs[s].services["{entity_id}"]:"mdi:flash";var o},Va=e=>{var t;return"turn_off"===Ji(e.service)||"off"===(null===(t=e.service_data)||void 0===t?void 0:t.state)},Ba=e=>{var t;return"turn_on"===Ji(e.service)||"on"===(null===(t=e.service_data)||void 0===t?void 0:t.state)},Fa=e=>{const t=Ji(e.service);if("turn_on"!==t&&"turn_off"!==t)return null;const i=e.service.split(".")[0];return Object.assign({service:`${i}.${"turn_on"===t?"turn_off":"turn_on"}`,service_data:{}},e.target?{target:e.target}:{})},Ua=(e,t,i)=>{let s=Te("string"==typeof e?Ae(e):e,i),a=Te("string"==typeof t?Ae(t):t,i);return a>s?1:a<s?-1:0},Wa=e=>Ae(e.start),Za=e=>{if(Ke(e.stop)){const t=Ae(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==we.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Ce(Wa(e),{minutes:1})},Ka=(e,t,i,s)=>{let a=t;if(Ke(i.stop))return[e,a]=Ka(e,t+1,{start:i.stop},s),[e,a-1];if(!Ke(i.start))return[e,a];let o=Wa(e[t]),n=i.start,r=Wa(e[t]);for(let i=t-1;i>=0;i--){if(e[i].actions.length){r=i==t-1?Ce(Wa(e[i]),{minutes:1}):Za(e[i]);break}r=Wa(e[i])}let d=Ce(Za(e[t]),{minutes:-1});if(!Ke(e[t].stop))for(let i=t+1;i<e.length;i++){if(e[i].actions.length){d=i==t+1?Ce(Za(e[i]),{minutes:-1}):Wa(e[i]);break}d=Za(e[i])}if(Ua(r,n,s)<0&&(n=r),Ua(d,n,s)>0&&Te(d,s)>0&&(n=d),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:He(n)})}),Ua(o,n,s)<=0)for(let i=t-1;i>=0;i--){let t=Ua(Wa(e[i]),n,s),o=Ua(Za(e[i]),n,s);if(t>0&&o<=0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:He(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}if(Ua(o,n,s)<0&&!Ke(e[t].stop)&&(e=Ke(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:He(Za(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:He(Za(e[t])),stop:He(Wa(e[t+1])),actions:[]}),...e.slice(t+1)]),Ua(o,n,s)>=0)for(let t=a+1;t<e.length;t++){let i=Za(e[a]),o=Ua(Wa(e[t]),i,s),n=Ua(Za(e[t]),i,s);if(o>=0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:He(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}return Ua(o,n,s)>0&&(t>0&&Ke(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:He(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?He(Za(e[t-1])):"00:00:00",stop:He(n),actions:[]}),...e.slice(t)],a=t+1)),[e=e.filter(Ke),a]},Xa=e=>{const t=Math.floor(e/3600),i=Math.round((e-3600*t)/60),s={mode:we.Fixed,hours:t,minutes:i};return He(s)},Ga=(e,t,i,s)=>{const a=e.map((t,i)=>{const a=Te(t.start,s);let o;return void 0!==t.stop?(o=Te(t.stop,s),!o&&a&&(o=86400)):o=i+1<e.length&&Te(e[i+1].start,s)||86400,{start:a,stop:o}}),o=e.find((e,s)=>a[s].stop>t&&a[s].start<i)||e[0];let n=[],r=-1;return e.forEach((e,s)=>{const d=a[s];d.stop<=t?n.push(e):(-1===r&&(d.start<t&&n.push(Object.assign(Object.assign({},e),{stop:Xa(t)})),r=n.length,n.push({start:Xa(t),stop:Xa(i),actions:[],conditions:o.conditions})),d.start>=i?n.push(e):d.stop>i&&n.push(Object.assign(Object.assign({},e),{start:Xa(i)})))}),-1===r&&(r=n.length,n.push({start:Xa(t),stop:Xa(i),actions:[],conditions:o.conditions})),[n,r]},Ya=[67,160,71],Ja=e=>{if(!Ba(e))return null;const t=e.service_data||{};let i,s;var a;let o;if(Array.isArray(t.rgb_color)&&t.rgb_color.length>=3&&t.rgb_color.slice(0,3).every(e=>"number"==typeof e)&&(i=t.rgb_color.slice(0,3)),"number"==typeof t.color_temp_kelvin?s=t.color_temp_kelvin:"number"==typeof t.color_temp&&(a=t.color_temp,s=Math.round(1e6/a)),"number"==typeof t.brightness?o=t.brightness/255*100:"number"==typeof t.brightness_pct&&(o=t.brightness_pct),void 0===i&&void 0===s&&void 0===o)return null;return{rgb:void 0!==i?i:void 0!==s?(e=>{const t=Math.min(Math.max(e,1e3),12e3)/100;let i,s,a;t<=66?(i=255,s=99.4708025861*Math.log(t)-161.1195681661,a=t<=19?0:138.5177312231*Math.log(t-10)-305.0447927307):(i=329.698727446*Math.pow(t-60,-.1332047592),s=288.1221695283*Math.pow(t-60,-.0755148492),a=255);const o=e=>Math.round(Math.min(Math.max(e,0),255));return[o(i),o(s),o(a)]})(s):Ya,alpha:void 0!==o?.25+.6*Math.min(Math.max(o,0),100)/100:.75}},Qa=(e,t)=>{if(!e)return[];const i=[1,2,3,4,6,8,12],s=t?88:56;let a=Math.ceil(24/(e/s));for(;!i.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let i=a/24*100;return i=Math.floor(100*i)/100,0!==t&&t!==o.length-1||(i/=2),{hour:e,widthPct:i,align:0===t?"left":t===o.length-1?"right":"center"}})},eo=(e,t,i,s=3,a=5)=>{const o=i-(e.length-1)*s,n=e.map((i,s)=>{const a=Te(i.start,t);let o;if(void 0!==i.stop)o=Te(i.stop,t),!o&&a&&(o=86400);else{const i=e[s+1];o=i&&Te(i.start,t)||86400}return(o-a)/86400}),r=a/o,d=o-n.filter(e=>e<r).length*a;return n.map(e=>e<r?a:e*d)},to=(e,t,i,s=3,a=null)=>{const o=t=>null!==a&&e[a]===t?"pending":t.actions.length?Va(t.actions[0])?"off":Ba(t.actions[0])?"on":"":"empty",n=e=>{const t=e.actions.length?Ja(e.actions[0]):null;return t?`rgba(${t.rgb.join(", ")}, ${t.alpha})`:void 0},r=[];let d=0;e.forEach((a,l)=>{0===l&&r.push({position:d,label:He(Ae(a.start),{seconds:!1,am_pm:i}),align:"start",state:o(a),color:n(a)});const c=d+t[l],h=l===e.length-1;void 0!==a.stop&&r.push({position:c,label:He(Ae(a.stop),{seconds:!1,am_pm:i}),align:h?"end":"middle",state:o(h?a:e[l+1]),color:n(h?a:e[l+1])}),d=c+(h?0:s)});const l=[],c=r.map(e=>{const t=7*e.label.length+6;const i="end"===e.align?e.position-t:e.position-t/2,s="start"===e.align?e.position+t:e.position+t/2;let a=l.findIndex(e=>i>e);return-1===a&&(a=l.length),l[a]=s,a}),h=c.reduce((e,t)=>Math.max(e,t),0);return{boundaries:r.map((e,t)=>Object.assign(Object.assign({},e),{tier:c[t]})),maxTier:h}},io=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Ee({hours:n,minutes:r})},so=(e,t)=>{const i=Math.floor(e/3600),s=Math.round((e-3600*i)/60);return He({mode:we.Fixed,hours:i,minutes:s},{seconds:!1,am_pm:t})};let ao=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this._width=0,this._zoom=1,this._panPx=0,this.pendingSlot=null,this._suppressNextClick=!1,this._undoStack=[],this.large=!1,this._handleKeyDown=e=>{const t=e.composedPath()[0],i=t instanceof HTMLElement&&(["input","textarea","select"].includes(t.tagName.toLowerCase())||t.isContentEditable);if("z"===e.key.toLowerCase()&&(e.ctrlKey||e.metaKey)&&!e.shiftKey&&!i)return e.preventDefault(),void this._undo();if("Delete"!==e.key&&"Backspace"!==e.key)return;if(null===this.selectedSlot||!this.schedule)return;if(i)return;if(null!==this.pendingSlot&&this.selectedSlot===this.pendingSlot)return e.preventDefault(),this._revertPendingSlot(null),this.selectedSlot=null,void this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:null}}));const s=this.schedule.slots;if(s.length<=2)return;e.preventDefault(),this._pushUndo();const a=this.selectedSlot,o=a===s.length-1?a-1:a;let n=[...s.slice(0,o),Object.assign(Object.assign({},s[o+1]),{start:s[o].start,stop:s[o+1].stop}),...s.slice(o+2)];n=Ha(n),this.schedule=Object.assign(Object.assign({},this.schedule),{slots:n}),this.selectedSlot=null,this.dispatchEvent(new CustomEvent("update",{detail:{slots:n}})),this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:null}}))}}_pushUndo(){this.schedule&&this._undoStack.push(this.schedule.slots),this._undoStack.length>50&&this._undoStack.shift()}_undo(){const e=this._undoStack.pop();e&&this.schedule&&(this.schedule=Object.assign(Object.assign({},this.schedule),{slots:e}),this.pendingSlot=null,this._slotsBackup=void 0,this.dispatchEvent(new CustomEvent("update",{detail:{slots:e}})))}get _contentWidth(){return this._width*this._zoom}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e!==this._width&&(this._width=e,this._panPx=this._clampPan(this._panPx,this._zoom))}}),this._resizeObserver.observe(this),window.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect(),this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame),window.removeEventListener("keydown",this._handleKeyDown)}_clampPan(e,t){const i=Math.max(0,this._width*t-this._width);return Math.min(Math.max(e,0),i)}_setZoom(e,t){const i=Math.min(Math.max(e,1),48),s=this._width*this._zoom,a=this._panPx+t,o=(s>0?a/s:0)*(this._width*i)-t;this._zoom=i,this._panPx=this._clampPan(o,i)}_animateZoomBy(e,t){this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame);const i=this._zoom,s=Math.min(Math.max(i*e,1),48),a=performance.now(),o=e=>{const n=Math.min((e-a)/220,1),r=1-Math.pow(1-n,3),d=i+(s-i)*r;this._setZoom(d,t),this._zoomAnimationFrame=n<1?requestAnimationFrame(o):void 0};this._zoomAnimationFrame=requestAnimationFrame(o)}_handleZoomInClick(){this._animateZoomBy(3,this._width/2)}_handleZoomOutClick(){this._animateZoomBy(1/3,this._width/2)}_handleZoomResetClick(){this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame);const e=this._zoom,t=this._panPx,i=performance.now(),s=a=>{const o=Math.min((a-i)/220,1),n=1-Math.pow(1-o,3);this._zoom=e+(1-e)*n,this._panPx=t+(0-t)*n,this._zoomAnimationFrame=o<1?requestAnimationFrame(s):void 0};this._zoomAnimationFrame=requestAnimationFrame(s)}_handleWheel(e){if(!this._width)return;const t=e.ctrlKey||e.metaKey||Math.abs(e.deltaY)>=Math.abs(e.deltaX);e.preventDefault();const i=e.currentTarget.getBoundingClientRect(),s=e.clientX-i.left;if(t){this._zoomAnimationFrame&&(cancelAnimationFrame(this._zoomAnimationFrame),this._zoomAnimationFrame=void 0);const t=Math.pow(2,-e.deltaY/60);this._setZoom(this._zoom*t,s)}else this._panPx=this._clampPan(this._panPx+e.deltaX,this._zoom)}_handleRulerPanStart(e){this._zoom<=1||(e.currentTarget.setPointerCapture(e.pointerId),this._panDrag={pointerId:e.pointerId,startX:e.clientX,startPanPx:this._panPx})}_handleRulerPanMove(e){if(!this._panDrag||this._panDrag.pointerId!==e.pointerId)return;const t=e.clientX-this._panDrag.startX;this._panPx=this._clampPan(this._panDrag.startPanPx-t,this._zoom)}_handleRulerPanEnd(){this._panDrag=void 0}_touchDistance(e){const t=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.hypot(t,i)}_handlePinchStart(e){if(2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect(),i=(e.touches[0].clientX+e.touches[1].clientX)/2-t.left;this._pinch={distance:this._touchDistance(e.touches),midpointX:i,panPx:this._panPx,zoom:this._zoom}}_handlePinchMove(e){if(!this._pinch||2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect(),i=(e.touches[0].clientX+e.touches[1].clientX)/2-t.left,s=this._touchDistance(e.touches)/this._pinch.distance,a=Math.min(Math.max(this._pinch.zoom*s,1),48),o=this._width*this._pinch.zoom,n=this._pinch.panPx+this._pinch.midpointX,r=(o>0?n/o:0)*(this._width*a)-i,d=-(i-this._pinch.midpointX);this._zoom=a,this._panPx=this._clampPan(r+d,a)}_handlePinchEnd(e){e.touches.length<2&&(this._pinch=void 0)}get _dragStepSize(){return this._zoom>=4?1:this.config.time_step||15}_clientXToTs(e,t=!0){const i=this.shadowRoot.querySelector(".bar").getBoundingClientRect();let s="rtl"===getComputedStyle(this).direction?i.right-e:e-i.left;s<0&&(s=0),s>i.width&&(s=i.width);let a=Math.round(s/i.width*86400);if(t){const e=60*this._dragStepSize;a=Math.round(a/e)*e}return a}_handleCreateDragStart(e){if(0!==e.button)return;const t=e.target.closest(".slot");if(!t)return;if(this._pinch)return;if("touch"===e.pointerType){const t=performance.now(),i=void 0!==this._lastBarTap&&t-this._lastBarTap.time<400&&Math.abs(e.clientX-this._lastBarTap.x)<50;if(this._lastBarTap={time:t,x:e.clientX},!i)return void this._startBarPan(e)}else{const i=performance.now(),s=void 0!==this._lastBarClick&&i-this._lastBarClick.time<400&&Math.abs(e.clientX-this._lastBarClick.x)<10;if(this._lastBarClick={time:i,x:e.clientX},!s)return void this._startBodyResizeDrag(e,t)}this._createDrag={startClientX:e.clientX,ts0:this._clientXToTs(e.clientX),active:!1};const i=e=>{if(!this._createDrag)return;if(this._pinch)return this._createDrag=void 0,void(this._createRange=void 0);if(!this._createDrag.active&&Math.abs(e.clientX-this._createDrag.startClientX)<5)return;this._createDrag.active=!0;const t=this._clientXToTs(e.clientX),i=Math.min(this._createDrag.ts0,t),s=Math.max(this._createDrag.ts0,t);this._createRange={ts0:i,ts1:s}},s=()=>{window.removeEventListener("pointermove",i),window.removeEventListener("pointerup",s),window.removeEventListener("pointercancel",s);const e=this._createDrag;this._createDrag=void 0;const t=this._createRange;if(this._createRange=void 0,!(null==e?void 0:e.active)||!t)return;this._suppressNextClick=!0;const a=60*this._dragStepSize;t.ts1-t.ts0<a||this._commitCreate(t.ts0,t.ts1)};window.addEventListener("pointermove",i),window.addEventListener("pointerup",s),window.addEventListener("pointercancel",s)}_startBarPan(e){const t=e.clientX,i=this._panPx;let s=!1;const a=e=>{if(this._pinch)return;const a=e.clientX-t;!s&&Math.abs(a)<5||(s=!0,this._panPx=this._clampPan(i-a,this._zoom))},o=()=>{window.removeEventListener("pointermove",a),window.removeEventListener("pointerup",o),window.removeEventListener("pointercancel",o),s&&(this._suppressNextClick=!0)};window.addEventListener("pointermove",a),window.addEventListener("pointerup",o),window.addEventListener("pointercancel",o)}_commitCreate(e,t){const i=[...this.schedule.slots];this._pushUndo();let[s,a]=Ga(i,e,t,this.hass);const o=[s[a-1],s[a+1]].find(e=>{var t;return(null===(t=null==e?void 0:e.actions)||void 0===t?void 0:t.length)&&null!==Fa(e.actions[0])}),n=o?Fa(o.actions[0]):null;n?(s=Object.assign([...s],{[a]:Object.assign(Object.assign({},s[a]),{actions:[n]})}),this.pendingSlot=null,this._slotsBackup=void 0):(this._slotsBackup=null!==this.pendingSlot&&this._slotsBackup?this._slotsBackup:i,this.pendingSlot=a),this.selectedSlot=a,this.schedule=Object.assign(Object.assign({},this.schedule),{slots:s}),this.dispatchEvent(new CustomEvent("update",{detail:{slots:s}})),this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:a}}))}_revertPendingSlot(e){const t=this._slotsBackup;let i=null;if(null!==e&&this.schedule.slots[e]){const s=Te(this.schedule.slots[e].start,this.hass);i=t.findIndex((e,i)=>{const a=Te(e.start,this.hass);let o=void 0!==e.stop?Te(e.stop,this.hass)||86400:i+1<t.length?Te(t[i+1].start,this.hass):86400;return s>=a&&s<o}),-1===i&&(i=null)}return this.pendingSlot=null,this._slotsBackup=void 0,this.schedule=Object.assign(Object.assign({},this.schedule),{slots:t}),this.dispatchEvent(new CustomEvent("update",{detail:{slots:t}})),i}willUpdate(){var e,t,i;null!==this.pendingSlot&&((null===(i=null===(t=null===(e=this.schedule)||void 0===e?void 0:e.slots[this.pendingSlot])||void 0===t?void 0:t.actions)||void 0===i?void 0:i.length)||0)>0&&(this.pendingSlot=null,this._slotsBackup=void 0)}render(){const e=Math.round(100*this._zoom),t=getComputedStyle(this).direction;return R`
    ...
    `}renderTimebar(){const e=Pe(this.hass.locale);return Qa(this._contentWidth,e).map(t=>{const i={mode:we.Fixed,hours:t.hour,minutes:0},s=He(i,{seconds:!1,am_pm:e}),a="left"===t.align?"left":"right"===t.align?"right":"";return R`
        <span class="${a}" style=${aa({width:t.widthPct+"%"})}>${s}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{const a=i.actions.length?Os(i.actions[0],this.hass,this.config.customize,!0,!0):"",o=5*a.length+10,n=s>0?15:0,r=s<e.length-1?15:0,d=t[s]-n-r,l=e[s+1],c=i.actions.length?Va(i.actions[0])?"off":Ba(i.actions[0])?"on":"":"",h=i.actions.length?Ja(i.actions[0]):null,u=h?{background:`rgba(${h.rgb.join(", ")}, ${h.alpha})`,border:this.selectedSlot==s?"3px solid rgb(var(--rgb-state-active-color, 67, 160, 71))":"2px solid rgba(var(--rgb-state-active-color, 67, 160, 71), 0.9)"}:{};return R`
        <div
        ...
        >
          ${i.stop,""}
          ${i.actions.length?a&&(d>o/3||d>50)&&d>30?R`<span style="margin-inline-start: ${n}px; margin-inline-end: ${r}px">${a}</span>`:d>16?R`<ha-icon icon="${qa(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
        ...
        `:""}
      `})}renderCreateOverlay(){if(!this._createRange)return"";const{ts0:e,ts1:t}=this._createRange,i=e/86400*this._contentWidth,s=(t-e)/86400*this._contentWidth,a=Pe(this.hass.locale),o=`${so(e,a)} - ${so(t,a)}`;return R`
      <div
    ...
    `}renderBoundaries(){if(!this._width)return R``;const e=this.schedule.slots,t=this.computeSlotWidths(),i=Pe(this.hass.locale),{boundaries:s,maxTier:a}=to(e,t,i,3,this.pendingSlot),o="rtl"===getComputedStyle(this).direction?"50%":"-50%";return R`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return q;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=oo(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return R`
        <div class="mode">
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Ie(this.hours).am_pm;const t=Ie(this.hours).hours;this.hours=Re(t,"AM"==e?Ne.PM:Ne.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return R`
      ...
      `:q}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const s=io({hours:this.hours,minutes:this.minutes},t),a=io({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||(Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset),d=r==we.Sunrise?s:a;return{mode:r,hours:d.hours,minutes:d.minutes}}{let e=this.mode==we.Sunrise?Ae(t):Ae(i);return e=Ce(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Ie(this.hours).am_pm;t=Re(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.detail.value;if(Ie(this.hours).am_pm==t)return;const i=Ie(this.hours).hours;this.hours=Re(i,"AM"==t?Ne.AM:Ne.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Ce(t,e),e.minutes&&(t=Ee(t,this.stepSize)),this.mode!=we.Fixed&&(t=oo(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};Rs(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==we.Fixed?Ie(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};no.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([le({attribute:!1})],no.prototype,"hass",void 0),t([ce()],no.prototype,"hours",void 0),t([ce()],no.prototype,"minutes",void 0),t([ce()],no.prototype,"mode",void 0),t([le({type:Boolean})],no.prototype,"autoValidate",void 0),t([le({type:Boolean})],no.prototype,"required",void 0),t([le({type:Boolean})],no.prototype,"disabled",void 0),t([le({type:String})],no.prototype,"label",void 0),t([le({type:Boolean})],no.prototype,"useAmPm",void 0),t([le({type:Boolean})],no.prototype,"large",void 0),t([le({attribute:!1})],no.prototype,"stepSize",void 0),no=t([re("scheduler-time-picker")],no);let ro=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0&&this._params.weekdays.length==this.selectedWeekdays.length}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?R`
    ...
    `}toggleViewMode(){const e=this.viewMode==me.Scheme?me.Single:me.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return R``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Te(e,this.hass),s=(Te(t,this.hass)||86400)-i;return R`
      <div class="actions">
        ...
        <ha-icon-button .path=${Xs} @click=${this._removeTimeslot} ?disabled=${this.schedule.entries[this.selectedEntry].slots.length<=2}>
        </ha-icon-button> 
      </div>
    ...
    `}_renderOnOffToggle(e,t){var i,s;const a=Ba(t)?t:Fa(t),o=Va(t)?t:Fa(t),n=this.selectedSlot>0?this.schedule.entries[this.selectedEntry].slots[this.selectedSlot-1]:void 0,r=null!==e?null:(null===(i=null==n?void 0:n.actions)||void 0===i?void 0:i.length)&&Ba(n.actions[0])?"off":(null===(s=null==n?void 0:n.actions)||void 0===s?void 0:s.length)&&Va(n.actions[0])?"on":null,d=t=>{t!==e&&this._updateSlot({actions:["on"===t?a:o]})};return R`
    ...
    `}const n=ms(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Qi(o.service),d=Ke(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Ke(null===(i=null===(t=ms(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return R``;const l=Object.keys(n.fields||{}).filter(e=>ja(o,e,this.hass,this.config.customize));let c="",h=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();!h.length&&["notify","script"].includes(r)&&(h=[o.service]),h.length&&(c+=h.map(e=>Ms(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=Os(o,this.hass,this.config.customize,!1,!0);const u=null!==Fa(o);return R`
      ...
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${qa(o,this.config.customize)}"></ha-icon>
          <span>${os(c)}</span>
        </div>
  ...
  ha-list-item.warning, ha-list-item.warning ha-icon {
            ...
            <div class="report-what">
              ...
              <div class="report-devices">
                ...
                <span class="report-device ${e.state}">
                  ${e.name}
                  <b>${this._t("on"==e.state?"state.on":"state.off")}</b>
                  ${void 0!==e.brightness?R`<i>${e.brightness}%</i>`:q}
                  ${void 0!==e.kelvin?R`<i>${e.kelvin}K</i>`:q}
                  ${e.own?R`<em>${this._t("report.own")}</em>`:q}
    ...
    `}_selectedGroupEntities(){var e,t;return(null===(e=this._selectedCube())||void 0===e?void 0:e.group.entities)||(null===(t=this._plan.groups[0])||void 0===t?void 0:t.entities)||[]}async _saveGroup(e,t){try{this._book=await((e,t,i)=>e.callWS({type:"scheduler/device_book/group",group:t,devices:i}))(this.hass,e,t),this._newGroup=""}catch(e){this._reportError(e)}}async _nameDevice(e,t){try{this._book=await((e,t,i)=>e.callWS(Object.assign({type:"scheduler/device_book/device",entity_id:t},i)))(this.hass,e,t)}catch(e){this._reportError(e)}}_useGroup(e){var t;const i=this._selectedCube(),s=(null==i?void 0:i.group)||this._plan.groups[0];if(!s)return;const a=(null===(t=this._book.groups.find(t=>t.name==e))||void 0===t?void 0:t.devices)||[];this._setMembers(s,[...new Set([...s.entities,...a])])}_renderMissingAnchors(){return R`
      <div class="empty">
        ...
        <div class="empty-body">
          ${this._t("error.no_anchor_hint",["{start}","{end}"],[Do,Ao])}
        </div>
      </div>
    ...
    `}_renderHandle(e,t,i){const s=this._position(i.start);return null===s?q:R`
      <div
        ...
        @pointerup=${this._handleDragEnd}
      ></div>
    `}_cubeStyle(e){if(e.color)return`background:${e.color};color:#fff`;const t=Ja(e.action);if(t){const[e,i,s]=t.rgb;return`background:rgba(${e},${i},${s},${t.alpha})`}return""}_renderCube(e,t){const i=this._position(t.start),s=this._position(t.stop);if(null===i||null===s||s<=i)return q;const a=Va(t.action),o=this._selected==t.id;return R`
      <button
        class="cube ${a?"off":"on"} ${o?"selected":""}"
      ...
      <div class="inspector">
        <div class="inspector-head">
          ...
          <div class="inspector-actions">
            ...
            >
              <ha-svg-icon .path=${Xs}></ha-svg-icon>${ns("ui.common.delete",this.hass)}
            </button>
          </div>
        </div>
        ...
        <div class="fields">
          ...
          ${this._renderLightFields(s.action,e=>this._updateCube(i.track,s.id,{action:e}))}
          ...
          <div class="member-chips">
            ${this._book.groups.map(e=>R`
              <button class="chip" @click=${()=>this._useGroup(e.name)}>
                <ha-svg-icon .path=${Zs}></ha-svg-icon>${e.name}
              </button>`)}
          </div>`:q}
          ${i.entities.length?R`
    ...
    `:q}_renderDeviceRow(e,t,i){var s;return this._deviceRow(i,Ro(t,i),Boolean(null===(s=t.overrides)||void 0===s?void 0:s[i]),s=>this._setDeviceAction(e,t,i,s),()=>this._clearDeviceAction(e,t,i))}_deviceRow(e,t,i,s,a){var o;const n=Va(t),r=e.split(".")[0],d=e=>s(Object.assign(Object.assign({},t),e));return R`
      <div class="device-row ${i?"own":""}">
        <span class="device-label">
          <span class="device-dot ${n?"":"on"}"></span>
          ${(null===(o=this.hass.states[e])||void 0===o?void 0:o.attributes.friendly_name)||e}
          ${i?R`<button class="link" @click=${a}>
              ${this._t("override.back")}
            </button>`:R`<em class="follows">${this._t("override.follows")}</em>`}
        </span>

        <div class="segmented">
          <button class=${n?"":"active"} @click=${()=>d({service:r+".turn_on"})}>${this._t("state.on")}</button>
          <button class=${n?"active":""} @click=${()=>d({service:r+".turn_off",service_data:{}})}>${this._t("state.off")}</button>
        </div>

        ${n?q:this._renderDeviceParameters(r,t,d)}
      </div>
    `}_renderDeviceParameters(e,t,i){var s;const a=t.service_data||{},o=e=>{const t=Object.assign(Object.assign({},a),e);Object.keys(t).forEach(e=>{void 0===t[e]&&delete t[e]}),i({service_data:t})};if("light"==e){const e=null!==(s=a.brightness_pct)&&void 0!==s?s:void 0!==a.brightness?Math.round(a.brightness/255*100):void 0,t=a.color_temp_kelvin;return R`
        ...
        <label class="param">
          ...
          <span class="field-value">${void 0===e?"—":e+"°"}</span>
        </label>`}return q}_setDeviceAction(e,t,i,s){this._updateCube(e.track,t.id,{overrides:Object.assign(Object.assign({},t.overrides||{}),{[i]:s})})}_clearDeviceAction(e,t,i){const s=Object.assign({},t.overrides||{});delete s[i],this._updateCube(e.track,t.id,{overrides:Object.keys(s).length?s:void 0})}_toggleOverride(e,t,i){var s;if(null===(s=t.overrides)||void 0===s?void 0:s[i])return void this._clearDeviceAction(e,t,i);const a=Fa(Ro(t,i));a&&this._setDeviceAction(e,t,i,a)}_renderLightFields(e,t){var i;if(Va(e))return q;const s=e.service_data||{},a=null!==(i=s.brightness_pct)&&void 0!==i?i:void 0!==s.brightness?Math.round(s.brightness/255*100):void 0,o=s.color_temp_kelvin,n=i=>{const a=Object.assign(Object.assign({},s),i);Object.keys(a).forEach(e=>{void 0===a[e]&&delete a[e]}),t(Object.assign(Object.assign({},e),{service_data:a}))};return R`
      <div class="field">
    ...
    `}_renderWizardMoments(){const e=new Set(this._wizard.moments.map(e=>e.name)),t=Zo.filter(t=>!e.has(this._t("wizard.preset."+t.key)));return R`
      <div class="moment-presets">
        ${t.map(e=>R`
          <button class="chip" @click=${()=>this._addMoment(e)}>
            <ha-svg-icon .path=${Zs}></ha-svg-icon>${this._t("wizard.preset."+e.key)}
          </button>`)}
      </div>
      ...
      <button class="ghost" @click=${()=>this._addMoment()}>
        <ha-svg-icon .path=${Zs}></ha-svg-icon>${this._t("wizard.moments.add")}
      </button>
    ...
    `}_renderWizardSettings(){const e=this._wizardTimeline().inside,t=e=>e.split(".")[0],i=[{id:"",name:this._t("cube.welcome"),on:this._wizard.onAtCandleLighting,overrides:this._wizard.openingOverrides,at:this._plan.startAnchor+"+00:00:00"},...e.map(e=>({id:e.moment.id,name:e.moment.name||this._t("cube.unnamed"),on:e.moment.on,overrides:e.moment.overrides,at:e.boundary}))];return R`
      <div class="wizard-settings">
        ...
        <div class="wizard-moment">
          ...
          <div class="device-rows">
            ${this._wizard.entities.map(i=>{var s;const a=null===(s=e.overrides)||void 0===s?void 0:s[i];return this._deviceRow(i,a||((e,i)=>({service:`${t(i)}.turn_${e?"on":"off"}`,service_data:{}}))(e.on,i),Boolean(a),t=>this._setMomentDevice(e.id,i,t),()=>this._setMomentDevice(e.id,i,null))})}
          </div>
        </div>`)}
      </div>
    ...
    `}_finishWizard(){var e;const t=this._wizard,i=(null===(e=t.entities[0])||void 0===e?void 0:e.split(".")[0])||"switch",s=[{at:this._plan.startAnchor+"+00:00:00",on:t.onAtCandleLighting,name:this._t("cube.welcome"),overrides:t.openingOverrides},...this._wizardTimeline().inside.map(e=>({at:e.boundary,on:e.moment.on,name:e.moment.name||this._t("cube.unnamed"),overrides:e.moment.overrides}))],a=To(this._t("group.default")),o=s.map((e,t)=>{return{id:`${a}#${t}`,name:e.name,start:e.at,stop:t+1<s.length?s[t+1].at:this._plan.endAnchor+"+01:30:00",action:(o=e.on,{service:`${i}.turn_${o?"on":"off"}`,service_data:{}}),overrides:e.overrides,enforce:!0};var o});this._updatePlan({groups:[{track:a,name:this._t("group.default"),entities:t.entities,cubes:o}],detaches:[]}),this._selected=o[0].id,this._wizardStep=null,this._offerWizard=!1}static get styles(){return r`
      :host {
        --plan-radius: 14px;
...
/**
    ...
    `}};t([le()],on.prototype,"_hass",void 0),t([le()],on.prototype,"datetime",void 0),on=t([re("scheduler-relative-time")],on);let nn=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return R``;const n=["off","completed"].includes(o.state),r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let d=qa(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Qi(r.service))&&(e=r.service),e&&(d=ha(e,this.config.customize,this.hass))}const l=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return l&&(d="mdi:help"),R`
      ...
      >
        ...
        <div class="secondary">
        ${this.renderDisplayItem((null===(a=this.config.display_options)||void 0===a?void 0:a.secondary_info)||Be)}
        </div>
      </div>
      <div class="state">
      ...
      >
        ...
        >
          <div class="content-inner">
            ...
            <div class="bar">
              ${t.map((e,s)=>{const a=e.actions.length?Va(e.actions[0])?"off":Ba(e.actions[0])?"on":"":"empty",o=e.actions.length?Ja(e.actions[0]):null,n=t[s+1];return R`
                  <div
                  ...
                  ${s<t.length-1&&e.stop?R`
                    ...
                    >
                      <span><ha-svg-icon .path=${Gs}></ha-svg-icon></span>
                    </div>
                  `:""}
                `})}
              ${void 0!==this.now?R`
    ...
    `}render(){if(!this.hass||!this.entityId)return R``;const e=!!this.action&&Ba(this.action),t=!!this.action&&Va(this.action);return R`

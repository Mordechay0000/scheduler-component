...
/**
        ...
        <div slot="header">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              data-dialog="close"
              .label=${rs("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${Ws}
            ></ha-icon-button>
            <div slot="title">
          ...
          <ha-input
            dialogInitialFocus
            .placeholder=${rs("ui.common.search",this.hass)}
            aria-label=${rs("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&H`
                <ha-icon-button
                  ...
                  .label=${rs("ui.common.clear",this.hass)}
                  .path=${Ws}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:H``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("ha-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e,t){var i;let s=e.target;for(;"HA-LIST-ITEM"!=s.tagName;)s=s.parentElement;const a=s.getAttribute("key"),o=null===(i=this.options)||void 0===i?void 0:i.find(e=>e.key==a).entities.map(e=>e.key);this._params=t?Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=a),entities:this._params.entities.filter(e=>!(null==o?void 0:o.includes(e)))}):Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,a]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("ha-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"HA-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,s=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),s.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),s=t.getAttribute("key");this.expandedGroups.includes(s)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[s],await this.requestUpdate());const a=t.nextElementSibling,o=a.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),a.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=s)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),a.style.height=o+"px")}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>ga(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>ga(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var s,a;const o=e[i].key,n=null===(s=this._params)||void 0===s?void 0:s.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const d=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length,l=(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)});return H`
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${rs(l?"ui.components.media-browser.file_management.deselect_all":"ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
            <ha-icon-button .path="${Fs}" @click=${e=>{e.target.blur()}} class="chevron"></ha-icon-button>
          </div>
          <span>${e[i].name}</span>
      ...
      `}):H`
        <ha-list-item disabled>
          ${rs("ui.components.entity.entity-picker.no_match",this.hass)}
        </ha-list-item>
    ...
    `}};t([le({attribute:!1})],va.prototype,"hass",void 0),t([ce()],va.prototype,"_params",void 0),t([ce()],va.prototype,"_search",void 0),t([ce()],va.prototype,"_filter",void 0),t([ce()],va.prototype,"_width",void 0),t([ce()],va.prototype,"_height",void 0),t([ce()],va.prototype,"expandedGroups",void 0),t([ce()],va.prototype,"options",void 0),t([ce()],va.prototype,"scheduleEntities",void 0),va=t([re("dialog-select-entities")],va);var fa=Object.freeze({__proto__:null,get DialogSelectEntities(){return va}});let ba=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return H`
    ...
    `}renderIcon(){if(!this.icon&&!this.toggleable&&!this.useStateIcon)return q;if(this.toggleable)return H`
      ...
      `:H`
        <div class="trailing-icon" @click=${this._iconClick}>
          ...
          ${this.disabled?q:H`<ha-tooltip for="${e}">${rs("ui.common.remove",this.hass)}</ha-tooltip>`}
        </div>
    ...
    `}};t([le({attribute:!1})],ba.prototype,"hass",void 0),t([le({type:String})],ba.prototype,"icon",void 0),t([le({type:Boolean})],ba.prototype,"useStateIcon",void 0),t([le({type:Boolean})],ba.prototype,"selectable",void 0),t([le({type:Boolean})],ba.prototype,"removable",void 0),t([le({type:Boolean})],ba.prototype,"toggleable",void 0),t([le({type:Boolean})],ba.prototype,"active",void 0),t([le({type:String})],ba.prototype,"badge",void 0),t([le({type:String})],ba.prototype,"value",void 0),t([le({type:Boolean})],ba.prototype,"disabled",void 0),ba=t([re("scheduler-chip")],ba);let ya=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?H`
    ...
    `}};t([le({attribute:!1})],ya.prototype,"hass",void 0),t([le({attribute:!1})],ya.prototype,"items",void 0),t([le({attribute:!1})],ya.prototype,"value",void 0),t([le({type:Boolean})],ya.prototype,"selectable",void 0),t([le({type:Boolean})],ya.prototype,"toggleable",void 0),t([le({type:Boolean})],ya.prototype,"removable",void 0),t([le({type:Boolean})],ya.prototype,"disabled",void 0),ya=t([re("scheduler-chip-set")],ya);const wa=[{name:"primary",weight:10},{name:"secondary",weight:8}];let ka=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.devicesOnly=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?[...e].pop():"");const t=e||"",i=this.hass.states[t];if(!i)return H`
        <ha-svg-icon
          slot="start"
          .path=${Ys}
          style="margin: 0 4px"
    ...
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);return this.domain&&(e=e.filter(e=>Qi(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||Be).some(t=>is(t,e))||Object.keys(this.config.customize||{}).some(t=>is(t,e)))&&!(this.config.exclude||[]).some(t=>is(t,e)))),e=e.filter(e=>!this.scheduleEntities.includes(e)),this.devicesOnly&&(e=e.filter(e=>((e,t)=>{var i;if(!ts.includes(Qi(e)))return!1;const s=null===(i=null==t?void 0:t.entities)||void 0===i?void 0:i[e];return!s||!s.entity_category&&(!s.hidden&&"scheduler"!==s.platform)})(e,this.hass))),this.filterFunc&&(e=e.filter(e=>this.filterFunc(this.hass.states[e]))),e.map(e=>this._parseEntityItem(e))}}async firstUpdated(){this.scheduleEntities=Object.entries(await ze(this.hass)).map(([,e])=>e.entity_id),this.domain&&this.config&&!ss(this.domain,this.config)&&(this.config=Object.assign(Object.assign({},this.config),{include:[...this.config.include||[],this.domain],exclude:[...(this.config.exclude||[]).filter(e=>!e.startsWith(this.domain))]})),this._autoSelectIfSingleEntity()}updated(e){super.updated(e),e.has("domain")&&this._autoSelectIfSingleEntity()}_autoSelectIfSingleEntity(){if(this.value&&this.value.length>0)return;const e=this._filteredItems();1===e.length&&(this.value=[e[0].id],Rs(this,"value-changed",{value:this.value}))}render(){var e,t;return H`
      ${this.renderChips()}

      ${(null===(e=this.value)||void 0===e?void 0:e.length)&&!this.multipleMode&&this.multiple?q:H`

      <ha-generic-picker
        .label=${(null===(t=this.value)||void 0===t?void 0:t.length)?"":rs("ui.components.entity.entity-picker.choose_entity",this.hass)}
        .hass=${this.hass}
        .autofocus=${this.autofocus}
        .notFoundLabel=${rs("ui.components.combo-box.no_match",this.hass)}
        ...
        .searchKeys=${wa}
        .searchLabel=${rs("ui.dialogs.quick-bar.filter_placeholder",this.hass)}
  ...
  `,t([le({attribute:!1})],ka.prototype,"hass",void 0),t([le()],ka.prototype,"domain",void 0),t([le()],ka.prototype,"config",void 0),t([le({type:Array})],ka.prototype,"value",void 0),t([le({type:Boolean})],ka.prototype,"multiple",void 0),t([le({type:Boolean})],ka.prototype,"disabled",void 0),t([le({type:Boolean})],ka.prototype,"devicesOnly",void 0),t([ce()],ka.prototype,"multipleMode",void 0),t([ce()],ka.prototype,"scheduleEntities",void 0),ka=t([re("scheduler-entity-picker")],ka);let xa=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return H`
      <div
    ...
    `}};t([le()],$a.prototype,"disabled",void 0),t([ce()],$a.prototype,"_openedItem",void 0),t([ce()],$a.prototype,"_numItems",void 0),$a=t([re("scheduler-collapsible-group")],$a);const Sa="__NONE_OPTION__";let ja=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),Rs(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return H`
        ...
        `)},l=e=>{let t=e.target,i=t.querySelector("ha-picker-field");this.style.setProperty("--select-menu-width",i.offsetWidth+"px"),t.classList.add("opened")},c=e=>{e.target.classList.remove("opened")},h=e=>{const t=e.detail.item.value;(t!=Sa&&!Array.isArray(this.value)||(e.target.value=void 0,t!=Sa))&&this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))},u=()=>{this._valueChanged(new CustomEvent("value-changed",{detail:{value:void 0}}))},p=Ke(this.value)&&!Array.isArray(this.value)?n.find(e=>e.id===this.value):void 0,m=p?p.primary||p.id:Ke(this.value)&&!Array.isArray(this.value)?this.value:void 0;return H`
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!Ke(t.min)||!Ke(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),Ke(s)&&(s=gs(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=gs(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();let t=e.target.value;const i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&Ke(t.min)&&(s=Number(e)>=t.min),s&&Ke(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return H`
      ...
      `}return H``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t]}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;Rs(this,"value-changed",{value:this.value})}};ja.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([le({attribute:!1})],za.prototype,"hass",void 0),t([le()],za.prototype,"_config",void 0),t([le()],za.prototype,"title",void 0),t([le()],za.prototype,"tagOptions",void 0),t([ce()],za.prototype,"customTagValue",void 0),za=t([re("scheduler-card-editor")],za);const Oa=r`
  ha-dialog {
...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=_s(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const d=r.fields[t];if(null===ys(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(d.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&d.supported_features)>0}))return!1}return!("light"==Qi(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"==t?s.filter(e=>"onoff"!=e).length:"color_temp_kelvin"!=t||s.includes("color_temp")}))});var Ea;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(Ea||(Ea={}));const Aa=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Te(i.start,t),o=void 0===i.stop?a:Te(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Te(e.start,t)>=o})})?null:Ea.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,Ea.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=_s(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?Ea.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>Ca(e,s,t,i)).every(([s,a])=>{var o,n;let r=ys(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const d=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!d)&&!(!Ke(e.service_data[s])&&!d)})?Ea.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},Da=(e,t)=>{const i=Ta(t);return e.callApi("POST","scheduler/add",i)},Ta=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(Ma),timeslots:e.entries[0].slots.map(Pa),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},Ma=e=>{switch(e){case _e.Monday:return"mon";case _e.Tuesday:return"tue";case _e.Wednesday:return"wed";case _e.Thursday:return"thu";case _e.Friday:return"fri";case _e.Saturday:return"sat";case _e.Sunday:return"sun";case _e.Workday:return"workday";case _e.Weekend:return"weekend";default:return"daily"}},Pa=e=>({start:e.start,stop:e.stop,name:e.name,color:e.color,enforce:e.enforce,track:e.track,priority:e.priority,start_date:e.start_date,end_date:e.end_date,actions:e.actions.map(e=>La(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ge.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),La=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>Ke(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}))}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},Na=(e,t,i)=>{const s={title:rs("state_badge.default.error",i),description:H`
  ...
  `,primaryButtonLabel:rs("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};Rs(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Co})),dialogParams:s})},Ia=(e,t)=>e.callApi("POST","scheduler/remove",{schedule_id:t}),Ha=(e,t)=>{const i=Ta(t);return e.callApi("POST","scheduler/edit",i)},Ra=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},qa=e=>JSON.stringify(Object.fromEntries(Object.entries(e||{}).sort(([e],[t])=>e.localeCompare(t)))),Va=(e,t)=>e.length===t.length&&e.every((e,i)=>{const s=t[i];return e.service===s.service&&qa(e.service_data)===qa(s.service_data)&&qa(e.target)===qa(s.target)}),Fa=e=>{const t=[];for(const i of e){const e=t[t.length-1];e&&void 0!==e.stop&&Va(e.actions,i.actions)&&JSON.stringify(e.conditions)===JSON.stringify(i.conditions)?t[t.length-1]=Object.assign(Object.assign({},e),{stop:i.stop}):t.push(i)}return t},Ba=(e,t)=>{const i=_s(e,t),s=Qi(e.service),a=Ji(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(bs).includes(s)&&Object.keys(bs[s].services).includes(a)){if(void 0!==bs[s].attributes){let t=bs[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return bs[s].services[a]}return Object.keys(bs).includes(s)&&Object.keys(bs[s].services).includes("{entity_id}")?bs[s].services["{entity_id}"]:"mdi:flash";var o},Wa=e=>{var t;return"turn_off"===Ji(e.service)||"off"===(null===(t=e.service_data)||void 0===t?void 0:t.state)},Ua=e=>{var t;return"turn_on"===Ji(e.service)||"on"===(null===(t=e.service_data)||void 0===t?void 0:t.state)},Za=e=>{const t=Ji(e.service);if("turn_on"!==t&&"turn_off"!==t)return null;const i=e.service.split(".")[0];return Object.assign({service:`${i}.${"turn_on"===t?"turn_off":"turn_on"}`,service_data:{}},e.target?{target:e.target}:{})},Ka=(e,t,i)=>{let s=Te("string"==typeof e?De(e):e,i),a=Te("string"==typeof t?De(t):t,i);return a>s?1:a<s?-1:0},Xa=e=>De(e.start),Ga=e=>{if(Ke(e.stop)){const t=De(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==we.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Ce(Xa(e),{minutes:1})},Ya=(e,t,i,s)=>{let a=t;if(Ke(i.stop))return[e,a]=Ya(e,t+1,{start:i.stop},s),[e,a-1];if(!Ke(i.start))return[e,a];let o=Xa(e[t]),n=i.start,r=Xa(e[t]);for(let i=t-1;i>=0;i--){if(e[i].actions.length){r=i==t-1?Ce(Xa(e[i]),{minutes:1}):Ga(e[i]);break}r=Xa(e[i])}let d=Ce(Ga(e[t]),{minutes:-1});if(!Ke(e[t].stop))for(let i=t+1;i<e.length;i++){if(e[i].actions.length){d=i==t+1?Ce(Ga(e[i]),{minutes:-1}):Xa(e[i]);break}d=Ga(e[i])}if(Ka(r,n,s)<0&&(n=r),Ka(d,n,s)>0&&Te(d,s)>0&&(n=d),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Re(n)})}),Ka(o,n,s)<=0)for(let i=t-1;i>=0;i--){let t=Ka(Xa(e[i]),n,s),o=Ka(Ga(e[i]),n,s);if(t>0&&o<=0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:Re(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}if(Ka(o,n,s)<0&&!Ke(e[t].stop)&&(e=Ke(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:Re(Ga(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:Re(Ga(e[t])),stop:Re(Xa(e[t+1])),actions:[]}),...e.slice(t+1)]),Ka(o,n,s)>=0)for(let t=a+1;t<e.length;t++){let i=Ga(e[a]),o=Ka(Xa(e[t]),i,s),n=Ka(Ga(e[t]),i,s);if(o>=0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Re(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}return Ka(o,n,s)>0&&(t>0&&Ke(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:Re(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?Re(Ga(e[t-1])):"00:00:00",stop:Re(n),actions:[]}),...e.slice(t)],a=t+1)),[e=e.filter(Ke),a]},Ja=e=>{const t=Math.floor(e/3600),i=Math.round((e-3600*t)/60),s={mode:we.Fixed,hours:t,minutes:i};return Re(s)},Qa=(e,t,i,s)=>{const a=e.map((t,i)=>{const a=Te(t.start,s);let o;return void 0!==t.stop?(o=Te(t.stop,s),!o&&a&&(o=86400)):o=i+1<e.length&&Te(e[i+1].start,s)||86400,{start:a,stop:o}}),o=e.find((e,s)=>a[s].stop>t&&a[s].start<i)||e[0];let n=[],r=-1;return e.forEach((e,s)=>{const d=a[s];d.stop<=t?n.push(e):(-1===r&&(d.start<t&&n.push(Object.assign(Object.assign({},e),{stop:Ja(t)})),r=n.length,n.push({start:Ja(t),stop:Ja(i),actions:[],conditions:o.conditions})),d.start>=i?n.push(e):d.stop>i&&n.push(Object.assign(Object.assign({},e),{start:Ja(i)})))}),-1===r&&(r=n.length,n.push({start:Ja(t),stop:Ja(i),actions:[],conditions:o.conditions})),[n,r]},eo=[67,160,71],to=e=>{if(!Ua(e))return null;const t=e.service_data||{};let i,s;var a;let o;if(Array.isArray(t.rgb_color)&&t.rgb_color.length>=3&&t.rgb_color.slice(0,3).every(e=>"number"==typeof e)&&(i=t.rgb_color.slice(0,3)),"number"==typeof t.color_temp_kelvin?s=t.color_temp_kelvin:"number"==typeof t.color_temp&&(a=t.color_temp,s=Math.round(1e6/a)),"number"==typeof t.brightness?o=t.brightness/255*100:"number"==typeof t.brightness_pct&&(o=t.brightness_pct),void 0===i&&void 0===s&&void 0===o)return null;return{rgb:void 0!==i?i:void 0!==s?(e=>{const t=Math.min(Math.max(e,1e3),12e3)/100;let i,s,a;t<=66?(i=255,s=99.4708025861*Math.log(t)-161.1195681661,a=t<=19?0:138.5177312231*Math.log(t-10)-305.0447927307):(i=329.698727446*Math.pow(t-60,-.1332047592),s=288.1221695283*Math.pow(t-60,-.0755148492),a=255);const o=e=>Math.round(Math.min(Math.max(e,0),255));return[o(i),o(s),o(a)]})(s):eo,alpha:void 0!==o?.25+.6*Math.min(Math.max(o,0),100)/100:.75}},io=(e,t)=>{if(!e)return[];const i=[1,2,3,4,6,8,12],s=t?88:56;let a=Math.ceil(24/(e/s));for(;!i.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let i=a/24*100;return i=Math.floor(100*i)/100,0!==t&&t!==o.length-1||(i/=2),{hour:e,widthPct:i,align:0===t?"left":t===o.length-1?"right":"center"}})},so=(e,t,i,s=3,a=5)=>{const o=i-(e.length-1)*s,n=e.map((i,s)=>{const a=Te(i.start,t);let o;if(void 0!==i.stop)o=Te(i.stop,t),!o&&a&&(o=86400);else{const i=e[s+1];o=i&&Te(i.start,t)||86400}return(o-a)/86400}),r=a/o,d=o-n.filter(e=>e<r).length*a;return n.map(e=>e<r?a:e*d)},ao=(e,t,i,s=3,a=null)=>{const o=t=>null!==a&&e[a]===t?"pending":t.actions.length?Wa(t.actions[0])?"off":Ua(t.actions[0])?"on":"":"empty",n=e=>{const t=e.actions.length?to(e.actions[0]):null;return t?`rgba(${t.rgb.join(", ")}, ${t.alpha})`:void 0},r=[];let d=0;e.forEach((a,l)=>{0===l&&r.push({position:d,label:Re(De(a.start),{seconds:!1,am_pm:i}),align:"start",state:o(a),color:n(a)});const c=d+t[l],h=l===e.length-1;void 0!==a.stop&&r.push({position:c,label:Re(De(a.stop),{seconds:!1,am_pm:i}),align:h?"end":"middle",state:o(h?a:e[l+1]),color:n(h?a:e[l+1])}),d=c+(h?0:s)});const l=[],c=r.map(e=>{const t=7*e.label.length+6;const i="end"===e.align?e.position-t:e.position-t/2,s="start"===e.align?e.position+t:e.position+t/2;let a=l.findIndex(e=>i>e);return-1===a&&(a=l.length),l[a]=s,a}),h=c.reduce((e,t)=>Math.max(e,t),0);return{boundaries:r.map((e,t)=>Object.assign(Object.assign({},e),{tier:c[t]})),maxTier:h}},oo=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Ee({hours:n,minutes:r})},no=(e,t)=>{const i=Math.floor(e/3600),s=Math.round((e-3600*i)/60);return Re({mode:we.Fixed,hours:i,minutes:s},{seconds:!1,am_pm:t})};let ro=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this._width=0,this._zoom=1,this._panPx=0,this.pendingSlot=null,this._suppressNextClick=!1,this._undoStack=[],this.large=!1,this._handleKeyDown=e=>{const t=e.composedPath()[0],i=t instanceof HTMLElement&&(["input","textarea","select"].includes(t.tagName.toLowerCase())||t.isContentEditable);if("z"===e.key.toLowerCase()&&(e.ctrlKey||e.metaKey)&&!e.shiftKey&&!i)return e.preventDefault(),void this._undo();if("Delete"!==e.key&&"Backspace"!==e.key)return;if(null===this.selectedSlot||!this.schedule)return;if(i)return;if(null!==this.pendingSlot&&this.selectedSlot===this.pendingSlot)return e.preventDefault(),this._revertPendingSlot(null),this.selectedSlot=null,void this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:null}}));const s=this.schedule.slots;if(s.length<=2)return;e.preventDefault(),this._pushUndo();const a=this.selectedSlot,o=a===s.length-1?a-1:a;let n=[...s.slice(0,o),Object.assign(Object.assign({},s[o+1]),{start:s[o].start,stop:s[o+1].stop}),...s.slice(o+2)];n=Fa(n),this.schedule=Object.assign(Object.assign({},this.schedule),{slots:n}),this.selectedSlot=null,this.dispatchEvent(new CustomEvent("update",{detail:{slots:n}})),this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:null}}))}}_pushUndo(){this.schedule&&this._undoStack.push(this.schedule.slots),this._undoStack.length>50&&this._undoStack.shift()}_undo(){const e=this._undoStack.pop();e&&this.schedule&&(this.schedule=Object.assign(Object.assign({},this.schedule),{slots:e}),this.pendingSlot=null,this._slotsBackup=void 0,this.dispatchEvent(new CustomEvent("update",{detail:{slots:e}})))}get _contentWidth(){return this._width*this._zoom}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e!==this._width&&(this._width=e,this._panPx=this._clampPan(this._panPx,this._zoom))}}),this._resizeObserver.observe(this),window.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect(),this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame),window.removeEventListener("keydown",this._handleKeyDown)}_clampPan(e,t){const i=Math.max(0,this._width*t-this._width);return Math.min(Math.max(e,0),i)}_setZoom(e,t){const i=Math.min(Math.max(e,1),48),s=this._width*this._zoom,a=this._panPx+t,o=(s>0?a/s:0)*(this._width*i)-t;this._zoom=i,this._panPx=this._clampPan(o,i)}_animateZoomBy(e,t){this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame);const i=this._zoom,s=Math.min(Math.max(i*e,1),48),a=performance.now(),o=e=>{const n=Math.min((e-a)/220,1),r=1-Math.pow(1-n,3),d=i+(s-i)*r;this._setZoom(d,t),this._zoomAnimationFrame=n<1?requestAnimationFrame(o):void 0};this._zoomAnimationFrame=requestAnimationFrame(o)}_handleZoomInClick(){this._animateZoomBy(3,this._width/2)}_handleZoomOutClick(){this._animateZoomBy(1/3,this._width/2)}_handleZoomResetClick(){this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame);const e=this._zoom,t=this._panPx,i=performance.now(),s=a=>{const o=Math.min((a-i)/220,1),n=1-Math.pow(1-o,3);this._zoom=e+(1-e)*n,this._panPx=t+(0-t)*n,this._zoomAnimationFrame=o<1?requestAnimationFrame(s):void 0};this._zoomAnimationFrame=requestAnimationFrame(s)}_handleWheel(e){if(!this._width)return;const t=e.ctrlKey||e.metaKey||Math.abs(e.deltaY)>=Math.abs(e.deltaX);e.preventDefault();const i=e.currentTarget.getBoundingClientRect(),s=e.clientX-i.left;if(t){this._zoomAnimationFrame&&(cancelAnimationFrame(this._zoomAnimationFrame),this._zoomAnimationFrame=void 0);const t=Math.pow(2,-e.deltaY/60);this._setZoom(this._zoom*t,s)}else this._panPx=this._clampPan(this._panPx+e.deltaX,this._zoom)}_handleRulerPanStart(e){this._zoom<=1||(e.currentTarget.setPointerCapture(e.pointerId),this._panDrag={pointerId:e.pointerId,startX:e.clientX,startPanPx:this._panPx})}_handleRulerPanMove(e){if(!this._panDrag||this._panDrag.pointerId!==e.pointerId)return;const t=e.clientX-this._panDrag.startX;this._panPx=this._clampPan(this._panDrag.startPanPx-t,this._zoom)}_handleRulerPanEnd(){this._panDrag=void 0}_touchDistance(e){const t=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.hypot(t,i)}_handlePinchStart(e){if(2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect(),i=(e.touches[0].clientX+e.touches[1].clientX)/2-t.left;this._pinch={distance:this._touchDistance(e.touches),midpointX:i,panPx:this._panPx,zoom:this._zoom}}_handlePinchMove(e){if(!this._pinch||2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect(),i=(e.touches[0].clientX+e.touches[1].clientX)/2-t.left,s=this._touchDistance(e.touches)/this._pinch.distance,a=Math.min(Math.max(this._pinch.zoom*s,1),48),o=this._width*this._pinch.zoom,n=this._pinch.panPx+this._pinch.midpointX,r=(o>0?n/o:0)*(this._width*a)-i,d=-(i-this._pinch.midpointX);this._zoom=a,this._panPx=this._clampPan(r+d,a)}_handlePinchEnd(e){e.touches.length<2&&(this._pinch=void 0)}get _dragStepSize(){return this._zoom>=4?1:this.config.time_step||15}_clientXToTs(e,t=!0){const i=this.shadowRoot.querySelector(".bar").getBoundingClientRect();let s="rtl"===getComputedStyle(this).direction?i.right-e:e-i.left;s<0&&(s=0),s>i.width&&(s=i.width);let a=Math.round(s/i.width*86400);if(t){const e=60*this._dragStepSize;a=Math.round(a/e)*e}return a}_handleCreateDragStart(e){if(0!==e.button)return;const t=e.target.closest(".slot");if(!t)return;if(this._pinch)return;if("touch"===e.pointerType){const t=performance.now(),i=void 0!==this._lastBarTap&&t-this._lastBarTap.time<400&&Math.abs(e.clientX-this._lastBarTap.x)<50;if(this._lastBarTap={time:t,x:e.clientX},!i)return void this._startBarPan(e)}else{const i=performance.now(),s=void 0!==this._lastBarClick&&i-this._lastBarClick.time<400&&Math.abs(e.clientX-this._lastBarClick.x)<10;if(this._lastBarClick={time:i,x:e.clientX},!s)return void this._startBodyResizeDrag(e,t)}this._createDrag={startClientX:e.clientX,ts0:this._clientXToTs(e.clientX),active:!1};const i=e=>{if(!this._createDrag)return;if(this._pinch)return this._createDrag=void 0,void(this._createRange=void 0);if(!this._createDrag.active&&Math.abs(e.clientX-this._createDrag.startClientX)<5)return;this._createDrag.active=!0;const t=this._clientXToTs(e.clientX),i=Math.min(this._createDrag.ts0,t),s=Math.max(this._createDrag.ts0,t);this._createRange={ts0:i,ts1:s}},s=()=>{window.removeEventListener("pointermove",i),window.removeEventListener("pointerup",s),window.removeEventListener("pointercancel",s);const e=this._createDrag;this._createDrag=void 0;const t=this._createRange;if(this._createRange=void 0,!(null==e?void 0:e.active)||!t)return;this._suppressNextClick=!0;const a=60*this._dragStepSize;t.ts1-t.ts0<a||this._commitCreate(t.ts0,t.ts1)};window.addEventListener("pointermove",i),window.addEventListener("pointerup",s),window.addEventListener("pointercancel",s)}_startBarPan(e){const t=e.clientX,i=this._panPx;let s=!1;const a=e=>{if(this._pinch)return;const a=e.clientX-t;!s&&Math.abs(a)<5||(s=!0,this._panPx=this._clampPan(i-a,this._zoom))},o=()=>{window.removeEventListener("pointermove",a),window.removeEventListener("pointerup",o),window.removeEventListener("pointercancel",o),s&&(this._suppressNextClick=!0)};window.addEventListener("pointermove",a),window.addEventListener("pointerup",o),window.addEventListener("pointercancel",o)}_commitCreate(e,t){const i=[...this.schedule.slots];this._pushUndo();let[s,a]=Qa(i,e,t,this.hass);const o=[s[a-1],s[a+1]].find(e=>{var t;return(null===(t=null==e?void 0:e.actions)||void 0===t?void 0:t.length)&&null!==Za(e.actions[0])}),n=o?Za(o.actions[0]):null;n?(s=Object.assign([...s],{[a]:Object.assign(Object.assign({},s[a]),{actions:[n]})}),this.pendingSlot=null,this._slotsBackup=void 0):(this._slotsBackup=null!==this.pendingSlot&&this._slotsBackup?this._slotsBackup:i,this.pendingSlot=a),this.selectedSlot=a,this.schedule=Object.assign(Object.assign({},this.schedule),{slots:s}),this.dispatchEvent(new CustomEvent("update",{detail:{slots:s}})),this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:a}}))}_revertPendingSlot(e){const t=this._slotsBackup;let i=null;if(null!==e&&this.schedule.slots[e]){const s=Te(this.schedule.slots[e].start,this.hass);i=t.findIndex((e,i)=>{const a=Te(e.start,this.hass);let o=void 0!==e.stop?Te(e.stop,this.hass)||86400:i+1<t.length?Te(t[i+1].start,this.hass):86400;return s>=a&&s<o}),-1===i&&(i=null)}return this.pendingSlot=null,this._slotsBackup=void 0,this.schedule=Object.assign(Object.assign({},this.schedule),{slots:t}),this.dispatchEvent(new CustomEvent("update",{detail:{slots:t}})),i}willUpdate(){var e,t,i;null!==this.pendingSlot&&((null===(i=null===(t=null===(e=this.schedule)||void 0===e?void 0:e.slots[this.pendingSlot])||void 0===t?void 0:t.actions)||void 0===i?void 0:i.length)||0)>0&&(this.pendingSlot=null,this._slotsBackup=void 0)}render(){const e=Math.round(100*this._zoom),t=getComputedStyle(this).direction;return H`
      ...
      >
        <div
          class="zoom-content"
          style=${ra({width:this._contentWidth+"px",transform:`translateX(${-this._panPx}px)`})}
        >
          <div class="slots-wrapper" style=${ra({direction:t})}>
          ...
          <div
            class="time-bar"
            style=${ra({direction:t,cursor:this._zoom>1?"grab":"default"})}
    ...
    `}renderTimebar(){const e=Le(this.hass.locale);return io(this._contentWidth,e).map(t=>{const i={mode:we.Fixed,hours:t.hour,minutes:0},s=Re(i,{seconds:!1,am_pm:e}),a="left"===t.align?"left":"right"===t.align?"right":"";return H`
        <span class="${a}" style=${ra({width:t.widthPct+"%"})}>${s}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{const a=i.actions.length?Os(i.actions[0],this.hass,this.config.customize,!0,!0):"",o=5*a.length+10,n=s>0?15:0,r=s<e.length-1?15:0,d=t[s]-n-r,l=e[s+1],c=i.actions.length?Wa(i.actions[0])?"off":Ua(i.actions[0])?"on":"":"",h=i.actions.length?to(i.actions[0]):null,u=h?{background:`rgba(${h.rgb.join(", ")}, ${h.alpha})`,border:this.selectedSlot==s?"3px solid rgb(var(--rgb-state-active-color, 67, 160, 71))":"2px solid rgba(var(--rgb-state-active-color, 67, 160, 71), 0.9)"}:{};return H`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?c:"empty"} ${void 0===i.stop?"short":""} ${this.pendingSlot===s?"pending":""}"
          style="${ra(Object.assign({width:t[s]+"px"},u))}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?a&&(d>o/3||d>50)&&d>30?H`<span style="margin-inline-start: ${n}px; margin-inline-end: ${r}px">${a}</span>`:d>16?H`<ha-icon icon="${Ba(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
    ...
    `}};t([le({attribute:!1})],ro.prototype,"config",void 0),t([ce()],ro.prototype,"schedule",void 0),t([ce()],ro.prototype,"selectedSlot",void 0),t([ce()],ro.prototype,"_width",void 0),t([ce()],ro.prototype,"_zoom",void 0),t([ce()],ro.prototype,"_panPx",void 0),t([ce()],ro.prototype,"_createRange",void 0),t([ce()],ro.prototype,"pendingSlot",void 0),t([le({type:Boolean})],ro.prototype,"large",void 0),ro=t([re("scheduler-timeslot-editor")],ro);const lo=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let co=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=we.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=De(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return H`
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return q;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=lo(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return H`
        <div class="mode">
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Ie(this.hours).am_pm;const t=Ie(this.hours).hours;this.hours=He(t,"AM"==e?Ne.PM:Ne.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return H`
      ...
      `:q}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const s=oo({hours:this.hours,minutes:this.minutes},t),a=oo({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||(Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset),d=r==we.Sunrise?s:a;return{mode:r,hours:d.hours,minutes:d.minutes}}{let e=this.mode==we.Sunrise?De(t):De(i);return e=Ce(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Ie(this.hours).am_pm;t=He(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.detail.value;if(Ie(this.hours).am_pm==t)return;const i=Ie(this.hours).hours;this.hours=He(i,"AM"==t?Ne.AM:Ne.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Ce(t,e),e.minutes&&(t=Ee(t,this.stepSize)),this.mode!=we.Fixed&&(t=lo(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};Rs(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==we.Fixed?Ie(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};co.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([le({attribute:!1})],co.prototype,"hass",void 0),t([ce()],co.prototype,"hours",void 0),t([ce()],co.prototype,"minutes",void 0),t([ce()],co.prototype,"mode",void 0),t([le({type:Boolean})],co.prototype,"autoValidate",void 0),t([le({type:Boolean})],co.prototype,"required",void 0),t([le({type:Boolean})],co.prototype,"disabled",void 0),t([le({type:String})],co.prototype,"label",void 0),t([le({type:Boolean})],co.prototype,"useAmPm",void 0),t([le({type:Boolean})],co.prototype,"large",void 0),t([le({attribute:!1})],co.prototype,"stepSize",void 0),co=t([re("scheduler-time-picker")],co);let ho=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0&&this._params.weekdays.length==this.selectedWeekdays.length}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?H`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        width="small"
    ...
    `:H``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,Ds(this.hass))}else e=[_e.Daily,_e.Workday,_e.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.some(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>H`
        <ha-list-item
          graphic="icon"
    ...
    `}};t([le({attribute:!1})],ho.prototype,"hass",void 0),t([ce()],ho.prototype,"_params",void 0),t([ce()],ho.prototype,"weekdayTypeCustomSelected",void 0),t([ce()],ho.prototype,"selectedWeekdays",void 0),ho=t([re("dialog-select-weekdays")],ho);var uo=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return ho}});const po=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),mo=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(cs).includes(t))return!1;let s=Object.keys(cs[t]).includes(e);if(!s&&Object.keys(cs[t]).includes("{entity_id}")){if("script"==t&&["turn_on","turn_off","reload","toggle","test"].includes(e))return!1;s=ss(`${t}.${e}`,i)}return s}):[],a=t=>rs(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=s=>{let o=ns(Os({service:`${t}.${s}`,service_data:{}},e,i.customize));return"script"==t?Object.keys(i.customize||{}).includes(`${t}.${s}`)&&Ke(i.customize[`${t}.${s}`].name)?i.customize[`${t}.${s}`].name:`${ns(Ps(`${t}.${s}`,e,i.customize))}: ${o}`:`${a(t)}: ${o}`},n=i=>{let s=rs(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=rs(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(s=>{return{key:s,name:o(s),description:n(s),icon:(a=s,"script"==t&&Object.keys(i.customize||{}).includes(`${t}.${a}`)&&Ke(i.customize[`${t}.${a}`].icon)?i.customize[`${t}.${a}`].icon:Object.keys(bs).includes(t)&&Object.keys(bs[t].services).includes(a)?bs[t].services[a]:ta(t)),action:{service:s.includes(".")?s:`${t}.${s}`,service_data:{},target:e.services[t][s].target?{}:void 0}};var a}),d=(l=i.customize||{},c=t,Object.keys(l).filter(e=>{var t;return null===(t=l[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&is(Qi(e),c)||is(e,c)).map(e=>l[e].exclude_actions).flat().filter(Ke));var l,c;return d.length&&(r=r.filter(t=>!d.some(s=>po(Ji(t.action.service),s)>0||po(Os(t.action,e,i.customize),s)>0))),ms(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=xs(i),a=Ra(s);!Ke(e.service_data[t])&&Ke(a)?e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}):Ke(e.service_data[t])||(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:null})}))}),r.push({key:i,name:`${a(t)}: ${_o(e.name||o(Ji(e.service)))}`,description:_o(e.name||""),icon:e.icon||ta(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},_o=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let go=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1,this.showAll=!1}async showDialog(e){this._params=e,this.lockDomain=void 0!==e.domainFilter,this.showAll=!1,this.selectedEntity=void 0,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?H`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        @wa-after-show=${this._opened}
      >
        <div slot="header">
          <ha-dialog-header>
            ...
            <ha-icon-button
              slot="navigationIcon"
              .label=${rs("ui.common.back",this.hass)}
              .path=${Bs}
            ...
            <ha-dropdown
              ...
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
            >
              <ha-icon-button slot="trigger" .label=${this.hass.localize("ui.common.menu")} .path=${Zs}>
              </ha-icon-button>
    ...
    `}};t([le({attribute:!1})],go.prototype,"hass",void 0),t([ce()],go.prototype,"_params",void 0),t([ce()],go.prototype,"_search",void 0),t([ce()],go.prototype,"_filter",void 0),t([ce()],go.prototype,"_width",void 0),t([ce()],go.prototype,"_height",void 0),t([ce()],go.prototype,"lockDomain",void 0),t([ce()],go.prototype,"showAll",void 0),t([ce()],go.prototype,"selectedEntity",void 0),go=t([re("dialog-select-action")],go);var vo=Object.freeze({__proto__:null,get DialogSelectAction(){return go}});let fo=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return H`
      ${this.showPrefix?H`
    ...
    `}};t([le({type:Boolean})],fo.prototype,"showPrefix",void 0),fo=t([re("scheduler-settings-row")],fo);let bo=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return H`
      ...
      <div class="editor-header">
        <div class="weekdays">
          <span>
            ...
            ${Ms(e.weekdays,"short",this.hass)}
          </span>
          <ha-icon-button .path=${Xs} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
        </div>
    ...
    `}toggleViewMode(){const e=this.viewMode==me.Scheme?me.Single:me.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return H``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Te(e,this.hass),s=(Te(t,this.hass)||86400)-i;return H`
      <div class="actions">
        <ha-icon-button .path=${Bs} @click=${e=>{this._updateSelectedSlot(this.selectedSlot-1),e.target.blur()}} ?disabled=${null===this.selectedSlot||this.selectedSlot<1}>
        </ha-icon-button> 
        ...
        <ha-icon-button .path=${Js} @click=${this._removeTimeslot} ?disabled=${this.schedule.entries[this.selectedEntry].slots.length<=2}>
        </ha-icon-button> 
      </div>
    ...
    `}_renderOnOffToggle(e,t){var i,s;const a=Ua(t)?t:Za(t),o=Wa(t)?t:Za(t),n=this.selectedSlot>0?this.schedule.entries[this.selectedEntry].slots[this.selectedSlot-1]:void 0,r=null!==e?null:(null===(i=null==n?void 0:n.actions)||void 0===i?void 0:i.length)&&Ua(n.actions[0])?"off":(null===(s=null==n?void 0:n.actions)||void 0===s?void 0:s.length)&&Wa(n.actions[0])?"on":null,d=t=>{t!==e&&this._updateSlot({actions:["on"===t?a:o]})};return H`
    ...
    `}const n=_s(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Qi(o.service),d=Ke(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Ke(null===(i=null===(t=_s(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return H``;const l=Object.keys(n.fields||{}).filter(e=>Ca(o,e,this.hass,this.config.customize));let c="",h=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();!h.length&&["notify","script"].includes(r)&&(h=[o.service]),h.length&&(c+=h.map(e=>Ps(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=Os(o,this.hass,this.config.customize,!1,!0);const u=null!==Za(o);return H`
      ...
      >
        ...
        <ha-dropdown
          ...
          placement="bottom-end"
        >
          <ha-icon-button slot="trigger" .path=${Zs}>
          </ha-icon-button>
          <ha-dropdown-item value="change_type">
            <ha-icon icon="mdi:pencil"></ha-icon>
            ${rs("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
          </ha-dropdown-item>
          <ha-dropdown-item variant="danger" value="delete">
            <ha-icon icon="mdi:delete"></ha-icon>
            ${rs("ui.common.delete",this.hass)}
          </ha-dropdown-item>
        </ha-dropdown>
        ...
        <div slot="content">
          ...
          ${n.target?H`
          <scheduler-settings-row>
            <span slot="heading">${rs("ui.components.entity.entity-picker.entity",this.hass)}</span>
          ...
          ${l.map(e=>{var t;const i=ys(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const a=!s||Object.keys(o.service_data).includes(e);return H`
            <scheduler-settings-row ?showPrefix=${s}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{var a;const o=Qi(e.service),n=Ji(e.service);let r=rs(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][e.service]&&i.services[o][e.service].fields&&i.services[o][e.service].fields[t]&&(r=String(i.services[o][e.service].fields[t].name));const d=["script","notify"].includes(o)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat(),l=d.length?d[0]:e.service;let c=ms(s||{},l);if(c.length){let i=c.map(i=>{if(i.service!=e.service||!Object.keys(i.variables||{}).includes(t))return null;return(i.variables||{})[t].name}).filter(Ke);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
  ...
  ha-list-item.warning, ha-list-item.warning ha-icon {
    ...
    `}};t([le({attribute:!1})],bo.prototype,"hass",void 0),t([le({attribute:!1})],bo.prototype,"config",void 0),t([le({attribute:!1})],bo.prototype,"viewMode",void 0),t([le({attribute:!1})],bo.prototype,"selectedSlot",void 0),t([le({type:Boolean})],bo.prototype,"large",void 0),t([ce()],bo.prototype,"schedule",void 0),t([ce()],bo.prototype,"selectedEntry",void 0),bo=t([re("scheduler-main-panel")],bo);const yo=["January","February","March","April","May","June","July","August","September","October","November","December"];function wo(e){return e.toISOString().split("T")[0]}function ko(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const s=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==s&&t.setHours(Number(s[1]),Number(s[2]),s.length>4?Number(s[4]):t.getSeconds()),t}const xo=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,s;return!isNaN(e)&&(!(void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min)&&!(void 0!==(null===(s=t.number)||void 0===s?void 0:s.max)&&e>t.number.max))})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,$o=e=>null==e||Array.isArray(e)?e:[e];let So=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.showAll=!1}async showDialog(e){this._params=e,this.showAll=!1,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?H`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        @wa-after-show=${this._opened}
    ...
    `}};t([le({attribute:!1})],So.prototype,"hass",void 0),t([ce()],So.prototype,"_params",void 0),t([ce()],So.prototype,"_search",void 0),t([ce()],So.prototype,"_filter",void 0),t([ce()],So.prototype,"_width",void 0),t([ce()],So.prototype,"_height",void 0),t([ce()],So.prototype,"showAll",void 0),So=t([re("dialog-select-condition")],So);var jo=Object.freeze({__proto__:null,get DialogSelectCondition(){return So}});let zo=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[],this.customTagValue=""}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||wo(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||wo(new Date);const i=(await Vs(this.hass)).map(e=>e.name),s=[this.config.tags||[]].flat();this.tags=[...new Set([...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))])]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return H`
      ...
      <div class="period">
        ...
        <div class="input">
          <ha-date-input
            ...
            .label=${rs("ui.components.date-range-picker.start_date",this.hass)}
        ...
        <div class="input">
          <ha-date-input
            .locale=${this.hass.locale}
            value=${this.endDate}
            .label=${rs("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${rs("ui.common.name",this.hass)}:</span>
      <div class="period">
        <ha-input
          value=${this.schedule.name||""}
          placeholder=${this.schedule.name?"":rs("ui.common.name",this.hass)}
      ...
      >
        ...
        ${rs("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${rs("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{var i;const s=this.conditionIdx==t?this.selectedEntity||e.entity_id||"":e.entity_id||"",a=this.conditionIdx==t&&this.selectedDomain||Qi(s),o=ua(s||a,this.hass,this.config.customize),n=o&&o.hasOwnProperty("number")?[ve.Above,ve.Below]:[ve.Equal,ve.Unequal],r={[ve.Equal]:"mdi:equal",[ve.Unequal]:"mdi:not-equal-variant",[ve.Above]:"mdi:greater-than",[ve.Below]:"mdi:less-than"},d={[ve.Equal]:"ui.panel.options.conditions.types.equal_to",[ve.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ve.Above]:"ui.panel.options.conditions.types.above",[ve.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=n[0]),H`
      <scheduler-collapsible-section idx="${t}">
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${rs("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            .hass=${this.hass}
            .config=${this.config}
            .domain=${a}
            @value-changed=${this._selectEntity}
            .value=${this.conditionIdx==t?$o(this.selectedEntity):$o(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${ns(Yi(d[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-dropdown
            ...
            >
              ...
              ${n.map(i=>H`
                ...
                >
                  ...
                  ${ns(Yi(d[i],this.hass,["{entity}","{value}"],["",""]))}
                </ha-dropdown-item>
              `)}
            </ha-dropdown>
          </span>
    ...
    `}};t([le({attribute:!1})],zo.prototype,"hass",void 0),t([le({attribute:!1})],zo.prototype,"config",void 0),t([ce()],zo.prototype,"schedule",void 0),t([ce()],zo.prototype,"conditionIdx",void 0),t([ce()],zo.prototype,"selectedDomain",void 0),t([ce()],zo.prototype,"selectedEntity",void 0),t([ce()],zo.prototype,"selectedMatchType",void 0),t([ce()],zo.prototype,"conditionValue",void 0),t([ce()],zo.prototype,"conditionValid",void 0),t([ce()],zo.prototype,"startDate",void 0),t([ce()],zo.prototype,"endDate",void 0),t([le()],zo.prototype,"tags",void 0),t([ce()],zo.prototype,"customTagValue",void 0),zo=t([re("scheduler-options-panel")],zo);let Oo=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?H`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        width="small"
    ...
    `}_renderHeader(){return H`
      <div class="plan-header">
        <div class="plan-title">
          ...
          >
            <ha-svg-icon .path=${Us}></ha-svg-icon>${this._t("settings.open")}
          </button>
    ...
    `}_renderKeys(){const e=[["← →",this._t("keys.select")],["↑ ↓",this._t("keys.row")],["⇧ ← →",this._t("keys.move_start")],["⌥ ← →",this._t("keys.move_stop")],["N",this._t("cube.split")],["⌫",rs("ui.common.delete",this.hass)],["O",this._t("keys.state")],["H",this._t("enforce.label")],["1…9 / 0",this._t("keys.colour")],["G",this._t("group.add")],["R",this._t("report.open")],["W",this._t("wizard.open")],["↵",this._t("keys.rename")],["⌘Z / Ctrl Z",this._t("history.undo")],["⌘Y / Ctrl Y",this._t("history.redo")],["⌘S / Ctrl S",rs("ui.common.save",this.hass)],["?",this._t("keys.open")]];return H`
      <div class="keys">
        ${e.map(([e,t])=>H`
    ...
    `}async _loadBook(){try{const t=await(e=this.hass,e.callWS({type:"scheduler/device_book"}));this._book={groups:(null==t?void 0:t.groups)||[],devices:(null==t?void 0:t.devices)||[],kinds:(null==t?void 0:t.kinds)||[]}}catch(e){this._book=Ko}var e}_renderBook(){const e=[...this._book.devices].sort((e,t)=>e.name.localeCompare(t.name)),t=[...this._book.groups.map(e=>e.name),...this._draftGroups.filter(e=>!this._book.groups.some(t=>t.name==e))];return H`
      <div class="book">
        <div class="book-head">
      ...
      <div class="band">
        ...
        <div class="row-actions">
          <button class="ghost" @click=${this._addGroup}>
            <ha-svg-icon .path=${Gs}></ha-svg-icon>${this._t("group.add")}
          </button>
        </div>
      </div>
    ...
    `}_renderHandle(e,t,i){const s=this._position(i.start);return null===s?q:H`
      <div
        ...
        @pointerup=${this._handleDragEnd}
      ></div>
    `}_cubeTone(e){const t=Object.values(e.devices||{});if(!t.length)return"empty";const i=t.filter(Wa).length;return i===t.length?"off":0===i?"on":"mixed"}_cubeStyle(e){if(e.color)return`background:${e.color};color:#fff`;if(this._plainColours)return"";const t=Object.values(e.devices||{}),i=t.filter(e=>!Wa(e));if(i.length===t.length&&i.length){const e=to(i[0]);if(e){const[t,i,s]=e.rgb;return`background:rgba(${t},${i},${s},${e.alpha})`}}return""}_renderCube(e,t){const i=this._position(t.start),s=this._position(t.stop);if(null===i||null===s||s<=i)return q;const a=this._cubeTone(t),o=this._selected==t.id;return H`
      <button
      ...
      >
        ...
        <span class="cube-tools">
          ...
          ><ha-svg-icon .path=${Gs}></ha-svg-icon></span>
          ${e.cubes.length>1?H`
          <span
            class="cube-tool"
            title=${rs("ui.common.delete",this.hass)}
            @click=${i=>{i.stopPropagation(),this._removeCube(e,t)}}
          ><ha-svg-icon .path=${Ws}></ha-svg-icon></span>`:q}
        </span>`:q}
      </button>
      ...
      <div class="inspector">
        <div class="inspector-head">
          ...
          <div class="inspector-actions">
            ...
            >
              <ha-svg-icon .path=${Js}></ha-svg-icon>${rs("ui.common.delete",this.hass)}
            </button>
          </div>
        </div>
          ...
          <div class="member-chips">
            ${this._book.groups.map(e=>H`
              <button class="chip" @click=${()=>this._useGroup(e.name)}>
                <ha-svg-icon .path=${Gs}></ha-svg-icon>${e.name}
    ...
    `}_renderDetachInspector(e){var t;const i=(null===(t=this.hass.states[e.entity])||void 0===t?void 0:t.attributes.friendly_name)||e.entity;return H`
      <div class="inspector detached">
        ...
        <div class="fields">
          ...
          ${this._renderStateField(Wa(e.action),t=>this._updateDetach(e.track,{action:Object.assign(Object.assign({},e.action),{service:`${e.action.service.split(".")[0]}.${t?"turn_off":"turn_on"}`})}))}
    ...
    `:q}_renderDeviceRow(e,t,i){return this._deviceRow(i,qo(t,i),s=>this._setDeviceAction(e,t,i,s),()=>this._clearDeviceAction(e,t,i))}_deviceRow(e,t,i,s,a){var o;const n=e.split(".")[0],r=!!(null==a?void 0:a.undecided),d=!t&&!r,l=!!t&&Wa(t),c=t||Vo(e,!0),h=e=>i(Object.assign(Object.assign({},c),e)),u=(null==a?void 0:a.note)||(d?this._t("device.untouched_hint"):"");return H`
    ...
    `}_renderAllDevicesField(e,t){const i=i=>{const s={};e.entities.forEach(e=>{const t=i(e);t&&(s[e]=t)}),this._updateCube(e.track,t.id,{devices:s})};return H`
      <div class="field">
        ...
        <div class="segmented states">
          <button class="on" @click=${()=>i(e=>Vo(e,!0))}>
            ${this._t("state.on")}
          </button>
          <button class="off" @click=${()=>i(e=>Vo(e,!1))}>
            ${this._t("state.off")}
          </button>
      ...
      <div class="wizard">
        ...
        <div class="wizard-buttons">
          <button class="ghost" @click=${()=>{this._wizardStep=i>0?i-1:null}}>
            ${i>0?this._t("wizard.back"):rs("ui.common.cancel",this.hass)}
          </button>
          <button
            class="ghost primary"
            ?disabled=${o}
      ...
      <div class="wizard-parts">
        ...
        <ol class="part-list">
          ...
          <li class="part-row">
            ...
            />
            <button class="icon-only" title=${rs("ui.common.delete",this.hass)}
        ...
        <div class="field">
          ...
          <div class="moment-presets">
            ...
            <button class="chip" @click=${()=>this._addMoment(e)}>
              <ha-svg-icon .path=${Gs}></ha-svg-icon>${this._t("wizard.preset."+e.key)}
            </button>`)}
          </div>
        </div>`:q}

        <button class="ghost" @click=${()=>this._addMoment()}>
          <ha-svg-icon .path=${Gs}></ha-svg-icon>${this._t("wizard.moments.add")}
        </button>
    ...
    `}_statesAt(e){const t={},i=this._wizard.opening||{};if(this._wizard.entities.forEach(e=>{t[e]=i[e]}),!e)return t;for(const i of this._wizard.moments)if(Object.entries(i.states||{}).forEach(([e,i])=>{t[e]=i}),i.id==e)break;return t}_openingUndecided(){const e=this._wizard.opening||{};return this._wizard.entities.filter(t=>void 0===e[t])}_setAllDevices(e,t){this._wizard.entities.forEach(i=>this._setMomentDevice(e,i,Vo(i,t)))}_renderWizardDevices(){const e=new Set(this._wizard.entities),t=e=>{this._wizard=Object.assign(Object.assign({},this._wizard),{entities:[...new Set(e)]})},i=(e,t)=>{var i;return t||(null===(i=this.hass.states[e])||void 0===i?void 0:i.attributes.friendly_name)||e};return H`
      <div class="wizard-devices">
        ...
        <div class="field">
          ...
          <div class="member-chips">
            ${this._book.groups.map(e=>{const i=Yo(this._book,e.name);return H`
      ...
      <ol class="review">
        ...
        <li>
          ...
          <div class="review-devices">
            ${this._wizard.entities.map(e=>{var i;const s=t[e],a=void 0===s?"pending":null===s?"none":Wa(s)?"off":"on";return H`
    ...
    `}};t([le({attribute:!1})],nn.prototype,"hass",void 0),t([ce()],nn.prototype,"_params",void 0),t([ce()],nn.prototype,"_plan",void 0),t([ce()],nn.prototype,"_selected",void 0),t([ce()],nn.prototype,"_error",void 0),t([ce()],nn.prototype,"_help",void 0),t([ce()],nn.prototype,"_wizardStep",void 0),t([ce()],nn.prototype,"_offerWizard",void 0),t([ce()],nn.prototype,"_wizard",void 0),t([ce()],nn.prototype,"_wizardAdvanced",void 0),t([ce()],nn.prototype,"_history",void 0),t([ce()],nn.prototype,"_future",void 0),t([ce()],nn.prototype,"_keys",void 0),t([ce()],nn.prototype,"_book",void 0),t([ce()],nn.prototype,"_bookOpen",void 0),t([ce()],nn.prototype,"_newGroup",void 0),t([ce()],nn.prototype,"_draftGroups",void 0),t([ce()],nn.prototype,"_prefs",void 0),t([ce()],nn.prototype,"_plainColours",void 0),t([ce()],nn.prototype,"_settingsOpen",void 0),t([ce()],nn.prototype,"_helpKey",void 0),t([ce()],nn.prototype,"_membersAdvanced",void 0),t([ce()],nn.prototype,"_report",void 0),t([ce()],nn.prototype,"_saved",void 0),nn=t([re("dialog-scheduler-plan")],nn);var rn=Object.freeze({__proto__:null,get DialogSchedulerPlan(){return nn}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class dn extends na{constructor(e){if(super(e),this.et=q,e.type!==aa)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===q||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}dn.directiveName="unsafeHTML",dn.resultType=1;const ln=oa(dn);var cn=window&&window.__assign||function(){return(cn=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)};var hn={second:45,minute:45,hour:22,day:5};const un=(e,t,i)=>{if(i===Pe.am_pm||!i&&t.time_format===Pe.am_pm){const t=Ie(e.getHours()).am_pm;return`${Ie(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Pe.twenty_four||!i&&t.time_format===Pe.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:Le(t)}):Le(t)?un(e,t,Pe.am_pm):un(e,t,Pe.twenty_four)};let pn=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return yo[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Yi("ui.components.date.next_week_day",this._hass,"{weekday}",As(e,"long",this._hass)):1==s?a=Yi("ui.components.date.tomorrow",this._hass):s>0&&(a=As(e,"long",this._hass));let o=Yi("ui.components.time.absolute",this._hass,"{time}",un(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Yi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Yi("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=rs("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=rs("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=cn(cn({},hn),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var d=new Date(e),l=new Date(t),c=d.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var h=12*c+d.getMonth()-l.getMonth();if(Math.round(Math.abs(h))>0)return{value:Math.round(h),unit:"month"};var u=a/604800;return{value:Math.round(u),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return H``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),H`
      ${ns(this.relativeTime(this.datetime))}
    `}};t([le()],pn.prototype,"_hass",void 0),t([le()],pn.prototype,"datetime",void 0),pn=t([re("scheduler-relative-time")],pn);let mn=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return H``;const n=["off","completed"].includes(o.state),r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let d=Ba(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Qi(r.service))&&(e=r.service),e&&(d=ma(e,this.config.customize,this.hass))}const l=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return l&&(d="mdi:help"),H`
      <ha-icon
        icon="${d}"
    ...
    `}catch(e){return H`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return H`
        ...
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return H`
          ...
          </div>`}return ln(e)};return Ls(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>H`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_toggleEnableDisable(e){const t=e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};t([le()],mn.prototype,"hass",void 0),t([le()],mn.prototype,"schedule_id",void 0),t([le()],mn.prototype,"schedule",void 0),t([le()],mn.prototype,"config",void 0),mn=t([re("scheduler-item-row")],mn);const _n=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday],gn=(e,t=new Date)=>{const i=_n[t.getDay()],s=i===_e.Friday||i===_e.Saturday,a=e.findIndex(e=>e.weekdays.includes(i)),o=a>=0?a:e.findIndex(e=>s?e.weekdays.includes(_e.Weekend):e.weekdays.includes(_e.Workday)),n=o>=0?o:e.findIndex(e=>e.weekdays.includes(_e.Daily)),r=n>=0?n:0;return{entry:e[r],index:r}},vn=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday],fn=(e,t)=>{const i=vn[t.getDay()],s=i===_e.Friday||i===_e.Saturday;return!!e.weekdays.includes(_e.Daily)||(!!e.weekdays.includes(i)||(!(!s||!e.weekdays.includes(_e.Weekend))||!(s||!e.weekdays.includes(_e.Workday))))};let bn=null;const yn=e=>{bn=e},wn="scheduler-overview-slot-select";let kn=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this.selectedSlot=null,this._onExternalSelect=e=>{var t;(null===(t=e.detail)||void 0===t?void 0:t.source)!==this&&null!==this.selectedSlot&&(this.selectedSlot=null,this.dispatchEvent(new CustomEvent("slot-selected",{detail:{index:null},bubbles:!0,composed:!0})))},this._handleKeyDown=e=>{var t,i;if(!this.editable)return;if(null===this.selectedSlot)return;const s="ArrowLeft"===e.key||"ArrowRight"===e.key;if("Delete"!==e.key&&"Backspace"!==e.key&&!s)return;const a=e.composedPath()[0];if(a instanceof HTMLElement&&(["input","textarea","select"].includes(a.tagName.toLowerCase())||a.isContentEditable))return;if(s)return e.preventDefault(),void this._nudgeSelected("ArrowRight"===e.key?1:-1);const o=this._slots;if(o.length<=2)return;const n=this.selectedSlot,r=n===o.length-1?n-1:n;if(void 0===(null===(t=o[r])||void 0===t?void 0:t.stop)||void 0===(null===(i=o[r+1])||void 0===i?void 0:i.stop))return;e.preventDefault();let d=[...o.slice(0,r),Object.assign(Object.assign({},o[r+1]),{start:o[r].start,stop:o[r+1].stop}),...o.slice(r+2)];d=Fa(d),this._liveSlots=d,this.selectedSlot=null,this.dispatchEvent(new CustomEvent("slot-selected",{detail:{index:null},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("slots-changed",{detail:{slots:d},bubbles:!0,composed:!0}))}}get _slots(){return this._liveSlots||this.slots}get _contentWidth(){return this.viewportWidth*this.zoom}connectedCallback(){super.connectedCallback(),document.addEventListener(wn,this._onExternalSelect),window.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(wn,this._onExternalSelect),window.removeEventListener("keydown",this._handleKeyDown)}_nudgeSelected(e){var t;const i=this._slots,s=this.selectedSlot,a="rtl"===getComputedStyle(this).direction?e<0:e>0,o=s<i.length-1?s:s-1;if(o<0||!(null===(t=i[o])||void 0===t?void 0:t.stop)||!i[o+1])return;if([we.Sunrise,we.Sunset].includes(De(i[o+1].start).mode))return;const n=60*this._dragStepSize,r=Te(i[o].stop,this.hass),d=o>0?Te(i[o-1].stop||i[o-1].start,this.hass)+n:n,l=(Te(i[o+1].stop||i[o+1].start,this.hass)||86400)-n,c=Math.min(Math.max(r+(a?n:-n),d),l);if(c===r)return;const h={mode:we.Fixed,hours:Math.floor(c/3600),minutes:Math.round(c%3600/60)},u=Re(Ee(h,this._dragStepSize)),p=Object.assign([...i],{[o]:Object.assign(Object.assign({},i[o]),{stop:u}),[o+1]:Object.assign(Object.assign({},i[o+1]),{start:u})});this._liveSlots=p,this.dispatchEvent(new CustomEvent("slots-changed",{detail:{slots:p},bubbles:!0,composed:!0}))}updated(e){var t;e.has("slots")&&(this._liveSlots=void 0);const i=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(".content-inner");i&&(i.style.direction=getComputedStyle(this).direction)}_handleWheel(e){if(!this.viewportWidth||!this.editable)return;const t=e.ctrlKey||e.metaKey||Math.abs(e.deltaY)>=Math.abs(e.deltaX);e.preventDefault();const i=e.currentTarget.getBoundingClientRect(),s=e.clientX-i.left;if(t){const t=Math.pow(2,-e.deltaY/60);this.dispatchEvent(new CustomEvent("overview-zoom",{detail:{anchorPx:s,factor:t},bubbles:!0,composed:!0}))}else this.dispatchEvent(new CustomEvent("overview-pan",{detail:{deltaPx:e.deltaX},bubbles:!0,composed:!0}))}_touchDistance(e){const t=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.hypot(t,i)}_handlePinchStart(e){if(2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect();this._pinch={distance:this._touchDistance(e.touches),midpointX:(e.touches[0].clientX+e.touches[1].clientX)/2-t.left}}_handlePinchMove(e){if(!this._pinch||2!==e.touches.length)return;e.preventDefault();const t=this._touchDistance(e.touches),i=t/this._pinch.distance;this.dispatchEvent(new CustomEvent("overview-zoom",{detail:{anchorPx:this._pinch.midpointX,factor:i},bubbles:!0,composed:!0})),this._pinch.distance=t}_handlePinchEnd(e){e.touches.length<2&&(this._pinch=void 0)}render(){var e;if(!this.hass||!(null===(e=this.slots)||void 0===e?void 0:e.length)||!this.viewportWidth)return H``;const t=this._slots,i=so(t,this.hass,this._contentWidth,2),s=Le(this.hass.locale),{boundaries:a,maxTier:o}=ao(t,i,s,2),n="rtl"===getComputedStyle(this).direction?"50%":"-50%",r=15+13*o;return H`
      <div
        class="viewport"
        @wheel=${this._handleWheel}
        @touchstart=${this._handlePinchStart}
      ...
      >
        <div
          class="zoom-content"
          style=${ra({width:this._contentWidth+"px",transform:`translateX(${-this.panPx}px)`})}
        >
          <div class="content-inner">
            <div class="boundaries" style=${ra({height:r+"px"})}>
              ${a.map(e=>H`
                <div
                  class="boundary ${e.align}"
                  style=${ra(Object.assign(Object.assign({},"end"===e.align?{insetInlineEnd:this._contentWidth-e.position+"px"}:{insetInlineStart:e.position+"px"}),"middle"===e.align?{transform:`translateX(${n})`}:{}))}
                >
                  <span class="boundary-label ${e.state}" style=${ra(e.color?{color:e.color}:{})}>${e.label}</span>
                  <span class="boundary-line" style=${ra({height:4+13*e.tier+"px"})}></span>
                </div>
              `)}
            </div>
            <div class="bar">
              ${t.map((e,s)=>{const a=e.actions.length?Wa(e.actions[0])?"off":Ua(e.actions[0])?"on":"":"empty",o=e.actions.length?to(e.actions[0]):null,n=t[s+1];return H`
                  <div
                    class="seg ${a} ${this.selectedSlot===s?"selected":""}"
                    style=${ra(Object.assign({width:i[s]+"px"},o?{background:`rgba(${o.rgb.join(", ")}, ${o.alpha})`}:{}))}
                  ...
                  ${s<t.length-1&&e.stop?H`
                    ...
                    >
                      <span><ha-svg-icon .path=${Qs}></ha-svg-icon></span>
                    </div>
                  `:""}
                `})}
              ${void 0!==this.now?H`
                <div
                  class="now-line"
                  style=${ra({insetInlineStart:(3600*this.now.getHours()+60*this.now.getMinutes()+this.now.getSeconds())/86400*this._contentWidth+"px"})}
                ></div>
              `:""}
              ${this._createRange?H`
                <div
                  class="create-overlay"
                  style=${ra({insetInlineStart:this._createRange.ts0/86400*this._contentWidth+"px",width:(this._createRange.ts1-this._createRange.ts0)/86400*this._contentWidth+"px"})}
                ></div>
              `:""}
            </div>
          </div>
    ...
    `}};t([le({attribute:!1})],kn.prototype,"hass",void 0),t([le({attribute:!1})],kn.prototype,"config",void 0),t([le({attribute:!1})],kn.prototype,"slots",void 0),t([le({type:Number})],kn.prototype,"zoom",void 0),t([le({type:Number})],kn.prototype,"panPx",void 0),t([le({type:Number})],kn.prototype,"viewportWidth",void 0),t([le({type:Boolean})],kn.prototype,"editable",void 0),t([le({attribute:!1})],kn.prototype,"now",void 0),t([ce()],kn.prototype,"selectedSlot",void 0),t([ce()],kn.prototype,"_liveSlots",void 0),t([ce()],kn.prototype,"_createRange",void 0),kn=t([re("scheduler-overview-bar")],kn);let xn=class extends oe{_fire(e){this.dispatchEvent(new CustomEvent("action-changed",{detail:{action:e}}))}_setOnOff(e){const t=Qi(this.entityId);this._fire({service:`${t}.${e?"turn_on":"turn_off"}`,service_data:{},target:{entity_id:this.entityId}})}_setParam(e,t){if(!this.action)return;const i=Object.assign(Object.assign({},this.action.service_data),{[e]:t});"color_temp_kelvin"===e&&delete i.rgb_color,this._fire(Object.assign(Object.assign({},this.action),{service_data:i}))}_setColor(e){if(!this.action)return;const t=[1,3,5].map(t=>parseInt(e.substr(t,2),16)),i=Object.assign(Object.assign({},this.action.service_data),{rgb_color:t});delete i.color_temp_kelvin,this._fire(Object.assign(Object.assign({},this.action),{service_data:i}))}_renderParams(){var e,t,i,s;const a=this.action;if(!a||"light"!==Qi(a.service)||!Ua(a))return q;const o=(null===(t=null===(e=this.hass.states[this.entityId])||void 0===e?void 0:e.attributes)||void 0===t?void 0:t.supported_color_modes)||[],n=o.includes("color_temp"),r=["hs","rgb","rgbw","rgbww","xy"].some(e=>o.includes(e)),d=a.service_data||{},l=d.rgb_color,c=Array.isArray(l)&&l.length>=3?"#"+l.slice(0,3).map(e=>Math.round(e).toString(16).padStart(2,"0")).join(""):"#ffb46b";return H`
      <div class="params">
        <label>
    ...
    `}render(){if(!this.hass||!this.entityId)return H``;const e=!!this.action&&Ua(this.action),t=!!this.action&&Wa(this.action);return H`
    ...
    `}};t([le({attribute:!1})],xn.prototype,"hass",void 0),t([le({attribute:!1})],xn.prototype,"action",void 0),t([le()],xn.prototype,"entityId",void 0),xn=t([re("scheduler-overview-action-panel")],xn);let $n=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this.spanDays=1,this._saveState=null,this._selectedSlot=null,this._undoStack=[]}render(){var e,t,i;try{const s=this.hass.states[this.schedule.entity_id];if(!s)return H``;const a=["off","completed"].includes(s.state),{entry:o,index:n}=gn(this.schedule.entries,this.date),r=this.date||new Date,d=fn(o,r),l=new Date(r.getTime()+864e5),c=2===this.spanDays?gn(this.schedule.entries,l):null,h=!!c&&fn(c.entry,l),u=2===this.spanDays?this.viewportWidth/2:this.viewportWidth,p=null===(e=o.slots.find(e=>e.actions.length))||void 0===e?void 0:e.actions[0];let m="mdi:calendar-clock";if(p){let e=[(null===(t=p.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Qi(p.service))&&(e=p.service),e&&(m=ma(e,this.config.customize,this.hass))}const _=p?Ps(["script","notify"].includes(Qi(p.service))?p.service:[(null===(i=p.target)||void 0===i?void 0:i.entity_id)||[]].flat()[0]||"",this.hass,this.config.customize):this.schedule.name||this.schedule.entity_id;return H`
      ...
      ></scheduler-overview-action-panel>
    `:""}_handleActionChanged(e,t,i){e.stopPropagation();const s=this._selectedSlot;if(null===s)return;const a=Object.assign([...t],{[s]:Object.assign(Object.assign({},t[s]),{actions:[e.detail.action]})});this._handleSlotsChanged(new CustomEvent("slots-changed",{detail:{slots:a}}),i)}_handleDuplicate(e){e.stopPropagation();const t=Object.assign({},this.schedule);delete t.schedule_id,delete t.entity_id,Promise.resolve(Da(this.hass,t)).catch(e=>Na(e,this,this.hass))}_handleToggle(e){e.stopPropagation();const t=this.hass.states[this.schedule.entity_id];if(!t)return;const i=["off","completed"].includes(t.state);this.hass.callService("switch",i?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}_handleEditClick(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}}))}_handleSlotsChanged(e,t){e.stopPropagation(),this._undoStack.push({slots:this.schedule.entries[t].slots,entryIndex:t}),yn(()=>this._performUndo()),this._saveAndSet(t,e.detail.slots,!0)}_saveAndSet(e,t,i=!1){const s=Object.assign([...this.schedule.entries],{[e]:Object.assign(Object.assign({},this.schedule.entries[e]),{slots:t})}),a=Object.assign(Object.assign({},this.schedule),{entries:s});this.schedule=a;const o=a.schedule_id?Ha(this.hass,a):Da(this.hass,a);return Promise.resolve(o).then(()=>{i&&this._showSaved()}).catch(e=>{this._clearSaveState(),Na(e,this,this.hass)})}_showSaved(){clearTimeout(this._saveStateTimer),this._saveState="saved",this._saveStateTimer=window.setTimeout(()=>{this._saveState="reset"},500)}_handlePillClick(){"reset"===this._saveState&&this._performReset()}_performUndo(){const e=this._undoStack.pop();e&&(this._undoStack.length?yn(()=>this._performUndo()):this._clearSaveState(),this._saveAndSet(e.entryIndex,e.slots))}_performReset(){const e=this._undoStack[0];e&&(this._undoStack=[],this._clearSaveState(),this._saveAndSet(e.entryIndex,e.slots))}_clearSaveState(){yn(null),clearTimeout(this._saveStateTimer),this._saveState=null}static get styles(){return r`
      :host {
        display: block;
      }
      .row {
    ...
    `}};t([le()],$n.prototype,"hass",void 0),t([le()],$n.prototype,"schedule_id",void 0),t([le()],$n.prototype,"schedule",void 0),t([le()],$n.prototype,"config",void 0),t([le({attribute:!1})],$n.prototype,"date",void 0),t([le({type:Number})],$n.prototype,"zoom",void 0),t([le({type:Number})],$n.prototype,"panPx",void 0),t([le({type:Number})],$n.prototype,"viewportWidth",void 0),t([le({type:Boolean})],$n.prototype,"editable",void 0),t([le({attribute:!1})],$n.prototype,"now",void 0),t([le({type:Number})],$n.prototype,"spanDays",void 0),t([ce()],$n.prototype,"_saveState",void 0),t([ce()],$n.prototype,"_selectedSlot",void 0),$n=t([re("scheduler-overview-row")],$n);let Sn=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.minZoom=1,this.maxZoom=48,this.spanDays=1,this._width=0}get _contentWidth(){return this._width*this.zoom}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=Math.max(0,t.contentRect.width-158);e!==this._width&&(this._width=e,this.dispatchEvent(new CustomEvent("viewport-width-changed",{detail:{width:e},bubbles:!0,composed:!0})))}}),this._resizeObserver.observe(this)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect()}_fireZoom(e){this.dispatchEvent(new CustomEvent("overview-zoom",{detail:e,bubbles:!0,composed:!0}))}_fireReset(){this.dispatchEvent(new CustomEvent("overview-zoom-reset",{bubbles:!0,composed:!0}))}_handleWheel(e){if(!this._width||2===this.spanDays)return;const t=e.ctrlKey||e.metaKey||Math.abs(e.deltaY)>=Math.abs(e.deltaX);e.preventDefault();const i=e.currentTarget.getBoundingClientRect(),s=e.clientX-i.left;if(t){const t=Math.pow(2,-e.deltaY/60);this._fireZoom({anchorPx:s,factor:t})}else this.dispatchEvent(new CustomEvent("overview-pan",{detail:{deltaPx:e.deltaX},bubbles:!0,composed:!0}))}_handlePanStart(e){this.zoom<=this.minZoom||(e.currentTarget.setPointerCapture(e.pointerId),this._panDrag={pointerId:e.pointerId,startX:e.clientX})}_handlePanMove(e){if(!this._panDrag||this._panDrag.pointerId!==e.pointerId)return;const t=e.clientX-this._panDrag.startX;this._panDrag.startX=e.clientX,this.dispatchEvent(new CustomEvent("overview-pan",{detail:{deltaPx:-t},bubbles:!0,composed:!0}))}_handlePanEnd(){this._panDrag=void 0}_touchDistance(e){const t=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.hypot(t,i)}_handlePinchStart(e){if(2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect();this._pinch={distance:this._touchDistance(e.touches),midpointX:(e.touches[0].clientX+e.touches[1].clientX)/2-t.left-158}}_handlePinchMove(e){if(!this._pinch||2!==e.touches.length)return;e.preventDefault();const t=this._touchDistance(e.touches),i=t/this._pinch.distance;this._fireZoom({anchorPx:this._pinch.midpointX,factor:i}),this._pinch.distance=t}_handlePinchEnd(e){e.touches.length<2&&(this._pinch=void 0)}render(){if(!this.hass)return H``;const e=Le(this.hass.locale),t=2===this.spanDays?[...io(this._contentWidth/2,e),...io(this._contentWidth/2,e)].map(e=>Object.assign(Object.assign({},e),{widthPct:e.widthPct/2})):io(this._contentWidth,e),i=Math.round(100*this.zoom),s=void 0!==this.now&&1===this.spanDays?Math.round(this.now.getHours()+this.now.getMinutes()/60)%24:null;return H`
      ...
      >
        ...
        <div
          ...
          style=${ra({cursor:this.zoom>this.minZoom?"grab":"default"})}
        ...
        >
          <div class="ruler" style=${ra({width:this._contentWidth+"px",transform:`translateX(${-this.panPx}px)`})}>
            ...
            ${t.map(t=>{const i={mode:we.Fixed,hours:t.hour,minutes:0},a=Re(i,{seconds:!1,am_pm:e}),o="left"===t.align?"left":"right"===t.align?"right":"",n=t.hour===s||0===t.hour&&24===s;return H`
                <span class="${o} ${n?"now":""}" style=${ra({width:t.widthPct+"%"})}>${a}</span>
              `})}
          </div>
        </div>
      </div>
    ...
    `}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".ruler");t&&(t.style.direction=getComputedStyle(this).direction)}};t([le({attribute:!1})],Sn.prototype,"hass",void 0),t([le({attribute:!1})],Sn.prototype,"now",void 0),t([le({type:Number})],Sn.prototype,"zoom",void 0),t([le({type:Number})],Sn.prototype,"panPx",void 0),t([le({type:Number})],Sn.prototype,"minZoom",void 0),t([le({type:Number})],Sn.prototype,"maxZoom",void 0),t([le({type:Number})],Sn.prototype,"spanDays",void 0),t([le({attribute:!1})],Sn.prototype,"dayLabels",void 0),t([ce()],Sn.prototype,"_width",void 0),Sn=t([re("scheduler-overview-ruler")],Sn);const jn=()=>({type:ge.Or,items:[],track_changes:!1}),zn=e=>({service:Qi(e)+".turn_on",service_data:{},target:{entity_id:e}}),On=e=>({service:Qi(e)+".turn_off",service_data:{},target:{entity_id:e}});let Cn=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this._picking=!1,this._entityId=null,this._slots=[],this._selectedSlot=null,this._saving=!1}_reset(){this._picking=!1,this._entityId=null,this._slots=[],this._selectedSlot=null}_startPicking(){this._picking=!0}_handleEntityPicked(e){var t;const i=null===(t=e.detail)||void 0===t?void 0:t.value,s=Array.isArray(i)?i[i.length-1]:i;s&&(this._entityId=s,this._picking=!1,this._slots=[{start:"00:00:00",stop:"08:00:00",actions:[On(s)],conditions:jn()},{start:"08:00:00",stop:"16:00:00",actions:[zn(s)],conditions:jn()},{start:"16:00:00",stop:"00:00:00",actions:[On(s)],conditions:jn()}],this._selectedSlot=null)}_handleSlotsChanged(e){e.stopPropagation(),this._slots=e.detail.slots}_handleSlotSelected(e){e.stopPropagation(),this._selectedSlot=e.detail.index}_handleActionChanged(e){const t=this._selectedSlot;null!==t&&(this._slots=Object.assign([...this._slots],{[t]:Object.assign(Object.assign({},this._slots[t]),{actions:[e.detail.action]})}))}async _save(){if(!this._slots.length)return;this._saving=!0;const e={entries:[{weekdays:[_e.Daily],slots:this._slots}],repeat_type:ye.Repeat,next_entries:[],timestamps:[],enabled:!0};try{await Da(this.hass,e),this._reset()}catch(e){Na(e,this,this.hass)}finally{this._saving=!1}}render(){var e,t;if(!this.hass)return H``;const i=this._selectedSlot;return H`
      <div class="row">
        <div class="device">
          ...
          `:H`
            <div class="draft-device">
              ...
              <ha-icon-button .path=${Ws} @click=${this._reset} class="cancel"></ha-icon-button>
              <ha-icon-button
    ...
    `}};t([le({attribute:!1})],Cn.prototype,"hass",void 0),t([le({attribute:!1})],Cn.prototype,"config",void 0),t([le({type:Number})],Cn.prototype,"zoom",void 0),t([le({type:Number})],Cn.prototype,"panPx",void 0),t([le({type:Number})],Cn.prototype,"viewportWidth",void 0),t([le({type:Boolean})],Cn.prototype,"editable",void 0),t([ce()],Cn.prototype,"_picking",void 0),t([ce()],Cn.prototype,"_entityId",void 0),t([ce()],Cn.prototype,"_slots",void 0),t([ce()],Cn.prototype,"_selectedSlot",void 0),t([ce()],Cn.prototype,"_saving",void 0),Cn=t([re("scheduler-overview-add-row")],Cn);let En=class extends oe{constructor(){super(...arguments),this.date=new Date,this.spanDays=1}_select(e){this.dispatchEvent(new CustomEvent("date-changed",{detail:{date:e},bubbles:!0,composed:!0}))}_toggleSpan(){this.dispatchEvent(new CustomEvent("span-changed",{detail:{spanDays:2===this.spanDays?1:2},bubbles:!0,composed:!0}))}render(){if(!this.hass)return H``;const e=new Date;e.setHours(0,0,0,0);const t=Ds(this.hass),i=(e.getDay()-t+7)%7,s=new Date(e.getTime()-864e5*i),a=Array.from({length:7},(e,t)=>new Date(s.getTime()+864e5*t)),o=new Date(this.date);return o.setHours(0,0,0,0),H`
      <div class="daybar">
        <div class="days">
      ...
      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?H`
        ...
        <div class="card-actions">
          ...
          <ha-button appearance="plain" variant="warning" @click=${this._retryConnection}
            >${rs("ui.common.refresh",this.hass)}
          </ha-button>
            `:H`
          <ha-button appearance="plain" @click=${this._addClick}
            >${rs("ui.common.add",this.hass)}
          </ha-button>
          `}
        </div>`:""}
      </ha-card>
    `}async loadSchedules(){ze(this.hass).then(e=>{this.schedules=Is(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{var s;if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const o=(([(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*o:Object.values(this.schedules).filter(e=>as(e,this._config)).length*o),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?Hs(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),s=i>=0?this.schedules[i]:null;let a=[...this.schedules||[]];!t||!1===this._config.discover_existing&&!as(t,this._config)?s&&(a=a.filter(t=>t.schedule_id!==e.schedule_id)):s?s.timestamps[s.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?a=Object.assign(a,{[i]:t}):(a=Object.assign(a,{[i]:t}),a=Is(a,this._config,this.hass)):a=Is([...a,t],this._config,this.hass),this.schedules=[...a]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_renderRow(e){return this.overviewMode?H`

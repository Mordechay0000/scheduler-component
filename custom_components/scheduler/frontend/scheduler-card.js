...
/**
        ...
        <div slot="header">
          <ha-dialog-header>
            <ha-icon-button
              slot="navigationIcon"
              data-dialog="close"
              .label=${ds("ui.dialogs.more_info_control.dismiss",this.hass)}
              .path=${Zs}
            ></ha-icon-button>
            <div slot="title">
          ...
          <ha-input
            dialogInitialFocus
            .placeholder=${ds("ui.common.search",this.hass)}
            aria-label=${ds("ui.common.search",this.hass)}
            ...
            <div class="trailing" slot="trailingIcon">
              ${this._search&&H`
                <ha-icon-button
                  ...
                  .label=${ds("ui.common.clear",this.hass)}
                  .path=${Zs}
                  class="clear-button"
                ></ha-icon-button>
              `}
    ...
    `:H``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("ha-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_toggleSelectEntity(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;t.querySelector("ha-checkbox");const i=t.getAttribute("key");this._params.entities.includes(i)?this._params=Object.assign(Object.assign({},this._params),{entities:this._params.entities.filter(e=>e!=i)}):this._params=Object.assign(Object.assign({},this._params),{entities:[...this._params.entities,i]})}_toggleSelectDomain(e,t){var i;let s=e.target;for(;"HA-LIST-ITEM"!=s.tagName;)s=s.parentElement;const a=s.getAttribute("key"),o=null===(i=this.options)||void 0===i?void 0:i.find(e=>e.key==a).entities.map(e=>e.key);this._params=t?Object.assign(Object.assign({},this._params),{domains:this._params.domains.filter(e=>e!=a),entities:this._params.entities.filter(e=>!(null==o?void 0:o.includes(e)))}):Object.assign(Object.assign({},this._params),{domains:[...this._params.domains,a]}),e.stopPropagation()}closeGroupByKey(e){this.shadowRoot.querySelector("ha-list").childNodes.forEach(t=>{if(t.nodeType==Node.ELEMENT_NODE&&"HA-LIST-ITEM"==t.tagName&&t.getAttribute("key")==e){const e=t,i=e.nextElementSibling,s=e.querySelector("ha-icon-button");i.style.height="0px",e.removeAttribute("expanded"),s.classList.remove("expanded")}})}async _toggleExpandGroup(e){let t=e.target;for(;"HA-LIST-ITEM"!=t.tagName;)t=t.parentElement;const i=t.querySelector("ha-icon-button"),s=t.getAttribute("key");this.expandedGroups.includes(s)||(this.expandedGroups.forEach(e=>this.closeGroupByKey(e)),this.expandedGroups=[s],await this.requestUpdate());const a=t.nextElementSibling,o=a.scrollHeight;t.hasAttribute("expanded")?(t.removeAttribute("expanded"),i.classList.remove("expanded"),a.style.height="0px",setTimeout(()=>{this.expandedGroups=this.expandedGroups.filter(e=>e!=s)},300)):(t.setAttribute("expanded","true"),i.classList.add("expanded"),a.style.height=o+"px")}_renderOptions(){if(!this.options)return;let e=[...this.options];const t=this._filter&&this._filter.trim().length;if(t){const t=this._filter.toLowerCase().trim().split(" ");e=e.map(e=>fa(e,t)||(e=Object.assign(Object.assign({},e),{entities:(e.entities||[]).filter(e=>fa(e,t))})).entities.length?e:void 0).filter(e=>void 0!==e)}return e.length?Object.keys(e).map(i=>{var s,a;const o=e[i].key,n=null===(s=this._params)||void 0===s?void 0:s.domains.includes(o);let r=[...e[i].entities];"switch"==o&&(r=r.filter(e=>!this.scheduleEntities.includes(e.key)));const d=n?r.length:r.filter(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)}).length,l=(null===(a=this._params)||void 0===a?void 0:a.domains.includes(o))||e[i].entities.every(e=>{var t;return null===(t=this._params)||void 0===t?void 0:t.entities.includes(e.key)});return H`
        ...
        >
          ...
          <div slot="meta" class="meta">
            <ha-button
              ...
              size="small"
            >
              ${ds(l?"ui.components.media-browser.file_management.deselect_all":"ui.components.subpage-data-table.select_all",this.hass)}
            </ha-button>
        ...
        ${this.expandedGroups.includes(o)||t?H`
        <div class="group ${t?"open":""}">
          <li role="divider"></li>
        ${r.map(e=>{var t,i;return H`
          <ha-list-item
            graphic="icon"
            twoline
            hasMeta
            ...
            key="${e.key}"
          >
            ${Object.keys(this.hass.states).includes(e.key)?H`<ha-state-icon .stateObj=${this.hass.states[e.key]} .hass=${this.hass} slot="graphic"></ha-state-icon>`:H`<ha-icon slot="graphic" icon="${e.icon}"></ha-icon>`}
            <ha-checkbox
              slot="meta"
      ...
      `}):H`
        <ha-list-item disabled>
          ${ds("ui.components.entity.entity-picker.no_match",this.hass)}
        </ha-list-item>
    ...
    `}};t([le({attribute:!1})],ba.prototype,"hass",void 0),t([ce()],ba.prototype,"_params",void 0),t([ce()],ba.prototype,"_search",void 0),t([ce()],ba.prototype,"_filter",void 0),t([ce()],ba.prototype,"_width",void 0),t([ce()],ba.prototype,"_height",void 0),t([ce()],ba.prototype,"expandedGroups",void 0),t([ce()],ba.prototype,"options",void 0),t([ce()],ba.prototype,"scheduleEntities",void 0),ba=t([re("dialog-select-entities")],ba);var ya=Object.freeze({__proto__:null,get DialogSelectEntities(){return ba}});let wa=class extends oe{constructor(){super(...arguments),this.active=!1}render(){return H`
    ...
    `}renderIcon(){if(!this.icon&&!this.toggleable&&!this.useStateIcon)return q;if(this.toggleable)return H`
        <div class="icon">
          <ha-icon
            icon="mdi:check"
          ></ha-icon>
        </div>
      `;if(this.useStateIcon){let e=this.hass.states[this.value||""];return H`
          <div class="icon filled">
            ${e?H`<ha-state-icon .stateObj=${e} .hass=${this.hass}></ha-state-icon>`:H`<ha-icon icon="mdi:help-circle-outline"></ha-icon>
            `}
          </div>
        `}return H`
        <div class="icon filled">
      ...
      `}renderTrailingIcon(){const e="icn_"+Math.random().toString(36).substring(2,9);return this.removable||this.badge?this.badge?H`
        <div class="badge">
          ${this.badge}
        </div>
      `:H`
        <div class="trailing-icon" @click=${this._iconClick}>
          ...
          ${this.disabled?q:H`<ha-tooltip for="${e}">${ds("ui.common.remove",this.hass)}</ha-tooltip>`}
        </div>
    ...
    `}};t([le({attribute:!1})],wa.prototype,"hass",void 0),t([le({type:String})],wa.prototype,"icon",void 0),t([le({type:Boolean})],wa.prototype,"useStateIcon",void 0),t([le({type:Boolean})],wa.prototype,"selectable",void 0),t([le({type:Boolean})],wa.prototype,"removable",void 0),t([le({type:Boolean})],wa.prototype,"toggleable",void 0),t([le({type:Boolean})],wa.prototype,"active",void 0),t([le({type:String})],wa.prototype,"badge",void 0),t([le({type:String})],wa.prototype,"value",void 0),t([le({type:Boolean})],wa.prototype,"disabled",void 0),wa=t([re("scheduler-chip")],wa);let ka=class extends oe{constructor(){super(...arguments),this.value=[]}render(){return this.items?H`
      ${Object.values(this.items).map(e=>this.renderChipitem(e))}
    `:H``}renderChipitem(e){const t=e.useStateIcon&&!Object.keys(this.hass.states).includes(e.value||"");return H`
      <scheduler-chip
        .hass=${this.hass}
    ...
    `}};t([le({attribute:!1})],ka.prototype,"hass",void 0),t([le({attribute:!1})],ka.prototype,"items",void 0),t([le({attribute:!1})],ka.prototype,"value",void 0),t([le({type:Boolean})],ka.prototype,"selectable",void 0),t([le({type:Boolean})],ka.prototype,"toggleable",void 0),t([le({type:Boolean})],ka.prototype,"removable",void 0),t([le({type:Boolean})],ka.prototype,"disabled",void 0),ka=t([re("scheduler-chip-set")],ka);const xa=[{name:"primary",weight:10},{name:"secondary",weight:8}];let $a=class extends oe{constructor(){super(...arguments),this.value=[],this.multiple=!1,this.disabled=!1,this.devicesOnly=!1,this.multipleMode=!1,this.scheduleEntities=[],this._valueRenderer=e=>{Array.isArray(e)&&(e=e.length?[...e].pop():"");const t=e||"",i=this.hass.states[t];if(!i)return H`
        <ha-svg-icon
          slot="start"
          .path=${Qs}
          style="margin: 0 4px"
      ...
      `;const s=this._parseEntityItem(t);return H`
      ${s.icon?H`
        <ha-icon
          slot="start"
          icon="${s.icon}"
    ...
    `},this._rowRenderer=e=>{const t=e.id||"",i=this.hass.states[t];return H`
      <ha-combo-box-item type="button" compact>
        ...
        ${e.secondary?H`<span slot="supporting-text">${e.secondary}</span>`:q}
      </ha-combo-box-item>
    `},this._filteredItems=()=>{let e=Object.keys(this.hass.states);return this.domain&&(e=e.filter(e=>Qi(e)==this.domain)),this.multiple&&(e=e.filter(e=>{var t;return!(null===(t=this.value)||void 0===t?void 0:t.includes(e))})),this.config&&(e=e.filter(e=>((this.config.include||Be).some(t=>ss(t,e))||Object.keys(this.config.customize||{}).some(t=>ss(t,e)))&&!(this.config.exclude||[]).some(t=>ss(t,e)))),e=e.filter(e=>!this.scheduleEntities.includes(e)),this.devicesOnly&&(e=e.filter(e=>is(e,this.hass))),this.filterFunc&&(e=e.filter(e=>this.filterFunc(this.hass.states[e]))),e.map(e=>this._parseEntityItem(e))}}async firstUpdated(){this.scheduleEntities=Object.entries(await Oe(this.hass)).map(([,e])=>e.entity_id),this.domain&&this.config&&!as(this.domain,this.config)&&(this.config=Object.assign(Object.assign({},this.config),{include:[...this.config.include||[],this.domain],exclude:[...(this.config.exclude||[]).filter(e=>!e.startsWith(this.domain))]})),this._autoSelectIfSingleEntity()}updated(e){super.updated(e),e.has("domain")&&this._autoSelectIfSingleEntity()}_autoSelectIfSingleEntity(){if(this.value&&this.value.length>0)return;const e=this._filteredItems();1===e.length&&(this.value=[e[0].id],qs(this,"value-changed",{value:this.value}))}render(){var e,t;return H`
      ${this.renderChips()}

      ${(null===(e=this.value)||void 0===e?void 0:e.length)&&!this.multipleMode&&this.multiple?q:H`

      <ha-generic-picker
        .label=${(null===(t=this.value)||void 0===t?void 0:t.length)?"":ds("ui.components.entity.entity-picker.choose_entity",this.hass)}
        .hass=${this.hass}
        .autofocus=${this.autofocus}
        .notFoundLabel=${ds("ui.components.combo-box.no_match",this.hass)}
        ...
        .searchKeys=${xa}
        .searchLabel=${ds("ui.dialogs.quick-bar.filter_placeholder",this.hass)}
      ...
      `}
    `}renderChips(){if(!this.multiple)return q;let e=(this.value||[]).map(e=>{const t=this._parseEntityItem(e);return{name:t.primary,value:e,useStateIcon:!t.icon,icon:t.icon}});return H`
      <div class="wrapper">
      <scheduler-chip-set
        .hass=${this.hass}
        .items=${e}
  ...
  `,t([le({attribute:!1})],$a.prototype,"hass",void 0),t([le()],$a.prototype,"domain",void 0),t([le()],$a.prototype,"config",void 0),t([le({type:Array})],$a.prototype,"value",void 0),t([le({type:Boolean})],$a.prototype,"multiple",void 0),t([le({type:Boolean})],$a.prototype,"disabled",void 0),t([le({type:Boolean})],$a.prototype,"devicesOnly",void 0),t([ce()],$a.prototype,"multipleMode",void 0),t([ce()],$a.prototype,"scheduleEntities",void 0),$a=t([re("scheduler-entity-picker")],$a);let Sa=class extends oe{constructor(){super(...arguments),this.expanded=!1,this.disabled=!1,this.idx=-1,this.openClose=new CustomEvent("open-close",{detail:{},bubbles:!0,composed:!0})}render(){return H`
      <div
    ...
    `}};t([le({type:Boolean,reflect:!0})],Sa.prototype,"expanded",void 0),t([le({type:Boolean,reflect:!0})],Sa.prototype,"disabled",void 0),t([le({attribute:!0})],Sa.prototype,"idx",void 0),t([le({type:CustomEvent})],Sa.prototype,"openClose",void 0),Sa=t([re("scheduler-collapsible-section")],Sa);let ja=class extends oe{set openedItem(e){e!==this._openedItem&&void 0!==e&&setTimeout(()=>{this.updateOpenedItem(e)},50)}constructor(){super(),this.disabled=!1,this._openedItem=-1,this._numItems=0,this.addEventListener("open-close",this.toggleActiveSection)}firstUpdated(){const e=this.querySelectorAll("scheduler-collapsible-section");this._numItems=e.length}toggleActiveSection(e){if(this.disabled)return;const t=e.target,i=Number(t.getAttribute("idx"));"true"===t.getAttribute("expanded")?this.updateOpenedItem(-1):this.updateOpenedItem(i)}updateOpenedItem(e){this.querySelectorAll("scheduler-collapsible-section").forEach((function(t){const i=Number(t.getAttribute("idx"));i!==e&&t.getAttribute("expanded")?t.removeAttribute("expanded"):i!==e||t.getAttribute("expanded")||t.setAttribute("expanded","true")})),this._openedItem=e;const t=new CustomEvent("openclose-changed",{detail:{item:e}});this.dispatchEvent(t)}render(){return H`
      <slot></slot>
    `}};t([le()],ja.prototype,"disabled",void 0),t([ce()],ja.prototype,"_openedItem",void 0),t([ce()],ja.prototype,"_numItems",void 0),ja=t([re("scheduler-collapsible-group")],ja);const Oa="__NONE_OPTION__";let za=class extends oe{constructor(){super(...arguments),this.disabled=!1}render(){var e;if(this.config.select){const e=this.config.select,t=[this.value||[]].flat().map(String),i=e=>{const i=e.detail;this.value=t.filter(e=>e!=i),qs(this,"value-changed",{value:this.value})},s=()=>{let e=t.map(e=>Object({name:e,value:e}));return H`
        <scheduler-chip-set
          .hass=${this.hass}
          .items=${e}
          removable
          @value-changed=${i}
        >
        </scheduler-chip-set>`},a=e=>{var t;let i=null===(t=this.config.select)||void 0===t?void 0:t.translation_key,s="";return i&&(s=ds(i.replace("${value}",e),this.hass,!1)),s||(s=e),s},o=e=>"object"==typeof e?{id:e.value,primary:a(e.label),icon:e.icon}:{id:e,primary:a(e)};let n=[...null==e?void 0:e.options].map(o),r=[this.value||[]].flat().map(String);n=[...n,...r.filter(e=>!n.find(t=>t.id==e)).map(o)],Array.isArray(this.value)&&(n=n.filter(e=>"object"==typeof e?!t.includes(e.id):!t.includes(e)));const d=()=>{if(!n.length)return H`
          <ha-dropdown-item .value=${Oa}>
            ${this.hass.localize("ui.components.combo-box.no_match")}
          </ha-dropdown-item>
        `;n.some(e=>e.icon);return n.map(e=>H`
          <ha-dropdown-item
            .value=${e.id}
          >
            ${e.icon?H`<ha-icon slot="icon" .icon=${e.icon}></ha-icon>`:q}
            <span>${e.primary}</span>
          </ha-dropdown-item>
        `)},l=e=>{let t=e.target,i=t.querySelector("ha-picker-field");this.style.setProperty("--select-menu-width",i.offsetWidth+"px"),t.classList.add("opened")},c=e=>{e.target.classList.remove("opened")},h=e=>{const t=e.detail.item.value;(t!=Oa&&!Array.isArray(this.value)||(e.target.value=void 0,t!=Oa))&&this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))},u=()=>{this._valueChanged(new CustomEvent("value-changed",{detail:{value:void 0}}))},p=Ke(this.value)&&!Array.isArray(this.value)?n.find(e=>e.id===this.value):void 0,m=p?p.primary||p.id:Ke(this.value)&&!Array.isArray(this.value)?this.value:void 0;return H`
      ...
      `}if(this.config.number){const t=this.config.number,i="box"==t.mode||!Ke(t.min)||!Ke(t.max);let s=this.value;i||"number"==typeof s||(s=t.min),"number"==typeof t.scale_factor&&(s=Number(s)/t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(s=Math.round(Number(s)/t.step)*t.step),Ke(s)&&(s=vs(Number(s)));const a=e=>{let i=Number(e.target.value);"number"==typeof t.scale_factor&&(i*=t.scale_factor),"number"==typeof(null==t?void 0:t.step)&&(i=Math.round(i/t.step)*t.step),i=vs(i),this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}})),e.stopPropagation()},o=e=>{e.stopPropagation();let t=e.target.value;const i=""===t||isNaN(Number(t))?void 0:Number(t);this._valueChanged(new CustomEvent("value-changed",{detail:{value:i}}))},n=(e,i)=>{let s=t.step&&Number(t.step)%1==0?null!==e.match(/^-?\d+$/):null!==e.match(/^[+-]?\d+([.,]\d+)?$/);return s&&Ke(t.min)&&(s=Number(e)>=t.min),s&&Ke(t.max)&&(s=Number(e)<=t.max),{valid:s,customError:!s}};return H`
      ...
      `}if(this.config.text){this.config.text;return H`
      ...
      `}if(this.config.boolean){let e={select:{options:[{value:"true",label:"True",icon:"mdi:check"},{value:"false",label:"False",icon:"mdi:close"}]}};const t=e=>{let t=Ke(e.detail.value)?"true"===e.detail.value:void 0;e.stopPropagation(),this._valueChanged(new CustomEvent("value-changed",{detail:{value:t}}))};return H`
      ...
      `}return H``}_valueChanged(e){if(e.stopPropagation(),Array.isArray(this.value)){let t=e.detail.value;if(!t)return;this.value=[...this.value,t]}else if(e.detail){let t=e.detail.value;void 0===t&&(t=null),this.value=t}else this.value=e.target.value;qs(this,"value-changed",{value:this.value})}};za.styles=r`
      :host {
        display: flex;
        width: 100%;
      }
  ...
  `,t([le({attribute:!1})],Ca.prototype,"hass",void 0),t([le()],Ca.prototype,"_config",void 0),t([le()],Ca.prototype,"title",void 0),t([le()],Ca.prototype,"tagOptions",void 0),t([ce()],Ca.prototype,"customTagValue",void 0),Ca=t([re("scheduler-card-editor")],Ca);const Ea=r`
  ha-dialog {
...
`,(e,t,i,s)=>{var a;const o=e.service,n=null===(a=e.target)||void 0===a?void 0:a.entity_id,r=gs(e,s);if(!r||!r.fields||!Object.keys(r.fields).includes(t))return!1;const d=r.fields[t];if(null===ws(o,n,t,i,s))return!1;if(Object.keys(e.service_data||{}).includes(t))return!0;if(d.supported_features){if(![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;return((i.states[e].attributes.supported_features||0)&d.supported_features)>0}))return!1}return!("light"==Qi(o)&&![n||[]].flat().every(e=>{if(!Object.keys(i.states).includes(e))return!1;const s=i.states[e].attributes.supported_color_modes||[];return"brightness"==t?s.filter(e=>"onoff"!=e).length:"color_temp_kelvin"!=t||s.includes("color_temp")}))});var Da;!function(e){e.OverlappingTime="overlapping_time",e.MissingTargetEntity="missing_target_entity",e.MissingServiceParameter="missing_service_parameter",e.MissingAction="missing_action"}(Da||(Da={}));const Ta=(e,t,i)=>{let s=[];s=[...s,...e.entries.map(e=>((e,t)=>e.every((i,s)=>{const a=Te(i.start,t),o=void 0===i.stop?a:Te(i.stop,t)||86400;return!(a>o)&&e.every((e,i)=>{if(i<=s)return!0;return Te(e.start,t)>=o})})?null:Da.OverlappingTime)(e.slots,t)).filter(e=>null!==e)];let a=e.entries.map(e=>e.slots.map(e=>e.actions)).flat().flat();return a.length||(s=[...s,Da.MissingAction]),s=[...s,...a.map(e=>((e,t,i)=>{var s;const a=gs(e,i);return(null==a?void 0:a.target)&&!(null===(s=e.target)||void 0===s?void 0:s.entity_id)?Da.MissingTargetEntity:(null==a?void 0:a.fields)&&!Object.entries(a.fields).filter(([s])=>Aa(e,s,t,i)).every(([s,a])=>{var o,n;let r=ws(e.service,null===(o=e.target)||void 0===o?void 0:o.entity_id,s,t,i);const d=!(!r.number||!(null===(n=r.number)||void 0===n?void 0:n.optional))||a.optional;return!(!Object.keys(e.service_data).includes(s)&&!d)&&!(!Ke(e.service_data[s])&&!d)})?Da.MissingServiceParameter:null})(e,t,i)).filter(e=>null!==e)],s.length?s.shift():null},Ma=(e,t)=>{const i=Pa(t);return e.callApi("POST","scheduler/add",i)},Pa=e=>{const t=e=>e.actions.length?(e.stop||(e=Object.fromEntries(Object.entries(e).filter(([e])=>"stop"!=e))),e):null;let i={weekdays:(e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map(t).filter(e=>null!==e)}))})).entries[0].weekdays.map(La),timeslots:e.entries[0].slots.map(Na),name:e.name,start_date:e.start_date,end_date:e.end_date,repeat_type:e.repeat_type,tags:e.tags||[]};return e.schedule_id&&(i=Object.assign(Object.assign({},i),{schedule_id:e.schedule_id})),i},La=e=>{switch(e){case _e.Monday:return"mon";case _e.Tuesday:return"tue";case _e.Wednesday:return"wed";case _e.Thursday:return"thu";case _e.Friday:return"fri";case _e.Saturday:return"sat";case _e.Sunday:return"sun";case _e.Workday:return"workday";case _e.Weekend:return"weekend";default:return"daily"}},Na=e=>({start:e.start,stop:e.stop,name:e.name,color:e.color,enforce:e.enforce,track:e.track,priority:e.priority,start_date:e.start_date,end_date:e.end_date,actions:e.actions.map(e=>Ia(e)).flat(),condition_type:e.conditions.items.length?e.conditions.type==ge.And?"and":"or":void 0,conditions:e.conditions.items.length?e.conditions.items:void 0,track_conditions:e.conditions.track_changes}),Ia=e=>{var t,i;const s=e=>Object.keys(e).filter(t=>Ke(e[t])).reduce((t,i)=>(t[i]=e[i],t),{});if(e.target){if(Array.isArray(null===(t=e.target)||void 0===t?void 0:t.entity_id)){return null==e?void 0:e.target.entity_id.map(t=>({service:e.service,service_data:s(e.service_data),entity_id:t}))}return{service:e.service,service_data:s(e.service_data),entity_id:null===(i=e.target)||void 0===i?void 0:i.entity_id}}return{service:e.service,service_data:s(e.service_data)}},Ha=(e,t,i)=>{const s={title:ds("state_badge.default.error",i),description:H`
  ...
  `,primaryButtonLabel:ds("ui.common.ok",i),confirm:()=>{},cancel:()=>{}};qs(t,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ao})),dialogParams:s})},Ra=(e,t)=>e.callApi("POST","scheduler/remove",{schedule_id:t}),qa=(e,t)=>{const i=Pa(t);return e.callApi("POST","scheduler/edit",i)},Va=e=>{if(!Object.keys(e).includes("select")||!e.select){if(Object.keys(e).includes("number")&&e.number){const t=e.number.min;return void 0!==t?t:0}return Object.keys(e).includes("boolean")&&e.boolean?void 0:(Object.keys(e).includes("text")&&e.text,"")}e.select.options},Fa=e=>JSON.stringify(Object.fromEntries(Object.entries(e||{}).sort(([e],[t])=>e.localeCompare(t)))),Ba=(e,t)=>e.length===t.length&&e.every((e,i)=>{const s=t[i];return e.service===s.service&&Fa(e.service_data)===Fa(s.service_data)&&Fa(e.target)===Fa(s.target)}),Wa=e=>{const t=[];for(const i of e){const e=t[t.length-1];e&&void 0!==e.stop&&Ba(e.actions,i.actions)&&JSON.stringify(e.conditions)===JSON.stringify(i.conditions)?t[t.length-1]=Object.assign(Object.assign({},e),{stop:i.stop}):t.push(i)}return t},Ua=(e,t)=>{const i=gs(e,t),s=Qi(e.service),a=Ji(e.service);if(i.icon)return(o=i.icon).match(/^[a-z]+\:[a-zA-Z\-]+$/)?o:"mdi:"+o;if(Object.keys(ys).includes(s)&&Object.keys(ys[s].services).includes(a)){if(void 0!==ys[s].attributes){let t=ys[s].attributes;const i=Object.keys(t).find(t=>Object.keys(e.service_data).includes(t));if(i&&Object.keys(t[i]).includes(e.service_data[i]))return t[i][e.service_data[i]]}return ys[s].services[a]}return Object.keys(ys).includes(s)&&Object.keys(ys[s].services).includes("{entity_id}")?ys[s].services["{entity_id}"]:"mdi:flash";var o},Za=e=>{var t;return"turn_off"===Ji(e.service)||"off"===(null===(t=e.service_data)||void 0===t?void 0:t.state)},Ka=e=>{var t;return"turn_on"===Ji(e.service)||"on"===(null===(t=e.service_data)||void 0===t?void 0:t.state)},Xa=e=>{const t=Ji(e.service);if("turn_on"!==t&&"turn_off"!==t)return null;const i=e.service.split(".")[0];return Object.assign({service:`${i}.${"turn_on"===t?"turn_off":"turn_on"}`,service_data:{}},e.target?{target:e.target}:{})},Ga=(e,t,i)=>{let s=Te("string"==typeof e?De(e):e,i),a=Te("string"==typeof t?De(t):t,i);return a>s?1:a<s?-1:0},Ya=e=>De(e.start),Ja=e=>{if(Ke(e.stop)){const t=De(e.stop);return 0==t.hours&&0==t.minutes&&t.mode==we.Fixed?Object.assign(Object.assign({},t),{hours:24}):t}return Ce(Ya(e),{minutes:1})},Qa=(e,t,i,s)=>{let a=t;if(Ke(i.stop))return[e,a]=Qa(e,t+1,{start:i.stop},s),[e,a-1];if(!Ke(i.start))return[e,a];let o=Ya(e[t]),n=i.start,r=Ya(e[t]);for(let i=t-1;i>=0;i--){if(e[i].actions.length){r=i==t-1?Ce(Ya(e[i]),{minutes:1}):Ja(e[i]);break}r=Ya(e[i])}let d=Ce(Ja(e[t]),{minutes:-1});if(!Ke(e[t].stop))for(let i=t+1;i<e.length;i++){if(e[i].actions.length){d=i==t+1?Ce(Ja(e[i]),{minutes:-1}):Ya(e[i]);break}d=Ja(e[i])}if(Ga(r,n,s)<0&&(n=r),Ga(d,n,s)>0&&Te(d,s)>0&&(n=d),e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Re(n)})}),Ga(o,n,s)<=0)for(let i=t-1;i>=0;i--){let t=Ga(Ya(e[i]),n,s),o=Ga(Ja(e[i]),n,s);if(t>0&&o<=0){e=Object.assign(e,{[i]:Object.assign(Object.assign({},e[i]),{stop:Re(n)})});break}if(o>=0)break;t<=0&&(e=Object.assign(e,{[i]:null}),a-=1)}if(Ga(o,n,s)<0&&!Ke(e[t].stop)&&(e=Ke(e[t+1].stop)&&!e[t+1].actions.length?Object.assign(e,{[t+1]:Object.assign(Object.assign({},e[t+1]),{start:Re(Ja(e[t]))})}):[...e.slice(0,t+1),Object.assign(Object.assign({},e[t]),{start:Re(Ja(e[t])),stop:Re(Ya(e[t+1])),actions:[]}),...e.slice(t+1)]),Ga(o,n,s)>=0)for(let t=a+1;t<e.length;t++){let i=Ja(e[a]),o=Ga(Ya(e[t]),i,s),n=Ga(Ja(e[t]),i,s);if(o>=0&&n<0)e=Object.assign(e,{[t]:Object.assign(Object.assign({},e[t]),{start:Re(i)})});else{if(o<0)break;n>=0&&(e=Object.assign(e,{[t]:null}))}}return Ga(o,n,s)>0&&(t>0&&Ke(e[t-1].stop)?e=Object.assign(e,{[t-1]:Object.assign(Object.assign({},e[t-1]),{stop:Re(n)})}):(e=[...e.slice(0,t),Object.assign(Object.assign({},e[t]),{start:t>0?Re(Ja(e[t-1])):"00:00:00",stop:Re(n),actions:[]}),...e.slice(t)],a=t+1)),[e=e.filter(Ke),a]},eo=e=>{const t=Math.floor(e/3600),i=Math.round((e-3600*t)/60),s={mode:we.Fixed,hours:t,minutes:i};return Re(s)},to=(e,t,i,s)=>{const a=e.map((t,i)=>{const a=Te(t.start,s);let o;return void 0!==t.stop?(o=Te(t.stop,s),!o&&a&&(o=86400)):o=i+1<e.length&&Te(e[i+1].start,s)||86400,{start:a,stop:o}}),o=e.find((e,s)=>a[s].stop>t&&a[s].start<i)||e[0];let n=[],r=-1;return e.forEach((e,s)=>{const d=a[s];d.stop<=t?n.push(e):(-1===r&&(d.start<t&&n.push(Object.assign(Object.assign({},e),{stop:eo(t)})),r=n.length,n.push({start:eo(t),stop:eo(i),actions:[],conditions:o.conditions})),d.start>=i?n.push(e):d.stop>i&&n.push(Object.assign(Object.assign({},e),{start:eo(i)})))}),-1===r&&(r=n.length,n.push({start:eo(t),stop:eo(i),actions:[],conditions:o.conditions})),[n,r]},io=[67,160,71],so=e=>{if(!Ka(e))return null;const t=e.service_data||{};let i,s;var a;let o;if(Array.isArray(t.rgb_color)&&t.rgb_color.length>=3&&t.rgb_color.slice(0,3).every(e=>"number"==typeof e)&&(i=t.rgb_color.slice(0,3)),"number"==typeof t.color_temp_kelvin?s=t.color_temp_kelvin:"number"==typeof t.color_temp&&(a=t.color_temp,s=Math.round(1e6/a)),"number"==typeof t.brightness?o=t.brightness/255*100:"number"==typeof t.brightness_pct&&(o=t.brightness_pct),void 0===i&&void 0===s&&void 0===o)return null;return{rgb:void 0!==i?i:void 0!==s?(e=>{const t=Math.min(Math.max(e,1e3),12e3)/100;let i,s,a;t<=66?(i=255,s=99.4708025861*Math.log(t)-161.1195681661,a=t<=19?0:138.5177312231*Math.log(t-10)-305.0447927307):(i=329.698727446*Math.pow(t-60,-.1332047592),s=288.1221695283*Math.pow(t-60,-.0755148492),a=255);const o=e=>Math.round(Math.min(Math.max(e,0),255));return[o(i),o(s),o(a)]})(s):io,alpha:void 0!==o?.25+.6*Math.min(Math.max(o,0),100)/100:.75}},ao=(e,t)=>{if(!e)return[];const i=[1,2,3,4,6,8,12],s=t?88:56;let a=Math.ceil(24/(e/s));for(;!i.includes(a);)a++;const o=[0,...Array.from(Array(24/a-1).keys()).map(e=>(e+1)*a),24];return o.map((e,t)=>{let i=a/24*100;return i=Math.floor(100*i)/100,0!==t&&t!==o.length-1||(i/=2),{hour:e,widthPct:i,align:0===t?"left":t===o.length-1?"right":"center"}})},oo=(e,t,i,s=3,a=5)=>{const o=i-(e.length-1)*s,n=e.map((i,s)=>{const a=Te(i.start,t);let o;if(void 0!==i.stop)o=Te(i.stop,t),!o&&a&&(o=86400);else{const i=e[s+1];o=i&&Te(i.start,t)||86400}return(o-a)/86400}),r=a/o,d=o-n.filter(e=>e<r).length*a;return n.map(e=>e<r?a:e*d)},no=(e,t,i,s=3,a=null)=>{const o=t=>null!==a&&e[a]===t?"pending":t.actions.length?Za(t.actions[0])?"off":Ka(t.actions[0])?"on":"":"empty",n=e=>{const t=e.actions.length?so(e.actions[0]):null;return t?`rgba(${t.rgb.join(", ")}, ${t.alpha})`:void 0},r=[];let d=0;e.forEach((a,l)=>{0===l&&r.push({position:d,label:Re(De(a.start),{seconds:!1,am_pm:i}),align:"start",state:o(a),color:n(a)});const c=d+t[l],h=l===e.length-1;void 0!==a.stop&&r.push({position:c,label:Re(De(a.stop),{seconds:!1,am_pm:i}),align:h?"end":"middle",state:o(h?a:e[l+1]),color:n(h?a:e[l+1])}),d=c+(h?0:s)});const l=[],c=r.map(e=>{const t=7*e.label.length+6;const i="end"===e.align?e.position-t:e.position-t/2,s="start"===e.align?e.position+t:e.position+t/2;let a=l.findIndex(e=>i>e);return-1===a&&(a=l.length),l[a]=s,a}),h=c.reduce((e,t)=>Math.max(e,t),0);return{boundaries:r.map((e,t)=>Object.assign(Object.assign({},e),{tier:c[t]})),maxTier:h}},ro=(e,t)=>{const i=new Date(t),s=3600*i.getHours()+60*i.getMinutes()+i.getSeconds();let a=3600*e.hours+60*e.minutes-s;const o=a<0?-1:1;a=Math.abs(a);let n=Math.floor(a/3600),r=Math.round((a-3600*n)/60);return o<0&&(n>0&&(n=-n),r=-r),Ee({hours:n,minutes:r})},lo=(e,t)=>{const i=Math.floor(e/3600),s=Math.round((e-3600*i)/60);return Re({mode:we.Fixed,hours:i,minutes:s},{seconds:!1,am_pm:t})};let co=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this._width=0,this._zoom=1,this._panPx=0,this.pendingSlot=null,this._suppressNextClick=!1,this._undoStack=[],this.large=!1,this._handleKeyDown=e=>{const t=e.composedPath()[0],i=t instanceof HTMLElement&&(["input","textarea","select"].includes(t.tagName.toLowerCase())||t.isContentEditable);if("z"===e.key.toLowerCase()&&(e.ctrlKey||e.metaKey)&&!e.shiftKey&&!i)return e.preventDefault(),void this._undo();if("Delete"!==e.key&&"Backspace"!==e.key)return;if(null===this.selectedSlot||!this.schedule)return;if(i)return;if(null!==this.pendingSlot&&this.selectedSlot===this.pendingSlot)return e.preventDefault(),this._revertPendingSlot(null),this.selectedSlot=null,void this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:null}}));const s=this.schedule.slots;if(s.length<=2)return;e.preventDefault(),this._pushUndo();const a=this.selectedSlot,o=a===s.length-1?a-1:a;let n=[...s.slice(0,o),Object.assign(Object.assign({},s[o+1]),{start:s[o].start,stop:s[o+1].stop}),...s.slice(o+2)];n=Wa(n),this.schedule=Object.assign(Object.assign({},this.schedule),{slots:n}),this.selectedSlot=null,this.dispatchEvent(new CustomEvent("update",{detail:{slots:n}})),this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:null}}))}}_pushUndo(){this.schedule&&this._undoStack.push(this.schedule.slots),this._undoStack.length>50&&this._undoStack.shift()}_undo(){const e=this._undoStack.pop();e&&this.schedule&&(this.schedule=Object.assign(Object.assign({},this.schedule),{slots:e}),this.pendingSlot=null,this._slotsBackup=void 0,this.dispatchEvent(new CustomEvent("update",{detail:{slots:e}})))}get _contentWidth(){return this._width*this._zoom}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e!==this._width&&(this._width=e,this._panPx=this._clampPan(this._panPx,this._zoom))}}),this._resizeObserver.observe(this),window.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect(),this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame),window.removeEventListener("keydown",this._handleKeyDown)}_clampPan(e,t){const i=Math.max(0,this._width*t-this._width);return Math.min(Math.max(e,0),i)}_setZoom(e,t){const i=Math.min(Math.max(e,1),48),s=this._width*this._zoom,a=this._panPx+t,o=(s>0?a/s:0)*(this._width*i)-t;this._zoom=i,this._panPx=this._clampPan(o,i)}_animateZoomBy(e,t){this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame);const i=this._zoom,s=Math.min(Math.max(i*e,1),48),a=performance.now(),o=e=>{const n=Math.min((e-a)/220,1),r=1-Math.pow(1-n,3),d=i+(s-i)*r;this._setZoom(d,t),this._zoomAnimationFrame=n<1?requestAnimationFrame(o):void 0};this._zoomAnimationFrame=requestAnimationFrame(o)}_handleZoomInClick(){this._animateZoomBy(3,this._width/2)}_handleZoomOutClick(){this._animateZoomBy(1/3,this._width/2)}_handleZoomResetClick(){this._zoomAnimationFrame&&cancelAnimationFrame(this._zoomAnimationFrame);const e=this._zoom,t=this._panPx,i=performance.now(),s=a=>{const o=Math.min((a-i)/220,1),n=1-Math.pow(1-o,3);this._zoom=e+(1-e)*n,this._panPx=t+(0-t)*n,this._zoomAnimationFrame=o<1?requestAnimationFrame(s):void 0};this._zoomAnimationFrame=requestAnimationFrame(s)}_handleWheel(e){if(!this._width)return;const t=e.ctrlKey||e.metaKey||Math.abs(e.deltaY)>=Math.abs(e.deltaX);e.preventDefault();const i=e.currentTarget.getBoundingClientRect(),s=e.clientX-i.left;if(t){this._zoomAnimationFrame&&(cancelAnimationFrame(this._zoomAnimationFrame),this._zoomAnimationFrame=void 0);const t=Math.pow(2,-e.deltaY/60);this._setZoom(this._zoom*t,s)}else this._panPx=this._clampPan(this._panPx+e.deltaX,this._zoom)}_handleRulerPanStart(e){this._zoom<=1||(e.currentTarget.setPointerCapture(e.pointerId),this._panDrag={pointerId:e.pointerId,startX:e.clientX,startPanPx:this._panPx})}_handleRulerPanMove(e){if(!this._panDrag||this._panDrag.pointerId!==e.pointerId)return;const t=e.clientX-this._panDrag.startX;this._panPx=this._clampPan(this._panDrag.startPanPx-t,this._zoom)}_handleRulerPanEnd(){this._panDrag=void 0}_touchDistance(e){const t=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.hypot(t,i)}_handlePinchStart(e){if(2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect(),i=(e.touches[0].clientX+e.touches[1].clientX)/2-t.left;this._pinch={distance:this._touchDistance(e.touches),midpointX:i,panPx:this._panPx,zoom:this._zoom}}_handlePinchMove(e){if(!this._pinch||2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect(),i=(e.touches[0].clientX+e.touches[1].clientX)/2-t.left,s=this._touchDistance(e.touches)/this._pinch.distance,a=Math.min(Math.max(this._pinch.zoom*s,1),48),o=this._width*this._pinch.zoom,n=this._pinch.panPx+this._pinch.midpointX,r=(o>0?n/o:0)*(this._width*a)-i,d=-(i-this._pinch.midpointX);this._zoom=a,this._panPx=this._clampPan(r+d,a)}_handlePinchEnd(e){e.touches.length<2&&(this._pinch=void 0)}get _dragStepSize(){return this._zoom>=4?1:this.config.time_step||15}_clientXToTs(e,t=!0){const i=this.shadowRoot.querySelector(".bar").getBoundingClientRect();let s="rtl"===getComputedStyle(this).direction?i.right-e:e-i.left;s<0&&(s=0),s>i.width&&(s=i.width);let a=Math.round(s/i.width*86400);if(t){const e=60*this._dragStepSize;a=Math.round(a/e)*e}return a}_handleCreateDragStart(e){if(0!==e.button)return;const t=e.target.closest(".slot");if(!t)return;if(this._pinch)return;if("touch"===e.pointerType){const t=performance.now(),i=void 0!==this._lastBarTap&&t-this._lastBarTap.time<400&&Math.abs(e.clientX-this._lastBarTap.x)<50;if(this._lastBarTap={time:t,x:e.clientX},!i)return void this._startBarPan(e)}else{const i=performance.now(),s=void 0!==this._lastBarClick&&i-this._lastBarClick.time<400&&Math.abs(e.clientX-this._lastBarClick.x)<10;if(this._lastBarClick={time:i,x:e.clientX},!s)return void this._startBodyResizeDrag(e,t)}this._createDrag={startClientX:e.clientX,ts0:this._clientXToTs(e.clientX),active:!1};const i=e=>{if(!this._createDrag)return;if(this._pinch)return this._createDrag=void 0,void(this._createRange=void 0);if(!this._createDrag.active&&Math.abs(e.clientX-this._createDrag.startClientX)<5)return;this._createDrag.active=!0;const t=this._clientXToTs(e.clientX),i=Math.min(this._createDrag.ts0,t),s=Math.max(this._createDrag.ts0,t);this._createRange={ts0:i,ts1:s}},s=()=>{window.removeEventListener("pointermove",i),window.removeEventListener("pointerup",s),window.removeEventListener("pointercancel",s);const e=this._createDrag;this._createDrag=void 0;const t=this._createRange;if(this._createRange=void 0,!(null==e?void 0:e.active)||!t)return;this._suppressNextClick=!0;const a=60*this._dragStepSize;t.ts1-t.ts0<a||this._commitCreate(t.ts0,t.ts1)};window.addEventListener("pointermove",i),window.addEventListener("pointerup",s),window.addEventListener("pointercancel",s)}_startBarPan(e){const t=e.clientX,i=this._panPx;let s=!1;const a=e=>{if(this._pinch)return;const a=e.clientX-t;!s&&Math.abs(a)<5||(s=!0,this._panPx=this._clampPan(i-a,this._zoom))},o=()=>{window.removeEventListener("pointermove",a),window.removeEventListener("pointerup",o),window.removeEventListener("pointercancel",o),s&&(this._suppressNextClick=!0)};window.addEventListener("pointermove",a),window.addEventListener("pointerup",o),window.addEventListener("pointercancel",o)}_commitCreate(e,t){const i=[...this.schedule.slots];this._pushUndo();let[s,a]=to(i,e,t,this.hass);const o=[s[a-1],s[a+1]].find(e=>{var t;return(null===(t=null==e?void 0:e.actions)||void 0===t?void 0:t.length)&&null!==Xa(e.actions[0])}),n=o?Xa(o.actions[0]):null;n?(s=Object.assign([...s],{[a]:Object.assign(Object.assign({},s[a]),{actions:[n]})}),this.pendingSlot=null,this._slotsBackup=void 0):(this._slotsBackup=null!==this.pendingSlot&&this._slotsBackup?this._slotsBackup:i,this.pendingSlot=a),this.selectedSlot=a,this.schedule=Object.assign(Object.assign({},this.schedule),{slots:s}),this.dispatchEvent(new CustomEvent("update",{detail:{slots:s}})),this.dispatchEvent(new CustomEvent("update",{detail:{selectedSlot:a}}))}_revertPendingSlot(e){const t=this._slotsBackup;let i=null;if(null!==e&&this.schedule.slots[e]){const s=Te(this.schedule.slots[e].start,this.hass);i=t.findIndex((e,i)=>{const a=Te(e.start,this.hass);let o=void 0!==e.stop?Te(e.stop,this.hass)||86400:i+1<t.length?Te(t[i+1].start,this.hass):86400;return s>=a&&s<o}),-1===i&&(i=null)}return this.pendingSlot=null,this._slotsBackup=void 0,this.schedule=Object.assign(Object.assign({},this.schedule),{slots:t}),this.dispatchEvent(new CustomEvent("update",{detail:{slots:t}})),i}willUpdate(){var e,t,i;null!==this.pendingSlot&&((null===(i=null===(t=null===(e=this.schedule)||void 0===e?void 0:e.slots[this.pendingSlot])||void 0===t?void 0:t.actions)||void 0===i?void 0:i.length)||0)>0&&(this.pendingSlot=null,this._slotsBackup=void 0)}render(){const e=Math.round(100*this._zoom),t=getComputedStyle(this).direction;return H`
      ...
      >
        <div
          class="zoom-content"
          style=${la({width:this._contentWidth+"px",transform:`translateX(${-this._panPx}px)`})}
        >
          <div class="slots-wrapper" style=${la({direction:t})}>
          ...
          <div
            class="time-bar"
            style=${la({direction:t,cursor:this._zoom>1?"grab":"default"})}
    ...
    `}renderTimebar(){const e=Le(this.hass.locale);return ao(this._contentWidth,e).map(t=>{const i={mode:we.Fixed,hours:t.hour,minutes:0},s=Re(i,{seconds:!1,am_pm:e}),a="left"===t.align?"left":"right"===t.align?"right":"";return H`
        <span class="${a}" style=${la({width:t.widthPct+"%"})}>${s}</span>
      `})}renderTimeslots(){const e=this.schedule.slots,t=this.computeSlotWidths();return e.map((i,s)=>{const a=i.actions.length?Cs(i.actions[0],this.hass,this.config.customize,!0,!0):"",o=5*a.length+10,n=s>0?15:0,r=s<e.length-1?15:0,d=t[s]-n-r,l=e[s+1],c=i.actions.length?Za(i.actions[0])?"off":Ka(i.actions[0])?"on":"":"",h=i.actions.length?so(i.actions[0]):null,u=h?{background:`rgba(${h.rgb.join(", ")}, ${h.alpha})`,border:this.selectedSlot==s?"3px solid rgb(var(--rgb-state-active-color, 67, 160, 71))":"2px solid rgba(var(--rgb-state-active-color, 67, 160, 71), 0.9)"}:{};return H`
        <div
          class="slot ${this.selectedSlot==s?"selected":""} ${i.actions.length?c:"empty"} ${void 0===i.stop?"short":""} ${this.pendingSlot===s?"pending":""}"
          style="${la(Object.assign({width:t[s]+"px"},u))}"
          @click=${this._toggleSelectTimeslot}
          idx="${s}"
        >
          ${i.stop,""}
          ${i.actions.length?a&&(d>o/3||d>50)&&d>30?H`<span style="margin-inline-start: ${n}px; margin-inline-end: ${r}px">${a}</span>`:d>16?H`<ha-icon icon="${Ua(i.actions[0],this.config.customize)}"></ha-icon>`:"":""}
        </div>
        ${s<e.length-1&&i.stop?H`
    ...
    `}};t([le({attribute:!1})],co.prototype,"config",void 0),t([ce()],co.prototype,"schedule",void 0),t([ce()],co.prototype,"selectedSlot",void 0),t([ce()],co.prototype,"_width",void 0),t([ce()],co.prototype,"_zoom",void 0),t([ce()],co.prototype,"_panPx",void 0),t([ce()],co.prototype,"_createRange",void 0),t([ce()],co.prototype,"pendingSlot",void 0),t([le({type:Boolean})],co.prototype,"large",void 0),co=t([re("scheduler-timeslot-editor")],co);const ho=e=>{let t=60*e.hours+e.minutes;return t>240?e=Object.assign(Object.assign({},e),{hours:4,minutes:0}):t<-240&&(e=Object.assign(Object.assign({},e),{hours:-4,minutes:0})),e};let uo=class extends oe{constructor(){super(...arguments),this.hours=0,this.minutes=0,this.mode=we.Fixed,this.autoValidate=!0,this.required=!0,this.disabled=!1,this.label="",this.useAmPm=!1,this.large=!1,this.stepSize=10}set time(e){const t=De(e);this.mode=t.mode,this.hours=t.hours,this.minutes=t.minutes}render(){return H`
      <div class="time-input-wrap">
        <div class="input">
          ${this.label?H`<span class="label">${this.label}</span>`:q}
    ...
    `}_renderTimeMode(){if(!this.hass.states["sun.sun"])return q;if(this.large){const e=()=>{let e=this._convertTimeMode();e.mode!=we.Fixed&&(e=ho(e)),this.mode=e.mode,this.hours=e.hours,this.minutes=e.minutes,this._valueChanged()};return H`
        <div class="mode">
          ${this.hass.states["sun.sun"]?H`
          <ha-button
      ...
      `}{let e=[we.Fixed,we.Sunrise,we.Sunset];const t={[we.Fixed]:ds("ui.components.selectors.selector.types.time",this.hass),[we.Sunrise]:ds("ui.panel.config.automation.editor.triggers.type.sun.sunrise",this.hass),[we.Sunset]:ds("ui.panel.config.automation.editor.triggers.type.sun.sunset",this.hass)},i={[we.Fixed]:"mdi:clock-outline",[we.Sunrise]:"mdi:weather-sunset-up",[we.Sunset]:"mdi:weather-sunset-down"},s={[we.Fixed]:"M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.47,22 2,17.5 2,12A10,10 0 0,1 12,2M12.5,7V12.25L17,14.92L16.25,16.15L11,13V7H12.5Z",[we.Sunrise]:"M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,16.3L15.82,19.41C16.21,19.8 16.21,20.43 15.82,20.82C15.43,21.21 14.8,21.21 14.41,20.82L12,18.41L9.59,20.82C9.2,21.21 8.57,21.21 8.18,20.82C7.79,20.43 7.79,19.8 8.18,19.41L11.29,16.3C11.5,16.1 11.74,16 12,16C12.26,16 12.5,16.1 12.71,16.3Z",[we.Sunset]:"M3,12H7A5,5 0 0,1 12,7A5,5 0 0,1 17,12H21A1,1 0 0,1 22,13A1,1 0 0,1 21,14H3A1,1 0 0,1 2,13A1,1 0 0,1 3,12M15,12A3,3 0 0,0 12,9A3,3 0 0,0 9,12H15M12,2L14.39,5.42C13.65,5.15 12.84,5 12,5C11.16,5 10.35,5.15 9.61,5.42L12,2M3.34,7L7.5,6.65C6.9,7.16 6.36,7.78 5.94,8.5C5.5,9.24 5.25,10 5.11,10.79L3.34,7M20.65,7L18.88,10.79C18.74,10 18.47,9.23 18.05,8.5C17.63,7.78 17.1,7.15 16.5,6.64L20.65,7M12.71,20.71L15.82,17.6C16.21,17.21 16.21,16.57 15.82,16.18C15.43,15.79 14.8,15.79 14.41,16.18L12,18.59L9.59,16.18C9.2,15.79 8.57,15.79 8.18,16.18C7.79,16.57 7.79,17.21 8.18,17.6L11.29,20.71C11.5,20.9 11.74,21 12,21C12.26,21 12.5,20.9 12.71,20.71Z"},a=e=>{if(e==we.Fixed)return!1;const t=this._convertTimeMode(e);return Math.abs(60*t.hours+t.minutes)>240};return H`
      <ha-dropdown
    ...
    `}}_renderSuffix(){if(this.large){const e=()=>{let e=Ie(this.hours).am_pm;const t=Ie(this.hours).hours;this.hours=He(t,"AM"==e?Ne.PM:Ne.AM),this._valueChanged()},t=()=>{0!=this.hours?this.hours=-this.hours:this.minutes=-this.minutes,this._valueChanged()},i=()=>{this.mode=this.mode==we.Sunrise?we.Sunset:we.Sunrise,this._valueChanged()};return H`
        <div class="suffix">
        ${this.useAmPm&&this.mode==we.Fixed?H`
      ...
      `}return this.useAmPm&&this.mode==we.Fixed?H`
        <ha-select
          .required=${this.required}
      ...
      `:q}_convertTimeMode(e){const t=this.hass.states["sun.sun"].attributes.next_rising,i=this.hass.states["sun.sun"].attributes.next_setting;if(e&&e!=we.Fixed||this.mode==we.Fixed){const s=ro({hours:this.hours,minutes:this.minutes},t),a=ro({hours:this.hours,minutes:this.minutes},i),o=60*s.hours+s.minutes,n=60*a.hours+a.minutes;let r=e||(Math.abs(o)<=Math.abs(n)?we.Sunrise:we.Sunset),d=r==we.Sunrise?s:a;return{mode:r,hours:d.hours,minutes:d.minutes}}{let e=this.mode==we.Sunrise?De(t):De(i);return e=Ce(e,{hours:this.hours,minutes:this.minutes}),{mode:we.Fixed,hours:e.hours,minutes:e.minutes}}}_hoursChanged(e){let t=Number(e.target.value);if(this.useAmPm){const e=Ie(this.hours).am_pm;t=He(t,e)}this.hours=t,this._valueChanged()}_minutesChanged(e){const t=Number(e.target.value);this.minutes=t,this._valueChanged()}_amPmChanged(e){const t=e.detail.value;if(Ie(this.hours).am_pm==t)return;const i=Ie(this.hours).hours;this.hours=He(i,"AM"==t?Ne.AM:Ne.PM),this._valueChanged()}_addTimeOffset(e){let t={mode:this.mode,hours:this.hours,minutes:this.minutes};t=Ce(t,e),e.minutes&&(t=Ee(t,this.stepSize)),this.mode!=we.Fixed&&(t=ho(t)),this.hours=t.hours,this.minutes=t.minutes,this._valueChanged()}_valueChanged(){const e={mode:this.mode,hours:this.hours,minutes:this.minutes};qs(this,"value-changed",{value:e})}_onFocus(e){e.currentTarget.select()}formatHours(){const e=this.hours<0||this.minutes<0;let t=this.useAmPm&&this.mode==we.Fixed?Ie(this.hours).hours:this.hours;return e&&!this.large?"-"+Math.abs(t).toFixed():this.mode==we.Fixed||this.large?this.large?Math.abs(t):t.toFixed():"+"+Math.abs(t).toFixed()}formatMinutes(){return Math.abs(this.minutes).toString().padStart(2,"0")}};uo.styles=r`
    :host {
      display: flex;
      flex-direction: row;
      flex-wrap: wrap;
  ...
  `,t([le({attribute:!1})],uo.prototype,"hass",void 0),t([ce()],uo.prototype,"hours",void 0),t([ce()],uo.prototype,"minutes",void 0),t([ce()],uo.prototype,"mode",void 0),t([le({type:Boolean})],uo.prototype,"autoValidate",void 0),t([le({type:Boolean})],uo.prototype,"required",void 0),t([le({type:Boolean})],uo.prototype,"disabled",void 0),t([le({type:String})],uo.prototype,"label",void 0),t([le({type:Boolean})],uo.prototype,"useAmPm",void 0),t([le({type:Boolean})],uo.prototype,"large",void 0),t([le({attribute:!1})],uo.prototype,"stepSize",void 0),uo=t([re("scheduler-time-picker")],uo);let po=class extends oe{constructor(){super(...arguments),this.weekdayTypeCustomSelected=!1,this.selectedWeekdays=[]}async showDialog(e){this._params=e,await this.updateComplete,this.selectedWeekdays=this._params.weekdays.filter(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)),this.weekdayTypeCustomSelected=this.selectedWeekdays.length>0&&this._params.weekdays.length==this.selectedWeekdays.length}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?H`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        width="small"
      >
        <ha-dialog-header slot="header">
          ${this.weekdayTypeCustomSelected?H`
          <ha-icon-button
            slot="navigationIcon"
            .label=${ds("ui.dialogs.more_info_control.dismiss",this.hass)}
            .path=${Us}
    ...
    `:H``}_renderWeekdayOptions(){let e=[];if(this.weekdayTypeCustomSelected){e=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday];e=((e,t)=>e.concat(e).slice(t,t+e.length))(e,Ts(this.hass))}else e=[_e.Daily,_e.Workday,_e.Weekend,"Custom"];const t=e=>{var t,i;return"Custom"==e?null===(t=this._params)||void 0===t?void 0:t.weekdays.some(e=>![_e.Daily,_e.Weekend,_e.Workday].includes(e)):null===(i=this._params)||void 0===i?void 0:i.weekdays.includes(e)};return e.map(e=>H`
        <ha-list-item
          graphic="icon"
          ...
          ?hasMeta=${"Custom"==e}
        >
          ${t(e)?H`<ha-icon slot="graphic" icon="mdi:check"></ha-icon>`:""}
          ${"Custom"==e?H`
            ${rs(Yi("ui.dialog.weekday_picker.choose",this.hass))}
            ${this.selectedWeekdays.length?H`<span class="badge">${this.selectedWeekdays.length}</span>`:""}
            `:rs(Ds(e,"long",this.hass))}

          ${"Custom"==e?H`<ha-icon slot="meta" icon="mdi:chevron-right"></ha-icon>`:""}
        </ha-list-item>
    ...
    `}};t([le({attribute:!1})],po.prototype,"hass",void 0),t([ce()],po.prototype,"_params",void 0),t([ce()],po.prototype,"weekdayTypeCustomSelected",void 0),t([ce()],po.prototype,"selectedWeekdays",void 0),po=t([re("dialog-select-weekdays")],po);var mo=Object.freeze({__proto__:null,get DialogSelectWeekdays(){return po}});const _o=(e,t)=>((e,t)=>e<t?-1:e>t?1:0)(e.toLowerCase(),t.toLowerCase()),go=(e,t,i)=>{const s=Object.keys(e.services).includes(t)?Object.keys(e.services[t]).filter(e=>{if(!Object.keys(hs).includes(t))return!1;let s=Object.keys(hs[t]).includes(e);if(!s&&Object.keys(hs[t]).includes("{entity_id}")){if("script"==t&&["turn_on","turn_off","reload","toggle","test"].includes(e))return!1;s=as(`${t}.${e}`,i)}return s}):[],a=t=>ds(`component.${t}.title`,e,!1)||t.replace(/_/g," "),o=s=>{let o=rs(Cs({service:`${t}.${s}`,service_data:{}},e,i.customize));return"script"==t?Object.keys(i.customize||{}).includes(`${t}.${s}`)&&Ke(i.customize[`${t}.${s}`].name)?i.customize[`${t}.${s}`].name:`${rs(Ls(`${t}.${s}`,e,i.customize))}: ${o}`:`${a(t)}: ${o}`},n=i=>{let s=ds(`component.${t}.services.${i}.description`,e,!1);return s||(s=e.services[t][i].description),s||"script"!=t||(s=ds(`component.${t}.services.turn_on.description`,e,!1)),s};let r=s.map(s=>{return{key:s,name:o(s),description:n(s),icon:(a=s,"script"==t&&Object.keys(i.customize||{}).includes(`${t}.${a}`)&&Ke(i.customize[`${t}.${a}`].icon)?i.customize[`${t}.${a}`].icon:Object.keys(ys).includes(t)&&Object.keys(ys[t].services).includes(a)?ys[t].services[a]:sa(t)),action:{service:s.includes(".")?s:`${t}.${s}`,service_data:{},target:e.services[t][s].target?{}:void 0}};var a}),d=(l=i.customize||{},c=t,Object.keys(l).filter(e=>{var t;return null===(t=l[e].exclude_actions)||void 0===t?void 0:t.length}).filter(e=>!c||!c.includes(".")&&ss(Qi(e),c)||ss(e,c)).map(e=>l[e].exclude_actions).flat().filter(Ke));var l,c;return d.length&&(r=r.filter(t=>!d.some(s=>_o(Ji(t.action.service),s)>0||_o(Cs(t.action,e,i.customize),s)>0))),_s(i.customize||{},t).forEach(e=>{let i=e.service;for(;r.find(e=>e.key==i);)i+="_2";e.variables&&Object.entries(e.variables).forEach(([t,i])=>{let s=$s(i),a=Va(s);!Ke(e.service_data[t])&&Ke(a)?e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:a})}):Ke(e.service_data[t])||(e=Object.assign(Object.assign({},e),{service_data:Object.assign(Object.assign({},e.service_data),{[t]:null})}))}),r.push({key:i,name:`${a(t)}: ${vo(e.name||o(Ji(e.service)))}`,description:vo(e.name||""),icon:e.icon||sa(t),action:{service:e.service.includes(".")?e.service:`${t}.${e.service}`,service_data:e.service_data||{},target:e.target?e.target:void 0,name:e.name,icon:e.icon}})}),r},vo=e=>{if(null!==/<.+?>/g.exec(e)){e=(new DOMParser).parseFromString(e,"text/html").body.textContent||""}let t;for(;t=/\[([^\]]+)\]/.exec(e);)e=e.replace(t[0],"");for(;t=/\{([^\}]+)\}/.exec(e);)e=e.replace(t[0],"");return e};let fo=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.lockDomain=!1,this.showAll=!1}async showDialog(e){this._params=e,this.lockDomain=void 0!==e.domainFilter,this.showAll=!1,this.selectedEntity=void 0,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title"),this.hass.loadBackendTranslation("services")}render(){return this._params?H`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        @wa-after-show=${this._opened}
      >
        <div slot="header">
          <ha-dialog-header>
            ${void 0!==this.selectedEntity||void 0!==this._params.domainFilter&&!this.lockDomain?H`
            <ha-icon-button
              slot="navigationIcon"
              .label=${ds("ui.common.back",this.hass)}
              .path=${Us}
            ...
            ${!this.lockDomain&&Ke(this._params.cardConfig.include)?H`
            <ha-dropdown
              placement="bottom-end"
              slot="actionItems"
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
            >
              <ha-icon-button slot="trigger" .label=${this.hass.localize("ui.common.menu")} .path=${Xs}>
              </ha-icon-button>
    ...
    `):H`
        <ha-list-item disabled>
          ${ds("ui.components.combo-box.no_match",this.hass)}
        </ha-list-item>
      `}_handleEntityClick(e){this.selectedEntity=e,this._clearSearch()}_renderDomainList(e){e.sort((e,t)=>ns(e.name,t.name)),this._filter&&(e=e.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))}));let t=[];for(var i=e.length;i<7;i++)t.push(0);return Object.keys(e).length?H`
      ${Object.keys(e).map(t=>H`
        <ha-list-item
          graphic="icon"
          hasMeta
      ...
      `:H`
        ...
        `}}return this._filter&&(i=i.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))})),Object.keys(i).length?Object.keys(i).map(e=>H`
        <ha-list-item
          graphic="icon"
    ...
    `}};t([le({attribute:!1})],fo.prototype,"hass",void 0),t([ce()],fo.prototype,"_params",void 0),t([ce()],fo.prototype,"_search",void 0),t([ce()],fo.prototype,"_filter",void 0),t([ce()],fo.prototype,"_width",void 0),t([ce()],fo.prototype,"_height",void 0),t([ce()],fo.prototype,"lockDomain",void 0),t([ce()],fo.prototype,"showAll",void 0),t([ce()],fo.prototype,"selectedEntity",void 0),fo=t([re("dialog-select-action")],fo);var bo=Object.freeze({__proto__:null,get DialogSelectAction(){return fo}});let yo=class extends oe{constructor(){super(...arguments),this.showPrefix=!1}render(){return H`
      ${this.showPrefix?H`
    ...
    `}};t([le({type:Boolean})],yo.prototype,"showPrefix",void 0),yo=t([re("scheduler-settings-row")],yo);let wo=class extends oe{constructor(){super(...arguments),this.selectedSlot=null,this.large=!1,this.selectedEntry=0}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return H`
    ${this.schedule.entries.map((e,t)=>H`
      ...
      <div class="editor-header">
        <div class="weekdays">
          ...
          <ha-icon-button .path=${Ys} @click=${e=>this._showWeekdayDialog(e,t)}></ha-icon-button>
        </div>
    ...
    ${this.renderSlot()}
    `}toggleViewMode(){const e=this.viewMode==me.Scheme?me.Single:me.Scheme;this.dispatchEvent(new CustomEvent("setViewMode",{detail:e}))}renderActionButtons(){if(null===this.selectedSlot||null===this.selectedEntry)return H``;const e=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].start,t=this.schedule.entries[this.selectedEntry].slots[this.selectedSlot].stop||e,i=Te(e,this.hass),s=(Te(t,this.hass)||86400)-i;return H`
      <div class="actions">
    ...
    `}_renderOnOffToggle(e,t){var i,s;const a=Ka(t)?t:Xa(t),o=Za(t)?t:Xa(t),n=this.selectedSlot>0?this.schedule.entries[this.selectedEntry].slots[this.selectedSlot-1]:void 0,r=null!==e?null:(null===(i=null==n?void 0:n.actions)||void 0===i?void 0:i.length)&&Ka(n.actions[0])?"off":(null===(s=null==n?void 0:n.actions)||void 0===s?void 0:s.length)&&Za(n.actions[0])?"on":null,d=t=>{t!==e&&this._updateSlot({actions:["on"===t?a:o]})};return H`
    ...
    `}const n=gs(o,this.config.customize),r=(null===(e=n.target)||void 0===e?void 0:e.domain)||Qi(o.service),d=Ke(null===(t=null==n?void 0:n.target)||void 0===t?void 0:t.entity_id)||this.schedule.entries[this.selectedEntry].slots.some(e=>{var t,i;return e.actions.length&&Ke(null===(i=null===(t=gs(e.actions[0],this.config.customize))||void 0===t?void 0:t.target)||void 0===i?void 0:i.entity_id)});if(void 0===n)return H``;const l=Object.keys(n.fields||{}).filter(e=>Aa(o,e,this.hass,this.config.customize));let c="",h=[(null===(i=o.target)||void 0===i?void 0:i.entity_id)||[]].flat();!h.length&&["notify","script"].includes(r)&&(h=[o.service]),h.length&&(c+=h.map(e=>Ls(e,this.hass,this.config.customize)).join(", "),c+=": "),c+=Cs(o,this.hass,this.config.customize,!1,!0);const u=null!==Xa(o);return H`
      ${u?this._renderOnOffToggle(Ka(o)?"on":"off",o):""}
      <scheduler-collapsible-section
        ?expanded=${!0}
        ?disabled=${!0}
      >
        <div slot="header" class="header">
          <ha-icon slot="icon" icon="${Ua(o,this.config.customize)}"></ha-icon>
          <span>${rs(c)}</span>
        </div>
        ...
        <ha-dropdown
          ...
          placement="bottom-end"
        >
          <ha-icon-button slot="trigger" .path=${Xs}>
          </ha-icon-button>
          <ha-dropdown-item value="change_type">
            <ha-icon icon="mdi:pencil"></ha-icon>
            ${ds("ui.panel.lovelace.editor.card.conditional.change_type",this.hass)}
          </ha-dropdown-item>
          <ha-dropdown-item variant="danger" value="delete">
            <ha-icon icon="mdi:delete"></ha-icon>
            ${ds("ui.common.delete",this.hass)}
          </ha-dropdown-item>
        </ha-dropdown>
        ...
        <div slot="content">
          ...
          ${n.target?H`
          <scheduler-settings-row>
            <span slot="heading">${ds("ui.components.entity.entity-picker.entity",this.hass)}</span>
          ...
          ${l.map(e=>{var t;const i=ws(o.service,null===(t=o.target)||void 0===t?void 0:t.entity_id,e,this.hass,this.config.customize);if(null===i)return"";let s=n.fields[e].optional||(i.number||{}).optional;const a=!s||Object.keys(o.service_data).includes(e);return H`
            <scheduler-settings-row ?showPrefix=${s}>
              ...
              `:""}
              <span slot="heading">
                ${((e,t,i,s)=>{var a;const o=Qi(e.service),n=Ji(e.service);let r=ds(`component.${o}.services.${n}.fields.${t}.name`,i,!1);!r&&i.services[o]&&i.services[o][e.service]&&i.services[o][e.service].fields&&i.services[o][e.service].fields[t]&&(r=String(i.services[o][e.service].fields[t].name));const d=["script","notify"].includes(o)?[e.service]:[(null===(a=e.target)||void 0===a?void 0:a.entity_id)||[]].flat(),l=d.length?d[0]:e.service;let c=_s(s||{},l);if(c.length){let i=c.map(i=>{if(i.service!=e.service||!Object.keys(i.variables||{}).includes(t))return null;return(i.variables||{})[t].name}).filter(Ke);if(i.length)return i[0]}return r||(r=t.replace(/_/g," ")),r})(o,e,this.hass,this.config.customize)}
              </span>
              <scheduler-combo-selector
                .hass=${this.hass}
                .config=${i}
  ...
  ha-list-item.warning, ha-list-item.warning ha-icon {
    ...
    `}};t([le({attribute:!1})],wo.prototype,"hass",void 0),t([le({attribute:!1})],wo.prototype,"config",void 0),t([le({attribute:!1})],wo.prototype,"viewMode",void 0),t([le({attribute:!1})],wo.prototype,"selectedSlot",void 0),t([le({type:Boolean})],wo.prototype,"large",void 0),t([ce()],wo.prototype,"schedule",void 0),t([ce()],wo.prototype,"selectedEntry",void 0),wo=t([re("scheduler-main-panel")],wo);const ko=["January","February","March","April","May","June","July","August","September","October","November","December"];function xo(e){return e.toISOString().split("T")[0]}function $o(e){let t=new Date;const i=(e||"").match(/^([0-9]{4})-([0-9]{2})-([0-9]{2})/);null!==i&&t.setFullYear(Number(i[1]),Number(i[2])-1,Number(i[3]));const s=(e||"").match(/([0-9]{2}):([0-9]{2})(:([0-9]{2}))?$/);return null!==s&&t.setHours(Number(s[1]),Number(s[2]),s.length>4?Number(s[4]):t.getSeconds()),t}const So=(e,t)=>"select"in t&&null!==t.select?((e,t)=>{var i;return((null===(i=t.select)||void 0===i?void 0:i.options)||[]).some(t=>"object"==typeof t?t.value==e:t==e)})(String(e),t):"number"in t&&null!==t.number?((e,t)=>{var i,s;return!isNaN(e)&&(!(void 0!==(null===(i=t.number)||void 0===i?void 0:i.min)&&e<t.number.min)&&!(void 0!==(null===(s=t.number)||void 0===s?void 0:s.max)&&e>t.number.max))})(Number(e),t):!("text"in t)||null===t.text||String(e).length>0,jo=e=>null==e||Array.isArray(e)?e:[e];let Oo=class extends oe{constructor(){super(...arguments),this._search="",this._filter="",this.timer=0,this.showAll=!1}async showDialog(e){this._params=e,this.showAll=!1,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0,this._clearSearch(),this._height=void 0,this._width=void 0}async willUpdate(){this.hass.loadBackendTranslation("title")}render(){return this._params?H`
      <ha-dialog
        open
        @closed=${this.closeDialog}
        @wa-after-show=${this._opened}
    ...
    `:H``}_opened(){var e;const t=null===(e=this.shadowRoot.querySelector("ha-list"))||void 0===e?void 0:e.getBoundingClientRect();this._width=null==t?void 0:t.width,this._height=null==t?void 0:t.height}_handleSearchChange(e){const t=e.currentTarget.value;this._search=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this._filter=this._search},100)}_clearSearch(){this._search="",this._filter=""}_renderOptions(){var e;let t=Object.assign({},null===(e=this._params)||void 0===e?void 0:e.cardConfig);this.showAll&&(t=Object.assign(Object.assign({},t),{include:void 0,exclude:void 0}));let i=_a(this.hass,t);return i.sort((e,t)=>ns(e.name,t.name)),this._filter&&(i=i.filter(e=>{const t=this._filter.toLowerCase().trim().split(" ");return t.every(t=>e.name.toLowerCase().includes(t))||t.every(t=>e.key.toLowerCase().includes(t))})),Object.keys(i).map(e=>H`
        <ha-list-item
          graphic="icon"
    ...
    `}};t([le({attribute:!1})],Oo.prototype,"hass",void 0),t([ce()],Oo.prototype,"_params",void 0),t([ce()],Oo.prototype,"_search",void 0),t([ce()],Oo.prototype,"_filter",void 0),t([ce()],Oo.prototype,"_width",void 0),t([ce()],Oo.prototype,"_height",void 0),t([ce()],Oo.prototype,"showAll",void 0),Oo=t([re("dialog-select-condition")],Oo);var zo=Object.freeze({__proto__:null,get DialogSelectCondition(){return Oo}});let Co=class extends oe{constructor(){super(...arguments),this.conditionIdx=-1,this.conditionValid=!0,this.startDate="",this.endDate="",this.tags=[],this.customTagValue=""}async firstUpdated(){var e,t;(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(e=this.schedule)||void 0===e?void 0:e.start_date)||xo(new Date),this.endDate=(null===(t=this.schedule)||void 0===t?void 0:t.end_date)||xo(new Date);const i=(await Fs(this.hass)).map(e=>e.name),s=[this.config.tags||[]].flat();this.tags=[...new Set([...i,...s.filter(e=>!i.includes(e)&&!["none","disabled","enabled"].includes(e))])]}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){const e={select:{options:this.tags,multiple:!0,custom_value:!0}};return H`
      <div class="header first">
        <span>${Yi("ui.panel.options.conditions.header",this.hass)}:</span>
        ${this.schedule.entries[0].slots[0].conditions.items.length?H`
        <ha-dropdown
      ...
      <div class="period">
        ...
        <div class="input">
          <ha-date-input
            ...
            .label=${ds("ui.components.date-range-picker.start_date",this.hass)}
        ...
        <div class="input">
          <ha-date-input
            .locale=${this.hass.locale}
            value=${this.endDate}
            .label=${ds("ui.components.date-range-picker.end_date",this.hass)}
      ...
      <span class="header">${ds("ui.common.name",this.hass)}:</span>
      <div class="period">
        <ha-input
          value=${this.schedule.name||""}
          placeholder=${this.schedule.name?"":ds("ui.common.name",this.hass)}
      ...
      >
        ...
        ${ds("ui.components.calendar.event.repeat.label",this.hass)}
      </ha-button>
      <ha-button
      ...
      >
        ...
        ${ds("ui.dialogs.more_info_control.vacuum.stop",this.hass)}
      </ha-button>
      <ha-button
    ...
    `}renderConditions(){let e=this.schedule.entries[0].slots[0].conditions.items;return this.conditionIdx==e.length&&(e=[...e,{}]),e.map((e,t)=>{var i;const s=this.conditionIdx==t?this.selectedEntity||e.entity_id||"":e.entity_id||"",a=this.conditionIdx==t&&this.selectedDomain||Qi(s),o=ma(s||a,this.hass,this.config.customize),n=o&&o.hasOwnProperty("number")?[ve.Above,ve.Below]:[ve.Equal,ve.Unequal],r={[ve.Equal]:"mdi:equal",[ve.Unequal]:"mdi:not-equal-variant",[ve.Above]:"mdi:greater-than",[ve.Below]:"mdi:less-than"},d={[ve.Equal]:"ui.panel.options.conditions.types.equal_to",[ve.Unequal]:"ui.panel.options.conditions.types.unequal_to",[ve.Above]:"ui.panel.options.conditions.types.above",[ve.Below]:"ui.panel.options.conditions.types.below"};return this.conditionIdx!==t||this.selectedMatchType||(this.selectedMatchType=n[0]),H`
      <scheduler-collapsible-section idx="${t}">
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${ds("ui.components.selectors.selector.types.entity",this.hass)}
          </span>
          <scheduler-entity-picker
            .hass=${this.hass}
            .config=${this.config}
            .domain=${a}
            @value-changed=${this._selectEntity}
            .value=${this.conditionIdx==t?jo(this.selectedEntity):jo(e.entity_id)}
            ?multiple=${!1}
          >
          </scheduler-entity-picker>
        </scheduler-settings-row>
        ...
        <scheduler-settings-row>
          <span slot="heading">
            ${rs(Yi(d[this.conditionIdx==t?this.selectedMatchType:e.match_type],this.hass,["{entity}","{value}"],["",""]))}
            <ha-dropdown
              @wa-select=${this._selectMatchType}
              @wa-after-hide=${e=>{e.target.firstElementChild.blur()}}
            >
              <ha-icon-button slot="trigger" .path=${Ys}>
              </ha-icon-button>
              ${n.map(i=>H`
                <ha-dropdown-item 
                ...
                >
                  ...
                  ${rs(Yi(d[i],this.hass,["{entity}","{value}"],["",""]))}
                </ha-dropdown-item>
              `)}
            </ha-dropdown>
          </span>
    ...
    `}};t([le({attribute:!1})],Co.prototype,"hass",void 0),t([le({attribute:!1})],Co.prototype,"config",void 0),t([ce()],Co.prototype,"schedule",void 0),t([ce()],Co.prototype,"conditionIdx",void 0),t([ce()],Co.prototype,"selectedDomain",void 0),t([ce()],Co.prototype,"selectedEntity",void 0),t([ce()],Co.prototype,"selectedMatchType",void 0),t([ce()],Co.prototype,"conditionValue",void 0),t([ce()],Co.prototype,"conditionValid",void 0),t([ce()],Co.prototype,"startDate",void 0),t([ce()],Co.prototype,"endDate",void 0),t([le()],Co.prototype,"tags",void 0),t([ce()],Co.prototype,"customTagValue",void 0),Co=t([re("scheduler-options-panel")],Co);let Eo=class extends oe{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?H`
      ...
      >
        ...
        <ha-dialog-footer slot="footer">
          ${this._params.secondaryButtonLabel?H`
            <ha-button
              appearance="plain"
              slot="secondaryAction"
              @click=${this.cancelClick}
        ...
        `}
          ...
          <div class="buttons" slot="footer">
            ...
            <ha-button appearance="plain" @click=${this._handleSaveClick}>
              ${ds("ui.common.save",this.hass)}
            </ha-button>
          </div>
      </ha-dialog>
    `:H``}_updateSchedule(e){let t=Object.keys(e.detail);if(t.includes("schedule")){let t=e.detail.schedule;this.schedule=t}t.includes("selectedSlot")&&(this.selectedSlot=e.detail.selectedSlot)}async _handleSaveClick(e){const t=Ta(this.schedule,this.hass,this._params.cardConfig.customize);if(t)await new Promise(i=>{const s={cancel:()=>i(!1),confirm:()=>i(!0),title:ds("state_badge.default.error",this.hass),description:Yi("ui.panel.editor.validation_errors."+t,this.hass),primaryButtonLabel:ds("ui.common.ok",this.hass)};qs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ao})),dialogParams:s})});else if(this.schedule.schedule_id){const t=qe(await Rs(this.hass,this.schedule.schedule_id),this.hass);if(ue(this.schedule,t))return void this.closeDialog();if(!t.enabled){await new Promise(t=>{const i={title:Yi("ui.dialog.enable_schedule.title",this.hass),description:Yi("ui.dialog.enable_schedule.description",this.hass),primaryButtonLabel:ds("ui.common.yes",this.hass),secondaryButtonLabel:ds("ui.common.no",this.hass),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};qs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ao})),dialogParams:i})})&&this.hass.callService("switch","turn_on",{entity_id:t.entity_id})}qa(this.hass,this.schedule).catch(e=>Ha(e,this,this.hass)).then(()=>{this.closeDialog()})}else Ma(this.hass,this.schedule).catch(e=>Ha(e,this,this.hass)).then(()=>{this.closeDialog()})}async _handleDeleteClick(e){await new Promise(t=>{const i={cancel:()=>t(!1),confirm:()=>t(!0),title:Yi("ui.dialog.confirm_delete.title",this.hass),description:Yi("ui.dialog.confirm_delete.description",this.hass),primaryButtonLabel:ds("ui.common.ok",this.hass),secondaryButtonLabel:ds("ui.common.cancel",this.hass)};qs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ao})),dialogParams:i})}).then(e=>{e&&Ra(this.hass,this._params.editItem).catch(e=>Ha(e,this,this.hass)).then(()=>{this.closeDialog()})})}_setViewMode(e){let t=e.detail;const i=this.schedule.entries[this.selectedEntry].slots.filter(e=>e.actions.length).length>1;if(t!=me.Scheme)if(t!=me.Single||i)new Promise(t=>{const i={title:Yi("ui.dialog.confirm_migrate.title",this.hass),description:Yi("ui.dialog.confirm_migrate.description",this.hass),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{t(!1)},confirm:()=>{t(!0)}};qs(e.target,"show-dialog",{dialogTag:"scheduler-generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ao})),dialogParams:i})}).then(e=>{e&&(this.schedule=(e=>{const t=e=>{let t=e.findIndex(e=>e.actions.length);t<0&&(t=Math.floor(e.length/2));let i=Object.assign(Object.assign({},e[t]),{stop:void 0});const s=i.conditions,a=i.start;return e=[{start:"00:00:00",stop:a,actions:[],conditions:s},i,{start:Re(Ce(De(a),{minutes:1})),stop:"00:00:00",actions:[],conditions:s}]};return e=Object.assign(Object.assign({},e),{entries:e.entries.map(e=>Object(Object.assign(Object.assign({},e),{slots:t(e.slots)})))})})(this.schedule),this.viewMode=t)});else{if(ue([...this.schedule.entries],[...Ue.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Ze.entries]});else{let e=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>{let t=e.slots.findIndex(e=>e.actions.length);return t<0&&(t=Math.floor(e.slots.length/2)),Object.assign(Object.assign({},e),{slots:e.slots.map((e,i)=>i==t?Object.assign(Object.assign({},e),{stop:void 0}):null).filter(Ke)})})});this.schedule=qe(e,this.hass)}this.viewMode=t}else{this.viewMode=t;if(ue([...this.schedule.entries],[...Ze.entries]))this.schedule=Object.assign(Object.assign({},this.schedule),{entries:[...Ue.entries]});else{this.schedule.entries.some(e=>e.slots.some(e=>void 0===e.stop))&&(this.schedule=Object.assign(Object.assign({},this.schedule),{entries:this.schedule.entries.map(e=>Object.assign(Object.assign({},e),{slots:e.slots.map((e,t,i)=>{if(void 0!==e.stop)return e;const s=i[t+1];return Object.assign(Object.assign({},e),{stop:s?s.start:"00:00:00"})})}))}))}}}};Do.styles=Ea,t([le({attribute:!1})],Do.prototype,"hass",void 0),t([ce()],Do.prototype,"_params",void 0),t([le({type:Boolean,reflect:!0})],Do.prototype,"large",void 0),t([ce()],Do.prototype,"schedule",void 0),t([ce()],Do.prototype,"selectedEntry",void 0),t([ce()],Do.prototype,"selectedSlot",void 0),t([ce()],Do.prototype,"_panel",void 0),t([ce()],Do.prototype,"_viewMode",void 0),Do=t([re("dialog-scheduler-editor")],Do);var To=Object.freeze({__proto__:null,get DialogSchedulerEditor(){return Do}});const Mo=e=>{if(!e)return null;const t=new Date(e);return isNaN(t.valueOf())?null:t},Po=(e,t,i)=>{var s,a,o;const n=De(e),r=1e3*(3600*n.hours+60*n.minutes);switch(n.mode){case we.EntityDay:{const e=Mo(n.entity_id?null===(s=t.states[n.entity_id])||void 0===s?void 0:s.state:void 0);if(!e)return null;const i=new Date(e);return i.setHours(n.hours,n.minutes,0,0),i}case we.Entity:{const e=Mo(n.entity_id?null===(a=t.states[n.entity_id])||void 0===a?void 0:a.state:void 0);return e?new Date(e.getTime()+r):null}case we.Sunrise:case we.Sunset:{const e=n.mode==we.Sunrise?"next_rising":"next_setting",i=Mo(null===(o=t.states["sun.sun"])||void 0===o?void 0:o.attributes[e]);return i?new Date(i.getTime()+r):null}default:{if(!i)return null;const e=new Date(i);return e.setHours(n.hours,n.minutes,0,0),e.getTime()<i.getTime()&&e.setDate(e.getDate()+1),e}}},Lo={brightness_pct:[1,100],color_temp_kelvin:[1500,8e3],temperature:[5,35],target_temp_low:[5,35],target_temp_high:[5,35]},No=(e,t)=>{var i;return(null===(i=e.states[t])||void 0===i?void 0:i.attributes.friendly_name)||t},Io=(e,t,i,s)=>{const a=s.service_data||{},o=[];return Object.entries(Lo).forEach(([s,[n,r]])=>{const d=a[s];null!=d&&("number"!=typeof d||Number.isNaN(d)||d<n||d>r)&&o.push({key:"check.parameter",values:{where:t,device:No(e,i),value:String(d),low:String(n),high:String(r)}})}),o},Ho="sensor.jewish_calendar_upcoming_candle_lighting",Ro="sensor.jewish_calendar_upcoming_havdalah",qo=e=>"group:"+e,Vo=e=>"detach:"+e,Fo=()=>({type:ge.Or,items:[],track_changes:!1}),Bo=e=>e.actions.flatMap(e=>{var t;return[(null===(t=e.target)||void 0===t?void 0:t.entity_id)||[]].flat()}).filter((e,t,i)=>e&&i.indexOf(e)===t),Wo=(e,t)=>Object.assign(Object.assign({},e),{target:{entity_id:t}}),Uo=(e,t)=>{var i;return null===(i=e.devices)||void 0===i?void 0:i[t]},Zo=(e,t)=>({service:`${e.split(".")[0]}.turn_${t?"on":"off"}`,service_data:{}}),Ko=e=>{const t={};return e.forEach(e=>{var i;[(null===(i=e.target)||void 0===i?void 0:i.entity_id)||[]].flat().forEach(i=>{i&&(t[i]=Object.assign(Object.assign({},e),{target:void 0}))})}),t},Xo=e=>{const t=(e||"").match(/^([a-z_]+\.[a-z0-9_]+)[-+@]/);return t?t[1]:void 0},Go=e=>{var t,i,s,a;const o=((null===(i=null===(t=null==e?void 0:e.entries)||void 0===t?void 0:t[0])||void 0===i?void 0:i.slots)||[]).filter(e=>e.actions.length),n=new Map;o.forEach(e=>{const t=e.track||qo("");n.has(t)||n.set(t,[]),n.get(t).push(e)});const r=[],d=[];n.forEach((e,t)=>{if(t.startsWith("detach:")){const i=t.slice("detach:".length);e.forEach((e,s)=>{d.push({track:t,name:e.name||"",entity:i,start:e.start,stop:e.stop||e.start,action:e.actions[0],start_date:e.start_date,end_date:e.end_date}),s&&(d[d.length-1].track=`${t}#${s}`)})}else r.push({track:t,name:t.startsWith("group:")?t.slice("group:".length):t,entities:[...new Set(e.flatMap(Bo))],cubes:e.map((e,i)=>({id:`${t}#${i}`,name:e.name||"",start:e.start,stop:e.stop||e.start,color:e.color,enforce:e.enforce,devices:Ko(e.actions)}))})});const l=null===(s=r[0])||void 0===s?void 0:s.cubes[0],c=null===(a=r[0])||void 0===a?void 0:a.cubes[r[0].cubes.length-1];return{name:(null==e?void 0:e.name)||"",startAnchor:Xo(null==l?void 0:l.start)||Ho,endAnchor:Xo(null==c?void 0:c.stop)||Ro,groups:r,detaches:d}},Yo=(e,t)=>{const i=[];return e.groups.forEach(e=>{e.cubes.forEach(t=>{i.push({start:t.start,stop:t.stop,name:t.name||void 0,color:t.color,enforce:t.enforce,track:e.track,priority:0,actions:e.entities.filter(e=>((e,t)=>Boolean(e.devices&&t in e.devices))(t,e)).map(e=>Wo(t.devices[e],[e])),conditions:Fo()})})}),e.detaches.forEach(e=>{i.push({start:e.start,stop:e.stop,name:e.name||void 0,track:e.track,priority:1,start_date:e.start_date,end_date:e.end_date,actions:[Wo(e.action,[e.entity])],conditions:Fo()})}),Object.assign(Object.assign({},t),{name:e.name,repeat_type:ye.Repeat,entries:[{weekdays:[_e.Daily],slots:i}],tags:[...new Set([...t.tags||[],"shabbat-plan"])]})},Jo=e=>(e.tags||[]).includes("shabbat-plan"),Qo=e=>{var t;const i=e.service_data||{};return{brightness:null!==(t=i.brightness_pct)&&void 0!==t?t:void 0!==i.brightness?Math.round(i.brightness/255*100):void 0,kelvin:i.color_temp_kelvin,degrees:i.temperature}},en=(e,t)=>{const i=Po(e.startAnchor+"+00:00:00",t),s=Po(e.endAnchor+"+01:30:00",t),a=e=>Po(e,t,i||void 0),o=[],n=[],r=e=>{var i;return(null===(i=t.states[e])||void 0===i?void 0:i.attributes.friendly_name)||e};return e.groups.forEach(t=>{t.entities.length||o.push(t.name),t.cubes.forEach((i,s)=>{const o=a(i.start),d=a(i.stop);n.push({key:i.id,group:t.name,name:i.name||"#"+(s+1),from:o,to:d,holds:Boolean(i.enforce),devices:t.entities.map(t=>{const s=Uo(i,t);if(!s)return{entity_id:t,name:r(t),state:"untouched",own:!1};const{brightness:n,kelvin:l,degrees:c}=Qo(s),h=e.detaches.find(e=>{if(e.entity!=t)return!1;const i=a(e.start);return Boolean(i&&o&&d&&i>=o&&i<d)});return Object.assign(Object.assign(Object.assign(Object.assign({entity_id:t,name:r(t),state:Za(s)?"off":"on"},"light"==t.split(".")[0]?{brightness:n,kelvin:l}:{}),"climate"==t.split(".")[0]?{degrees:c}:{}),{own:!0}),h?{takenOverBy:h.name}:{})})})})}),e.detaches.forEach(e=>{const t=e.action,{brightness:i,kelvin:s,degrees:o}=Qo(t);n.push({key:e.track,group:r(e.entity),name:e.name,from:a(e.start),to:a(e.stop),holds:!1,devices:[Object.assign(Object.assign(Object.assign({entity_id:e.entity,name:r(e.entity),state:Za(t)?"off":"on"},"light"==e.entity.split(".")[0]?{brightness:i,kelvin:s}:{}),"climate"==e.entity.split(".")[0]?{degrees:o}:{}),{own:!0})]})}),n.sort((e,t)=>{var i,s;return((null===(i=e.from)||void 0===i?void 0:i.getTime())||0)-((null===(s=t.from)||void 0===s?void 0:s.getTime())||0)}),{opens:i,closes:s,stretches:n,problems:o}},tn={groups:[],devices:[],kinds:[]},sn=["light","switch","fan","climate","input_boolean","media_player"],an=e=>sn.includes(e.split(".")[0]),on=(e,t)=>{var i;return((null===(i=e.groups.find(e=>e.name==t))||void 0===i?void 0:i.devices)||[]).filter(an)},nn=[{key:"meal_eve",when:"sunset",time:"01:30",before:!1},{key:"sleep",when:"clock",time:"23:00"},{key:"morning",when:"clock",time:"07:00"},{key:"meal_day",when:"clock",time:"12:00"},{key:"nap",when:"clock",time:"14:30"},{key:"close",when:"end",time:"00:30",before:!0}],rn=!0,dn=()=>({plainColours:rn,moments:nn.map(e=>Object.assign({},e))}),ln=()=>{var e;const t=dn();try{const i=null===(e=window.localStorage)||void 0===e?void 0:e.getItem("scheduler-card.plan-prefs");if(!i)return t;const s=JSON.parse(i);"boolean"==typeof(null==s?void 0:s.plainColours)&&(t.plainColours=s.plainColours);const a=new Map((Array.isArray(null==s?void 0:s.moments)?s.moments:[]).map(e=>[null==e?void 0:e.key,e]));t.moments=nn.map(e=>((e,t)=>{if(!e||"object"!=typeof e)return Object.assign({},t);const i=["clock","sunset","end"].includes(e.when)?e.when:t.when;return{key:t.key,when:i,time:/^\d{1,2}:\d{2}$/.test(e.time)?e.time:t.time,before:"boolean"==typeof e.before?e.before:t.before}})(a.get(e.key),e))}catch(e){return dn()}return t},cn=["#43a047","#7cb342","#fdd835","#fb8c00","#f4511e","#e53935","#d81b60","#8e24aa","#3949ab","#1e88e5","#00897b","#6d4c41"],hn=()=>({entries:[{weekdays:[_e.Daily],slots:[]}],repeat_type:ye.Repeat,next_entries:[],timestamps:[],enabled:!0,tags:[]}),un=(e,t)=>e.toDateString()==t.toDateString();let pn=class extends oe{constructor(){super(...arguments),this._selected=null,this._error=null,this._help=!1,this._wizardStep=null,this._offerWizard=!1,this._wizard={entities:[],opening:{},moments:[],hold:!0},this._wizardAdvanced=!1,this._history=[],this._future=[],this._keys=!1,this._book=tn,this._bookOpen=!1,this._newGroup="",this._draftGroups=[],this._prefs=ln(),this._plainColours=this._prefs.plainColours,this._settingsOpen=!1,this._helpKey=null,this._membersAdvanced=!1,this._report=null,this._saved=!1,this._base=hn(),this._drag=null,this._handleKeyDown=async e=>{if(!this._params)return;const t=e.composedPath()[0],i=t instanceof HTMLElement&&(["input","textarea","select"].includes(t.tagName.toLowerCase())||t.isContentEditable),s=e.ctrlKey||e.metaKey,a=e.key.toLowerCase();if(s&&"z"==a&&!e.shiftKey)return e.preventDefault(),void this._undo();if(s&&("y"==a||"z"==a&&e.shiftKey))return e.preventDefault(),void this._redo();if(s&&"s"==a)return e.preventDefault(),void await this._save();if(i)return;if(null!==this._wizardStep)return;if("escape"==a&&(this._keys||this._report))return e.preventDefault(),this._keys=!1,void(this._report=null);if("?"==a||e.shiftKey&&"/"==a)return e.preventDefault(),void(this._keys=!this._keys);const o=this._selectedCube(),n=this._selectedDetach();switch(a){case"delete":case"backspace":return e.preventDefault(),void(o?this._removeCube(o.group,o.cube):n&&this._rejoinGroup(n.track));case"arrowright":case"arrowleft":return e.preventDefault(),void(e.shiftKey||e.altKey?this._nudgeBoundary("arrowright"==a?1:-1,e.altKey):this._step("arrowright"==a?1:-1));case"arrowdown":case"arrowup":return e.preventDefault(),void this._stepRow("arrowdown"==a?1:-1);case"n":case"+":return e.preventDefault(),void(o&&this._splitCube(o.group,o.cube));case"o":return e.preventDefault(),void this._toggleSelectedState();case"h":return e.preventDefault(),void(o&&this._updateCube(o.group.track,o.cube.id,{enforce:!o.cube.enforce}));case"g":return e.preventDefault(),void this._addGroup();case"r":return e.preventDefault(),void this._toggleReport();case"w":return e.preventDefault(),void(this._wizardStep=0);case"enter":return e.preventDefault(),void this._focusName()}if(o&&/^[0-9]$/.test(a)){e.preventDefault();const t=Number(a)-1;this._updateCube(o.group.track,o.cube.id,{color:t<0?void 0:cn[t]})}},this._addDraftGroup=()=>{const e=this._newGroup.trim();e&&(this._draftGroups.includes(e)||(this._draftGroups=[...this._draftGroups,e]),this._newGroup="")}}async showDialog(e){var t,i,s;this._params=e,this._base=e.schedule?Object.assign({},e.schedule):hn(),this._plan=e.schedule?Go(e.schedule):this._blankPlan(),this._selected=null!==(s=null===(i=null===(t=this._plan.groups[0])||void 0===t?void 0:t.cubes[0])||void 0===i?void 0:i.id)&&void 0!==s?s:null,this._error=null,this._help=!1,this._helpKey=null,this._wizardStep=null,this._wizardAdvanced=!1,this._membersAdvanced=!1,this._history=[],this._future=[],this._report=null,this._saved=!1,this._keys=!1,this._prefs=ln(),this._plainColours=this._prefs.plainColours,this._wizard={entities:[],opening:{},moments:[],hold:!0},this._offerWizard=!e.schedule,this._bookOpen=!1,this._loadBook(),await this.updateComplete}async closeDialog(){this._params=void 0}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){window.removeEventListener("keydown",this._handleKeyDown),super.disconnectedCallback()}_t(e,t,i){return Yi("ui.panel.plan."+e,this.hass,t||[],i||[])}_helpFor(e){return H`
      <button
        class="icon-only help-toggle ${this._helpKey==e?"active":""}"
        title=${this._t("help.open")}
        @click=${()=>{this._helpKey=this._helpKey==e?null:e}}
      ><ha-svg-icon .path=${Gs}></ha-svg-icon></button>
    `}_helpText(e){return this._helpKey!=e?q:H`<p class="help-note">${this._t("help."+e)}</p>`}_updatePrefs(e){this._prefs=Object.assign(Object.assign({},this._prefs),e),(e=>{var t;try{null===(t=window.localStorage)||void 0===t||t.setItem("scheduler-card.plan-prefs",JSON.stringify(e))}catch(e){}})(this._prefs)}_setPlainColours(e){this._plainColours=e,this._updatePrefs({plainColours:e})}_setDefaultMoment(e,t){this._updatePrefs({moments:this._prefs.moments.map(i=>i.key==e?Object.assign(Object.assign({},i),t):i)})}_resetDefaultMoments(){this._updatePrefs({moments:nn.map(e=>Object.assign({},e))})}_blankPlan(){return((e,t)=>{const i=Ho,s=Ro;return{name:e,startAnchor:i,endAnchor:s,groups:[{track:qo(t[5]||"group"),name:t[5]||"group",entities:[],cubes:[{id:"c0",name:t[0],start:i+"+00:00:00",stop:i+"@22:30:00",devices:{},enforce:!0,suggestOn:!0},{id:"c1",name:t[1],start:i+"@22:30:00",stop:s+"@06:30:00",devices:{},enforce:!0,suggestOn:!1},{id:"c2",name:t[2],start:s+"@06:30:00",stop:s+"@13:00:00",devices:{},enforce:!0,suggestOn:!0},{id:"c3",name:t[3],start:s+"@13:00:00",stop:s+"-00:30:00",devices:{},enforce:!0,suggestOn:!1},{id:"c4",name:t[4],start:s+"-00:30:00",stop:s+"+01:30:00",devices:{},enforce:!0,suggestOn:!0}]}],detaches:[]}})(this._t("title"),[this._t("cube.welcome"),this._t("cube.night"),this._t("cube.morning"),this._t("cube.afternoon"),this._t("cube.close"),this._t("group.default")])}get _rows(){return[...this._plan.groups.map(e=>({track:e.track,ids:e.cubes.map(e=>e.id)})),...this._plan.detaches.map(e=>({track:e.track,ids:[e.track]}))]}_step(e){var t,i;const s=this._rows.find(e=>e.ids.includes(this._selected||""));if(!s)return void(this._selected=null!==(i=null===(t=this._rows[0])||void 0===t?void 0:t.ids[0])&&void 0!==i?i:null);const a=s.ids.indexOf(this._selected)+e;a>=0&&a<s.ids.length&&(this._selected=s.ids[a])}_stepRow(e){const t=this._rows,i=t.findIndex(e=>e.ids.includes(this._selected||"")),s=t[Math.min(t.length-1,Math.max(0,i+e))];s&&(this._selected=s.ids[0])}_nudgeBoundary(e,t){const i=this._selectedCube();if(!i)return;const{group:s,cube:a}=i,o=s.cubes.findIndex(e=>e.id==a.id),n=t?o+1:o,r=t?a.stop:a.start,d=this._moment(r);if(!d)return;const l=new Date(d.getTime()+5*e*6e4);if(n>0&&n<s.cubes.length)return void this._moveBoundary(s.track,n,this._boundaryFromDate(l),"nudge");const c=s.cubes.map(e=>e.id!=a.id?e:Object.assign(Object.assign({},e),{[t?"stop":"start"]:this._boundaryFromDate(l)}));this._setCubes(s.track,c,"nudge")}_toggleSelectedState(){const e=this._selectedCube();if(e)return void this._updateCube(e.group.track,e.cube.id,{devices:this._invertDevices(e.cube)});const t=this._selectedDetach();if(t){const e=t.action.service.split(".")[0],i=Za(t.action)?"turn_on":"turn_off";this._updateDetach(t.track,{action:Object.assign(Object.assign({},t.action),{service:`${e}.${i}`})})}}async _focusName(){var e;await this.updateComplete;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".cube-title");null==t||t.focus(),null==t||t.select()}_showReport(){this._report=en(this._plan,this.hass)}_toggleReport(){if(this._report)return this._report=null,void(this._saved=!1);this._showReport()}get _bandStart(){return Po(this._plan.startAnchor+"+00:00:00",this.hass)}get _bandEnd(){return Po(this._plan.endAnchor+"+01:30:00",this.hass)}_moment(e){const t=Po(e,this.hass,this._bandStart||void 0);if(!t)return t;const i=De(e);return i.mode!=we.Sunset&&i.mode!=we.Sunrise?t:this._onBandDay(t.getHours(),t.getMinutes())||t}_onBandDay(e,t){const i=e>=16?this._bandStart:this._bandEnd;if(!i)return null;const s=new Date(i);return s.setHours(e,t,0,0),s}_position(e){const t=this._bandStart,i=this._bandEnd;if(!t||!i)return null;const s=i.getTime()-t.getTime();if(s<=0)return null;const a=this._moment(e);return a?Math.min(1,Math.max(0,(a.getTime()-t.getTime())/s)):null}_formatMoment(e){var t;const i=this._moment(e);return i?new Intl.DateTimeFormat((null===(t=this.hass.locale)||void 0===t?void 0:t.language)||"en",{weekday:"short",hour:"2-digit",minute:"2-digit"}).format(i):"—"}_hourTicks(){const e=this._bandStart,t=this._bandEnd;if(!e||!t)return[];const i=[],s=t.getTime()-e.getTime(),a=new Date(e);for(a.setMinutes(0,0,0),a.setHours(a.getHours()+1);a.getTime()<t.getTime();)a.getHours()%3==0&&i.push({at:(a.getTime()-e.getTime())/s,label:String(a.getHours()).padStart(2,"0")}),a.setHours(a.getHours()+1);return i}_boundaryParts(e){const t=De(e),i=t.entity_id||"",s=0==t.hours&&0==t.minutes;return{anchor:i,mode:i?t.mode==we.EntityDay?"clock":s?"exact":"offset":"clock",hours:Math.abs(t.hours),minutes:Math.abs(t.minutes),before:t.hours<0||t.minutes<0}}_boundaryString(e){if(!e.anchor)return Re({mode:we.Fixed,hours:e.hours,minutes:e.minutes});if("exact"==e.mode)return Re({mode:we.Entity,hours:0,minutes:0,entity_id:e.anchor});if("clock"==e.mode)return Re({mode:we.EntityDay,hours:e.hours,minutes:e.minutes,entity_id:e.anchor});const t=e.before?-1:1;return Re({mode:we.Entity,hours:t*e.hours,minutes:t*e.minutes,entity_id:e.anchor})}_boundaryFromDate(e){const t=this._moment(this._plan.startAnchor+"+00:00:00"),i=this._moment(this._plan.endAnchor+"+00:00:00"),s=t=>Re({mode:we.EntityDay,hours:e.getHours(),minutes:e.getMinutes(),entity_id:t});if(t&&un(e,t))return s(this._plan.startAnchor);if(i&&un(e,i))return s(this._plan.endAnchor);const a=[{anchor:this._plan.startAnchor,base:t},{anchor:this._plan.endAnchor,base:i}].filter(e=>e.base);for(const t of a.sort((t,i)=>Math.abs(e.getTime()-t.base.getTime())-Math.abs(e.getTime()-i.base.getTime()))){const i=Math.round((e.getTime()-t.base.getTime())/6e4);if(Math.abs(i)<1440)return this._boundaryString({anchor:t.anchor,mode:"offset",hours:Math.floor(Math.abs(i)/60),minutes:Math.abs(i)%60,before:i<0})}return s(this._plan.endAnchor)}_dateFromPointer(e,t){const i=this._bandStart,s=this._bandEnd;if(!i||!s)return null;const a=e.getBoundingClientRect(),o="rtl"==getComputedStyle(this).direction,n=Math.min(1,Math.max(0,(o?a.right-t:t-a.left)/a.width)),r=new Date(i.getTime()+n*(s.getTime()-i.getTime()));return r.setMinutes(5*Math.round(r.getMinutes()/5),0,0),r}_handleDragStart(e,t,i){const s=e.currentTarget.parentElement;s&&(e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),this._drag={row:t,index:i,track:s})}_handleDragMove(e){if(!this._drag)return;const t=this._dateFromPointer(this._drag.track,e.clientX);t&&this._moveBoundary(this._drag.row,this._drag.index,this._boundaryFromDate(t),`drag:${this._drag.row}:${this._drag.index}`)}_handleDragEnd(){this._drag=null}_moveBoundary(e,t,i,s){const a=this._plan.groups.find(t=>t.track==e),o=this._moment(i);if(!a||!o)return;const n=e=>{var t,i;return null!==(i=null===(t=this._moment(e))||void 0===t?void 0:t.getTime())&&void 0!==i?i:null},r=a.cubes.map(e=>Object.assign({},e));r[t]=Object.assign(Object.assign({},r[t]),{start:i}),t>0&&(r[t-1]=Object.assign(Object.assign({},r[t-1]),{stop:i}));let d=o.getTime();for(let e=t;e<r.length;e++){const t=n(r[e].stop);if(null===t||t>=d+3e5)break;d+=3e5;const i=this._boundaryFromDate(new Date(d));r[e]=Object.assign(Object.assign({},r[e]),{stop:i}),e+1<r.length&&(r[e+1]=Object.assign(Object.assign({},r[e+1]),{start:i}))}d=o.getTime();for(let e=t-1;e>=0;e--){const t=n(r[e].start);if(null===t||t<=d-3e5)break;d-=3e5;const i=this._boundaryFromDate(new Date(d));r[e]=Object.assign(Object.assign({},r[e]),{start:i}),e>0&&(r[e-1]=Object.assign(Object.assign({},r[e-1]),{stop:i}))}this._setCubes(e,r,s)}_setCubes(e,t,i){this._updatePlan({groups:this._plan.groups.map(i=>i.track==e?Object.assign(Object.assign({},i),{cubes:this._resolveOverlaps(t)}):i)},i),this._keepSelectionValid()}_resolveOverlaps(e){const t=e=>{var t,i;return null!==(i=null===(t=this._moment(e))||void 0===t?void 0:t.getTime())&&void 0!==i?i:null};let i=e.filter(e=>{const i=t(e.start),s=t(e.stop);return null===i||null===s||s-i>=3e5});return i.length?(i=i.map((e,t)=>t<i.length-1?Object.assign(Object.assign({},e),{stop:i[t+1].start}):e),i):e.slice(0,1)}_updatePlan(e,t){const i=this._plan;void 0!==t&&t===this._lastChange||(this._history=[...this._history.slice(-49),i]),this._lastChange=t,this._future=[],this._plan=Object.assign(Object.assign({},i),e)}_undo(){if(!this._history.length)return;const e=this._history[this._history.length-1];this._history=this._history.slice(0,-1),this._future=[...this._future,this._plan],this._plan=e,this._lastChange=void 0,this._keepSelectionValid()}_redo(){if(!this._future.length)return;const e=this._future[this._future.length-1];this._future=this._future.slice(0,-1),this._history=[...this._history,this._plan],this._plan=e,this._lastChange=void 0,this._keepSelectionValid()}_keepSelectionValid(){var e,t,i;this._selectedCube()||this._selectedDetach()||(this._selected=null!==(i=null===(t=null===(e=this._plan.groups[0])||void 0===e?void 0:e.cubes[0])||void 0===t?void 0:t.id)&&void 0!==i?i:null)}_updateCube(e,t,i){this._updatePlan({groups:this._plan.groups.map(s=>s.track!=e?s:Object.assign(Object.assign({},s),{cubes:s.cubes.map(e=>e.id==t?Object.assign(Object.assign({},e),i):e)}))})}_updateDetach(e,t){this._updatePlan({detaches:this._plan.detaches.map(i=>i.track==e?Object.assign(Object.assign({},i),t):i)})}_selectedCube(){for(const e of this._plan.groups){const t=e.cubes.find(e=>e.id==this._selected);if(t)return{group:e,cube:t}}return null}_selectedDetach(){return this._plan.detaches.find(e=>e.track==this._selected)||null}_addGroup(){const e=this._t("group.new","{n}",String(this._plan.groups.length+1)),t=this._blankPlan().groups[0],i=Object.assign(Object.assign({},t),{track:qo(e),name:e,cubes:t.cubes.map((t,i)=>Object.assign(Object.assign({},t),{id:`${qo(e)}#${i}`}))});this._updatePlan({groups:[...this._plan.groups,i]}),this._selected=i.cubes[0].id}_removeGroup(e){var t,i,s;this._updatePlan({groups:this._plan.groups.filter(t=>t.track!=e)}),this._selected=null!==(s=null===(i=null===(t=this._plan.groups[0])||void 0===t?void 0:t.cubes[0])||void 0===i?void 0:i.id)&&void 0!==s?s:null}_splitCube(e,t){const i=e.cubes.findIndex(e=>e.id==t.id),s=this._moment(t.start),a=this._moment(t.stop);if(!s||!a||a.getTime()-s.getTime()<6e5)return;const o=new Date((s.getTime()+a.getTime())/2);o.setMinutes(5*Math.round(o.getMinutes()/5),0,0);const n=this._boundaryFromDate(o),r=Object.assign(Object.assign({},t),{id:`${e.track}#new${i}${e.cubes.length}`,name:"",color:void 0,start:n,devices:this._invertDevices(t)}),d=[...e.cubes];d.splice(i,1,Object.assign(Object.assign({},t),{stop:n}),r),this._setCubes(e.track,d),this._selected=r.id}_invertDevices(e){const t={};return Object.entries(e.devices||{}).forEach(([e,i])=>{t[e]=Xa(i)||i}),t}_removeCube(e,t){if(e.cubes.length<2)return;const i=e.cubes.findIndex(e=>e.id==t.id),s=e.cubes.filter(e=>e.id!=t.id);i>0?s[i-1]=Object.assign(Object.assign({},s[i-1]),{stop:t.stop}):s[0]=Object.assign(Object.assign({},s[0]),{start:t.start}),this._selected=s[Math.max(0,i-1)].id,this._setCubes(e.track,s)}_detachDevice(e,t){let i=Vo(t),s=1;for(;this._plan.detaches.some(e=>e.track==i);)i=`${Vo(t)}#${s++}`;const a=e.cubes[Math.min(2,e.cubes.length-1)],o={track:i,name:this._t("detach.name"),entity:t,start:a.start,stop:a.stop,action:{service:t.split(".")[0]+".turn_on",service_data:{}}};this._updatePlan({detaches:[...this._plan.detaches,o]}),this._selected=i}_rejoinGroup(e){var t,i,s;this._updatePlan({detaches:this._plan.detaches.filter(t=>t.track!=e)}),this._selected=null!==(s=null===(i=null===(t=this._plan.groups[0])||void 0===t?void 0:t.cubes[0])||void 0===i?void 0:i.id)&&void 0!==s?s:null}_setMembers(e,t){const i=t.filter(t=>!e.entities.includes(t)),s=e=>{const s=Object.assign({},e.devices||{});return i.forEach(t=>{s[t]=Zo(t,!1!==e.suggestOn)}),Object.keys(s).forEach(e=>{t.includes(e)||delete s[e]}),Object.assign(Object.assign({},e),{devices:s})};this._updatePlan({groups:this._plan.groups.map(i=>i.track==e.track?Object.assign(Object.assign({},i),{entities:t,cubes:i.cubes.map(s)}):i),detaches:this._plan.detaches.filter(i=>t.includes(i.entity)||this._plan.groups.some(t=>t.track!=e.track&&t.entities.includes(i.entity)))})}async _save(){if(!this._bandStart||!this._bandEnd)return void(this._error=this._t("error.no_anchor"));const e=((e,t)=>{const i=[],s=new Map,a=e=>Po(e,t)||null;e.groups.forEach(e=>{e.entities.length||i.push({key:"check.empty_group",values:{group:e.name}}),e.entities.forEach(a=>{t.states[a]?is(a,t)||i.push({key:"check.not_a_device",values:{device:No(t,a)}}):i.push({key:"check.unknown_device",values:{device:a}});const o=s.get(a);o&&o!=e.name&&i.push({key:"check.two_groups",values:{device:No(t,a),a:o,b:e.name}}),s.set(a,e.name)}),e.cubes.forEach((s,o)=>{const n=s.name||"#"+(o+1);Object.entries(s.devices||{}).forEach(([s,a])=>{e.entities.includes(s)||i.push({key:"check.stranger",values:{where:n,device:No(t,s),group:e.name}}),(null==a?void 0:a.service)?i.push(...Io(t,n,s,a)):i.push({key:"check.no_action",values:{where:n,device:No(t,s)}})});const r=e.cubes[o+1];r&&s.stop!=r.start&&i.push({key:"check.gap",values:{where:n,next:r.name||"#"+(o+2)}});const d=a(s.start),l=a(s.stop);d&&l&&l.getTime()<=d.getTime()&&i.push({key:"check.backwards",values:{where:n}})})}),e.detaches.forEach(e=>{const s=a(e.start),o=a(e.stop);s&&o&&o.getTime()<=s.getTime()&&i.push({key:"check.backwards",values:{where:e.name||No(t,e.entity)}}),e.action&&i.push(...Io(t,e.name||No(t,e.entity),e.entity,e.action))});const o=[];return i.forEach(e=>{const t=JSON.stringify(e);o.some(e=>JSON.stringify(e)==t)||o.push(e)}),o})(this._plan,this.hass);if(e.length)return void(this._error=[this._t("check.refused"),...e.slice(0,4).map(e=>this._t(e.key,Object.keys(e.values||{}).map(e=>`{${e}}`),Object.values(e.values||{}))),...e.length>4?[this._t("check.and_more","{n}",String(e.length-4))]:[]].join(" "));const t=Yo(this._plan,this._base);try{t.schedule_id?await qa(this.hass,t):await Ma(this.hass,t),this._saved=!0,this._showReport()}catch(e){this._reportError(e)}}async _delete(){this._base.schedule_id&&await Ra(this.hass,this._base.schedule_id).catch(e=>this._reportError(e)),this.closeDialog()}_reportError(e){var t,i;this._error=(null===(t=null==e?void 0:e.body)||void 0===t?void 0:t.message)||(null==e?void 0:e.error)||String(e),(null===(i=null==e?void 0:e.body)||void 0===i?void 0:i.message)&&Ha(e,this,this.hass)}updated(){this.toggleAttribute("plain",this._plainColours)}render(){return this._params?H`
      <ha-dialog open @closed=${this.closeDialog} width="full" prevent-scrim-close>
        ...
        <div class="content">
          ...
          ${this._error?H`<div class="error">${this._error}</div>`:q}
        </div>

        ${null!==this._wizardStep?q:H`
        <div class="buttons" slot="footer">
    ...
    `}_renderHeader(){return H`
      <div class="plan-header">
        <div class="plan-title">
          ...
          >
            <ha-svg-icon .path=${Ks}></ha-svg-icon>${this._t("settings.open")}
          </button>
    ...
    `}_renderKeys(){const e=[["← →",this._t("keys.select")],["↑ ↓",this._t("keys.row")],["⇧ ← →",this._t("keys.move_start")],["⌥ ← →",this._t("keys.move_stop")],["N",this._t("cube.split")],["⌫",ds("ui.common.delete",this.hass)],["O",this._t("keys.state")],["H",this._t("enforce.label")],["1…9 / 0",this._t("keys.colour")],["G",this._t("group.add")],["R",this._t("report.open")],["W",this._t("wizard.open")],["↵",this._t("keys.rename")],["⌘Z / Ctrl Z",this._t("history.undo")],["⌘Y / Ctrl Y",this._t("history.redo")],["⌘S / Ctrl S",ds("ui.common.save",this.hass)],["?",this._t("keys.open")]];return H`
      <div class="keys">
        ${e.map(([e,t])=>H`
          <div class="key-row"><kbd>${e}</kbd><span>${t}</span></div>`)}
      </div>
    `}_renderReport(e){const t=e=>{var t;return e?new Intl.DateTimeFormat((null===(t=this.hass.locale)||void 0===t?void 0:t.language)||"en",{weekday:"short",hour:"2-digit",minute:"2-digit"}).format(e):"—"};return H`
      <div class="report">
        ...
        ${this._saved?H`<div class="report-saved">${this._t("report.saved")}</div>`:q}

        ${e.problems.length?H`<div class="report-problem">
          ...
          <li>
            ...
            <div class="report-what">
              <span class="report-name">
                ...
                ${e.holds?H`<span class="beta">${this._t("enforce.on")}</span>`:q}
              </span>
              <div class="report-devices">
                ...
                <span class="report-device ${e.state}">
                  ...
                  ${void 0!==e.brightness?H`<i>${e.brightness}%</i>`:q}
                  ${void 0!==e.kelvin?H`<i>${e.kelvin}K</i>`:q}
                  ${void 0!==e.degrees?H`<i>${e.degrees}°</i>`:q}
                  ${e.takenOverBy?H`<em>${this._t("report.taken","{name}",e.takenOverBy)}</em>`:q}
                </span>`)}
              </div>
            </div>
          </li>`)}
    ...
    `}async _loadBook(){try{const t=await(e=this.hass,e.callWS({type:"scheduler/device_book"}));this._book={groups:(null==t?void 0:t.groups)||[],devices:(null==t?void 0:t.devices)||[],kinds:(null==t?void 0:t.kinds)||[]}}catch(e){this._book=tn}var e}_renderBook(){const e=[...this._book.devices].sort((e,t)=>e.name.localeCompare(t.name)),t=[...this._book.groups.map(e=>e.name),...this._draftGroups.filter(e=>!this._book.groups.some(t=>t.name==e))];return H`
      <div class="book">
        <div class="book-head">
        ...
        <div class="book-body">
          <div class="book-groups">
            ...
            ${t.length?t.map(e=>{var t;const i=(null===(t=this._book.groups.find(t=>t.name==e))||void 0===t?void 0:t.devices)||[];return H`
            <div class="book-group">
              <span class="book-group-name">${e}</span>
              <span class="book-group-count">
                ${this._t("group.members","{n}",String(i.length))}
              </span>
              <button class="ghost small" ?disabled=${!i.length}
                @click=${()=>this._useGroup(e)}>
                ${this._t("book.use")}
              </button>
              <button class="ghost small danger" @click=${()=>this._removeGroup(e)}>
                ${ds("ui.common.delete",this.hass)}
              </button>
            </div>`}):H`<span class="hint">${this._t("book.no_groups")}</span>`}
            ...
            <div class="book-group new">
              <input
                ...
                @keydown=${e=>{"Enter"==e.key&&this._addDraftGroup()}}
              />
          ...
          <div class="book-devices">
            ...
            ${e.length?e.map(e=>this._renderBookDevice(e.entity_id,t)):H`<span class="hint">${this._t("book.no_devices")}</span>`}
            ...
            <div class="book-add">
              ...
              <scheduler-entity-picker
                ...
                .devicesOnly=${!0}
                .value=${[]}
                @value-changed=${e=>this._addToBook(e.detail.value)}
              ></scheduler-entity-picker>
            </div>
          </div>
        </div>
      </div>
    `}_renderBookDevice(e,t){var i;const s=this._book.devices.find(t=>t.entity_id==e),a=this._book.kinds.length?this._book.kinds:["light","switch","climate","other"],o=t=>{var i;return((null===(i=this._book.groups.find(e=>e.name==t))||void 0===i?void 0:i.devices)||[]).includes(e)};return H`
      <div class="device-row">
        <span class="device-label" title=${e}>
          ${(null===(i=this.hass.states[e])||void 0===i?void 0:i.attributes.friendly_name)||e}
        </span>
        <input
          class="moment-name"
          .value=${(null==s?void 0:s.alias)||""}
        ...
        <select @change=${t=>this._nameDevice(e,{kind:t.target.value})}>
          ${a.map(t=>H`
            <option value=${t} ?selected=${((null==s?void 0:s.kind)||e.split(".")[0])==t}>
              ${this._t("book.kind."+t)||t}
            </option>`)}
        </select>
        <button class="icon-only danger" title=${this._t("book.remove")}
          @click=${()=>this._forgetDevice(e)}>
          <ha-svg-icon .path=${Zs}></ha-svg-icon>
        </button>
        ${t.length?H`
        <div class="book-group-chips">
          ${t.map(t=>H`
          <button class="chip ${o(t)?"on":""}"
            @click=${()=>this._toggleGroupMember(t,e)}>
            ${t}
          </button>`)}
        </div>`:q}
      </div>
    `}async _toggleGroupMember(e,t){var i;const s=(null===(i=this._book.groups.find(t=>t.name==e))||void 0===i?void 0:i.devices)||[],a=s.includes(t)?s.filter(e=>e!=t):[...s,t];await this._saveGroup(e,a)}async _removeBookGroup(e){this._draftGroups=this._draftGroups.filter(t=>t!=e),this._book.groups.some(t=>t.name==e)&&await this._saveGroup(e,[])}async _addToBook(e){var t;const i=Array.isArray(e)?e[e.length-1]:e;if(!i||this._book.devices.some(e=>e.entity_id==i))return;const s=(null===(t=this.hass.states[i])||void 0===t?void 0:t.attributes.friendly_name)||i;await this._nameDevice(i,{name:s})}async _forgetDevice(e){try{this._book=await(t=this.hass,i=e,t.callWS({type:"scheduler/device_book/forget",entity_id:i}))}catch(e){this._reportError(e)}var t,i}async _saveGroup(e,t){try{this._book=await((e,t,i)=>e.callWS({type:"scheduler/device_book/group",group:t,devices:i}))(this.hass,e,t),this._newGroup=""}catch(e){this._reportError(e)}}async _nameDevice(e,t){try{this._book=await((e,t,i)=>e.callWS(Object.assign({type:"scheduler/device_book/device",entity_id:t},i)))(this.hass,e,t)}catch(e){this._reportError(e)}}_useGroup(e){const t=this._selectedCube(),i=(null==t?void 0:t.group)||this._plan.groups[0];if(!i)return;const s=on(this._book,e);this._setMembers(i,[...new Set([...i.entities,...s])])}_renderMissingAnchors(){return H`
      <div class="empty">
        <div class="empty-title">${this._t("error.no_anchor")}</div>
        <div class="empty-body">
          ${this._t("error.no_anchor_hint",["{start}","{end}"],[Ho,Ro])}
        </div>
      </div>
    `}_renderBand(){return H`
      <div class="band">
        <div class="ruler">
          ${this._hourTicks().map(e=>H`<span class="tick" style="inset-inline-start:${(100*e.at).toFixed(3)}%">${e.label}</span>`)}
        </div>
        ...
        <div class="row-actions">
          <button class="ghost" @click=${this._addGroup}>
            <ha-svg-icon .path=${Js}></ha-svg-icon>${this._t("group.add")}
          </button>
        </div>
      </div>
    `}_renderGroupRow(e){return H`
      <div class="row">
        <div class="row-label">
    ...
    `}_renderHandle(e,t,i){const s=this._position(i.start);return null===s?q:H`
      <div
        class="handle"
        ...
        @pointerup=${this._handleDragEnd}
      ></div>
    `}_cubeTone(e){const t=Object.values(e.devices||{});if(!t.length)return"empty";const i=t.filter(Za).length;return i===t.length?"off":0===i?"on":"mixed"}_cubeStyle(e){if(e.color)return`background:${e.color};color:#fff`;if(this._plainColours)return"";const t=Object.values(e.devices||{}),i=t.filter(e=>!Za(e));if(i.length===t.length&&i.length){const e=so(i[0]);if(e){const[t,i,s]=e.rgb;return`background:rgba(${t},${i},${s},${e.alpha})`}}return""}_renderCube(e,t){const i=this._position(t.start),s=this._position(t.stop);if(null===i||null===s||s<=i)return q;const a=this._cubeTone(t),o=this._selected==t.id;return H`
      <button
      ...
      >
        ...
        <span class="cube-tools">
          ...
          ><ha-svg-icon .path=${Js}></ha-svg-icon></span>
          ${e.cubes.length>1?H`
          <span
            class="cube-tool"
            title=${ds("ui.common.delete",this.hass)}
            @click=${i=>{i.stopPropagation(),this._removeCube(e,t)}}
          ><ha-svg-icon .path=${Zs}></ha-svg-icon></span>`:q}
        </span>`:q}
      </button>
    `}_renderDetachRow(e){var t;const i=this._position(e.start),s=this._position(e.stop),a=(null===(t=this.hass.states[e.entity])||void 0===t?void 0:t.attributes.friendly_name)||e.entity;return H`
    ...
    `}_renderInspector(){const e=this._selectedCube(),t=this._selectedDetach();if(t)return this._renderDetachInspector(t);if(!e)return q;const{group:i,cube:s}=e;return H`
      <div class="inspector">
        <div class="inspector-head">
          ...
          <div class="inspector-actions">
            ...
            >
              <ha-svg-icon .path=${ea}></ha-svg-icon>${ds("ui.common.delete",this.hass)}
            </button>
          </div>
        </div>
        ...
        <div class="fields">
          ...
          ${this._nextCube(i,s)?H`<span class="hint spans">
        ...
        <div class="members">
          ...
          ${this._book.groups.length?H`
          <div class="member-chips">
            ${this._book.groups.map(e=>H`
              <button class="chip" @click=${()=>this._useGroup(e.name)}>
                <ha-svg-icon .path=${Js}></ha-svg-icon>${e.name}
                <span class="chip-action">
                  ${this._t("group.members","{n}",String(e.devices.length))}
                </span>
              </button>`)}
          </div>`:q}
          ${this._book.devices.length?H`
          <div class="member-chips">
            ${this._book.devices.map(e=>{var t;const s=i.entities.includes(e.entity_id);return H`
              <button
          ...
          <div class="member-chips">
            ${i.entities.map(e=>{var t;return H`
          ...
          ${this._plan.groups.length>1?H`<button class="ghost danger" @click=${()=>this._removeGroup(i.track)}>
              ${this._t("group.remove")}
            </button>`:q}
        </div>
      </div>
    `}_renderDetachInspector(e){var t;const i=(null===(t=this.hass.states[e.entity])||void 0===t?void 0:t.attributes.friendly_name)||e.entity;return H`
      <div class="inspector detached">
        ...
        <div class="fields">
          ...
          ${this._renderStateField(Za(e.action),t=>this._updateDetach(e.track,{action:Object.assign(Object.assign({},e.action),{service:`${e.action.service.split(".")[0]}.${t?"turn_off":"turn_on"}`})}))}
    ...
    `}_nextCube(e,t){return e.cubes[e.cubes.findIndex(e=>e.id==t.id)+1]}_setCubeEnd(e,t,i){const s=e.cubes.findIndex(e=>e.id==t.id);s<0||(s+1<e.cubes.length?this._moveBoundary(e.track,s+1,i,`end:${e.track}:${s}`):this._setCubes(e.track,e.cubes.map((e,t)=>t==s?Object.assign(Object.assign({},e),{stop:i}):e),`end:${e.track}:${s}`))}_renderBoundaryField(e,t,i){const s=this._boundaryParts(t),a=e=>i(this._boundaryString(Object.assign(Object.assign({},s),e))),o=[{value:"exact",label:this._t("boundary.exact")},{value:"offset",label:this._t("boundary.offset")},{value:"clock",label:this._t("boundary.clock")}];return H`
      <div class="field boundary">
        ...
        >
          ${this._anchorOptions(s.anchor).map(e=>H`<option value=${e.value} ?selected=${e.value==s.anchor}>${e.label}</option>`)}
        </select>
        ...
        ${s.anchor&&"exact"==s.mode?q:H`
        <div class="field-row">
          ${s.anchor&&"offset"==s.mode?H`
          <button
    ...
    `}_renderStateField(e,t){return H`
      <div class="field">
    ...
    `}_renderOverrides(e,t){return e.entities.length?H`
      <div class="overrides">
    ...
    `:q}_renderDeviceRow(e,t,i){return this._deviceRow(i,Uo(t,i),s=>this._setDeviceAction(e,t,i,s),()=>this._clearDeviceAction(e,t,i))}_deviceRow(e,t,i,s,a){var o;const n=e.split(".")[0],r=!!(null==a?void 0:a.undecided),d=!t&&!r,l=!!t&&Za(t),c=t||Zo(e,!0),h=e=>i(Object.assign(Object.assign({},c),e)),u=(null==a?void 0:a.note)||(d?this._t("device.untouched_hint"):"");return H`
      <div class="device-row ${d?"untouched":""} ${r?"undecided":""}">
        <span class="device-label">
          <span class="device-dot ${r?"pending":d?"none":l?"off":"on"}"></span>
          ${(null===(o=this.hass.states[e])||void 0===o?void 0:o.attributes.friendly_name)||e}
          ${u?H`<em class="follows">${u}</em>`:q}
        </span>

        <div class="segmented states">
          <button class="on ${r||d||l?"":"active"}" @click=${()=>h({service:n+".turn_on"})}>${this._t("state.on")}</button>
          <button class="off ${r||d||!l?"":"active"}" @click=${()=>h({service:n+".turn_off",service_data:{}})}>${this._t("state.off")}</button>
          <button class="none ${d?"active":""}" title=${this._t("device.untouched_hint")}
            @click=${s}>${this._t("device.untouched")}</button>
        </div>

        ${r||d||l?q:this._renderDeviceParameters(n,c,h)}
      </div>
    `}_renderDeviceParameters(e,t,i){var s;const a=t.service_data||{},o=e=>{const t=Object.assign(Object.assign({},a),e);Object.keys(t).forEach(e=>{void 0===t[e]&&delete t[e]}),i({service_data:t})};if("light"==e){const e=null!==(s=a.brightness_pct)&&void 0!==s?s:void 0!==a.brightness?Math.round(a.brightness/255*100):void 0,t=a.color_temp_kelvin;return H`
        <label class="param">
        ...
        </label>`}if("climate"==e){const e=a.temperature;return H`
        <label class="param">
          <input type="checkbox" ?checked=${void 0!==e}
    ...
    `}_renderEnforceField(e,t){return H`
      <div class="field">
        <span class="field-label">
    ...
    `}_renderAllDevicesField(e,t){const i=i=>{const s={};e.entities.forEach(e=>{const t=i(e);t&&(s[e]=t)}),this._updateCube(e.track,t.id,{devices:s})};return H`
      <div class="field">
        <span class="field-label">${this._t("device.all")}</span>
        <div class="segmented states">
          <button class="on" @click=${()=>i(e=>Zo(e,!0))}>
            ${this._t("state.on")}
          </button>
          <button class="off" @click=${()=>i(e=>Zo(e,!1))}>
            ${this._t("state.off")}
          </button>
    ...
    `}_renderColorField(e,t){return H`
      <div class="field">
    ...
    `}get _wizardSteps(){return[{key:"intro",kind:"intro"},{key:"devices",kind:"devices"},{key:"parts",kind:"parts"},{key:"opening",kind:"opening"},...this._orderedMoments().map(e=>({key:"part:"+e.id,kind:"part",moment:e.id})),{key:"hold",kind:"hold"},{key:"review",kind:"review"}]}get _wizardStepAt(){var e;const t=this._wizardSteps;return t[Math.min(null!==(e=this._wizardStep)&&void 0!==e?e:0,t.length-1)]}_momentBoundary(e){const[t,i]=e.time.split(":").map(Number);if("end"==e.when)return this._boundaryString({anchor:this._plan.endAnchor,mode:"offset",hours:t||0,minutes:i||0,before:!1!==e.before});if("sunset"==e.when){const s=e.before?-1:1;return Re({mode:we.Sunset,hours:s*(t||0),minutes:s*(i||0)})}const s=(t||0)>=16;return this._boundaryString({anchor:s?this._plan.startAnchor:this._plan.endAnchor,mode:"clock",hours:t||0,minutes:i||0,before:!1})}_momentCaution(e){const t=this._moment(this._momentBoundary(e)),i=this._bandStart,s=this._bandEnd;if(!t||!i||!s)return this._t("wizard.caution.unknown");if(t<=i||t>=s){const t=this._formatMoment(this._momentBoundary(e));return this._t("sunset"==e.when?"wizard.caution.estimate":"wizard.caution.outside","{time}",t)}if("clock"!=e.when)return null;return Math.min((t.getTime()-i.getTime())/36e5,(s.getTime()-t.getTime())/36e5)<1.5?this._t("wizard.caution.tight","{time}",e.time):this._t("wizard.caution.hard","{time}",e.time)}_momentProblem(e){const t=e=>e.name||this._t("cube.unnamed");if(!/^\d{1,2}:\d{2}$/.test(e.time||""))return this._t("wizard.problem.no_time","{name}",t(e));const i=this._moment(this._momentBoundary(e));if(!i)return null;const s=this._bandStart,a=this._bandEnd;if(s&&a&&(i<=s||i>=a)&&"sunset"!=e.when)return this._t("wizard.problem.outside",["{name}","{time}"],[t(e),this._formatMoment(this._momentBoundary(e))]);const o=this._wizard.moments.find(t=>{if(t.id==e.id)return!1;const s=this._moment(this._momentBoundary(t));return!!s&&Math.abs(s.getTime()-i.getTime())<6e4});return o?this._t("wizard.problem.collide","{names}",[t(e),t(o)].join(" · ")):null}_wizardProblems(){const e=[],t=[],i=this._bandStart,s=this._bandEnd,a=e=>e.name||this._t("cube.unnamed"),o=this._wizard.moments.map(e=>({moment:e,boundary:this._momentBoundary(e),at:this._moment(this._momentBoundary(e))}));o.forEach(({moment:o,boundary:n,at:r})=>{if(!/^\d{1,2}:\d{2}$/.test(o.time||""))return void e.push(this._t("wizard.problem.no_time","{name}",a(o)));if(!r)return void t.push(this._t("wizard.problem.unknown","{name}",a(o)));if(!i||!s||r>i&&r<s)return;const d=this._t("wizard.problem.outside",["{name}","{time}"],[a(o),this._formatMoment(n)]);"sunset"==o.when?t.push(d):e.push(d)});const n=new Map;o.forEach(({moment:e,at:t})=>{if(!t)return;const i=Math.floor(t.getTime()/6e4);n.set(i,[...n.get(i)||[],a(e)])}),n.forEach(t=>{t.length>1&&e.push(this._t("wizard.problem.collide","{names}",t.join(" · ")))});const r=o.filter(e=>"clock"==e.moment.when);return r.length&&t.push(this._t("wizard.problem.hard","{names}",r.map(e=>a(e.moment)).join(" · "))),r.forEach(({moment:e,at:o})=>{if(!o||!i||!s)return;const n=Math.min(o.getTime()-i.getTime(),s.getTime()-o.getTime())/36e5;n>0&&n<1.5&&t.push(this._t("wizard.problem.tight",["{name}","{hours}"],[a(e),n.toFixed(1)]))}),{blocking:e,warnings:t}}_wizardBlocked(e){if("devices"==e.kind)return!this._wizard.entities.length;if("opening"==e.kind)return this._openingUndecided().length>0;if("part"==e.kind){const t=this._wizard.moments.find(t=>t.id==e.moment);return!!t&&null!==this._momentProblem(t)}return"review"==e.kind&&this._wizardProblems().blocking.length>0}_orderedMoments(){return[...this._wizard.moments].map((e,t)=>({moment:e,index:t,at:this._moment(this._momentBoundary(e))})).sort((e,t)=>e.at&&t.at?e.at.getTime()-t.at.getTime()||e.index-t.index:e.at?-1:t.at?1:e.index-t.index).map(e=>e.moment)}_wizardTimeline(){const e=this._bandStart,t=this._bandEnd,i=this._wizard.moments.map(i=>{const s=this._momentBoundary(i),a=this._moment(s);return{moment:i,boundary:s,at:a,inside:!!(a&&e&&t&&a>e&&a<t)||!(!a||"sunset"!=i.when)}});return{inside:i.filter(e=>e.inside).sort((e,t)=>e.at.getTime()-t.at.getTime()),outside:i.filter(e=>!e.inside)}}_updateMoment(e,t){this._wizard=Object.assign(Object.assign({},this._wizard),{moments:this._wizard.moments.map(i=>i.id==e?Object.assign(Object.assign({},i),t):i)})}_addMoment(e){const t={id:`m${this._wizard.moments.length}-${(null==e?void 0:e.key)||"new"}`,name:e?this._t("wizard.preset."+e.key):"",when:(null==e?void 0:e.when)||"clock",time:(null==e?void 0:e.time)||"12:00",before:null==e?void 0:e.before,states:{}};this._wizard=Object.assign(Object.assign({},this._wizard),{moments:[...this._wizard.moments,t]})}_removeMoment(e){this._wizard=Object.assign(Object.assign({},this._wizard),{moments:this._wizard.moments.filter(t=>t.id!=e)})}_renderWizard(){var e;const t=this._wizardSteps,i=Math.min(null!==(e=this._wizardStep)&&void 0!==e?e:0,t.length-1),s=t[i],a=i==t.length-1,o=this._wizardBlocked(s),n=s.moment?this._wizard.moments.find(e=>e.id==s.moment):void 0;return H`
      <div class="wizard">
        <div class="wizard-progress">
          ${t.map((e,t)=>H`<span class="dot ${t<=i?"done":""}"></span>`)}
        </div>

        <h2 class="wizard-title">
          ${"part"==s.kind?(null==n?void 0:n.name)||this._t("wizard.part.untitled"):this._t(`wizard.${s.kind}.title`)}
          <span class="wizard-count">
            ${this._t("wizard.step_of",["{n}","{total}"],[String(i+1),String(t.length)])}
          </span>
          ${this._helpFor("step_"+s.kind)}
        </h2>
        <p class="wizard-body">${this._t(`wizard.${s.kind}.body`)}</p>
        ${this._helpText("step_"+s.kind)}

        ${"intro"==s.kind?this._renderWizardIntro():q}
        ${"devices"==s.kind?this._renderWizardDevices():q}
        ${"parts"==s.kind?this._renderWizardParts():q}
        ${"opening"==s.kind?this._renderWizardOpening():q}
        ${"part"==s.kind&&n?this._renderWizardPart(n):q}
        ${"hold"==s.kind?this._renderWizardHold():q}
        ${"review"==s.kind?this._renderWizardReview():q}

        <div class="wizard-buttons">
          <button class="ghost" @click=${()=>{this._wizardStep=i>0?i-1:null}}>
            ${i>0?this._t("wizard.back"):ds("ui.common.cancel",this.hass)}
          </button>
          <button
            class="ghost primary"
            ?disabled=${o}
            title=${o?this._t("wizard.blocked"):""}
            @click=${()=>a?this._finishWizard():this._wizardStep=i+1}
          >
            ${a?this._t("wizard.finish"):this._t("wizard.next")}
          </button>
        </div>
      </div>
    `}_renderWizardIntro(){return H`
      <div class="wizard-intro">
        <span class="field-label">${this._t("wizard.intro.list_title")}</span>
        <ol class="intro-list">
          ${["list_devices","list_parts","list_each","list_end"].map(e=>H`<li>${this._t("wizard.intro."+e)}</li>`)}
        </ol>
      </div>
    `}_renderWizardParts(){const e=new Set(this._wizard.moments.map(e=>e.name)),t=this._prefs.moments.filter(t=>!e.has(this._t("wizard.preset."+t.key)));return H`
      <div class="wizard-parts">
        ${this._wizard.moments.length?H`
        <ol class="part-list">
          ${this._orderedMoments().map((e,t)=>H`
          <li class="part-row">
            <span class="part-index">${t+1}</span>
            <input
              class="moment-name"
              .value=${e.name}
            ...
            />
            <button class="icon-only" title=${ds("ui.common.delete",this.hass)}
              @click=${()=>this._removeMoment(e.id)}>
              <ha-svg-icon .path=${Zs}></ha-svg-icon>
            </button>
          </li>`)}
        </ol>`:H`<p class="wizard-empty">${this._t("wizard.parts.empty")}</p>`}
        ...
        <div class="field">
          ...
          <div class="moment-presets">
            ...
            <button class="chip" @click=${()=>this._addMoment(e)}>
              <ha-svg-icon .path=${Js}></ha-svg-icon>${this._t("wizard.preset."+e.key)}
            </button>`)}
          </div>
        </div>`:q}

        <button class="ghost" @click=${()=>this._addMoment()}>
          <ha-svg-icon .path=${Js}></ha-svg-icon>${this._t("wizard.moments.add")}
        </button>
        <span class="hint">${this._t("wizard.parts.hint")}</span>
      </div>
    `}_renderWizardPart(e){const t=this._orderedMoments(),i=t.findIndex(t=>t.id==e.id),s=i>0?t[i-1]:null,a=s?this._formatMoment(this._momentBoundary(s)):this._formatMoment(this._plan.startAnchor+"+00:00:00"),o=this._moment(this._momentBoundary(e)),n=this._momentCaution(e),r=!!(o&&this._bandStart&&this._bandEnd&&(o<=this._bandStart||o>=this._bandEnd)&&"sunset"!=e.when);return H`
      <div class="wizard-part">
        <p class="part-from">
          ${this._t("wizard.part.starts","{time}",s?`${s.name||this._t("cube.unnamed")} · ${a}`:a)}
        </p>
        ...
        <div class="field">
          ...
          <span class="field-resolved ${r?"wrong":""}">
            ${o?this._t("wizard.part.ends_at","{time}",this._formatMoment(this._momentBoundary(e))):this._t("wizard.part.ends_unknown")}
          </span>
          ${n&&o?H`<p class="wizard-warning ${r?"blocking":""}">
              <span class="mark">${r?"✕":"⚠"}</span>${n}
            </p>`:q}
        </div>
        ...
        <div class="field">
          ...
          ${this._renderWizardDeviceRows(e.id)}
        </div>
      </div>
    `}_renderWizardDeviceRows(e){var t;const i=this._statesAt(e),s=e?null===(t=this._wizard.moments.find(t=>t.id==e))||void 0===t?void 0:t.states:this._wizard.opening||{};return H`
      <div class="wizard-states">
        <div class="bulk">
          <span class="hint">${this._t("wizard.part.bulk")}</span>
          <button class="ghost small" @click=${()=>this._setAllDevices(e,!0)}>
            ${this._t("wizard.part.all_on")}
          </button>
          <button class="ghost small" @click=${()=>this._setAllDevices(e,!1)}>
            ${this._t("wizard.part.all_off")}
          </button>
        </div>
        <div class="device-rows">
          ${this._wizard.entities.map(t=>{const a=i[t],o=void 0!==a,n=o&&!(s&&t in s);return this._deviceRow(t,a||void 0,i=>this._setMomentDevice(e,t,i),()=>this._setMomentDevice(e,t,null),{undecided:!o,note:o?n?this._t("wizard.part.carried"):void 0:this._t("wizard.part.undecided")})})}
        </div>
      </div>
    `}_statesAt(e){const t={},i=this._wizard.opening||{};if(this._wizard.entities.forEach(e=>{t[e]=i[e]}),!e)return t;for(const i of this._orderedMoments())if(Object.entries(i.states||{}).forEach(([e,i])=>{t[e]=i}),i.id==e)break;return t}_openingUndecided(){const e=this._wizard.opening||{};return this._wizard.entities.filter(t=>void 0===e[t])}_setAllDevices(e,t){this._wizard.entities.forEach(i=>this._setMomentDevice(e,i,Zo(i,t)))}_renderWizardDevices(){const e=new Set(this._wizard.entities),t=e=>{this._wizard=Object.assign(Object.assign({},this._wizard),{entities:[...new Set(e)]})},i=(e,t)=>{var i;return t||(null===(i=this.hass.states[e])||void 0===i?void 0:i.attributes.friendly_name)||e};return H`
      <div class="wizard-devices">
        ...
        <div class="field">
          ...
          <div class="member-chips">
            ${this._book.groups.map(e=>{const i=on(this._book,e.name);return H`
        ...
        <div class="field">
          ...
          </div>`:H`<p class="wizard-empty">${this._t("wizard.devices.no_book")}</p>`}
        </div>
    ...
    `}_renderWizardOpening(){const e=this._wizard.moments[0],t=this._openingUndecided();return H`
      <div class="wizard-part">
        <p class="part-from">
        ...
        ${e?H`
        <p class="part-from">
          ${this._t("wizard.opening.until","{name}",e.name||this._t("cube.unnamed"))}
        </p>`:q}
        ...
        <div class="field">
          ...
          ${t.length?H`<p class="wizard-warning blocking">
            <span class="mark">✕</span>
            ${this._t("wizard.opening.waiting","{n}",String(t.length))}
          </p>`:q}
        </div>
      </div>
    `}_renderWizardHold(){var e;const t=null===(e=this._wizard.hold)||void 0===e||e;return H`
      <div class="field">
        <span class="field-label">
          ${this._t("enforce.label")} <span class="beta">${this._t("enforce.beta")}</span>
          ${this._helpFor("hold")}
    ...
    `}_renderWizardProblems(){const{blocking:e,warnings:t}=this._wizardProblems();return e.length||t.length?H`
    ...
    `:q}_endPicker(e,t){return H`
      ...
      />
    `}_setMomentDevice(e,t,i){if(!e)return void(this._wizard=Object.assign(Object.assign({},this._wizard),{opening:Object.assign(Object.assign({},this._wizard.opening||{}),{[t]:i})}));const s=this._wizard.moments.find(t=>t.id==e);s&&this._updateMoment(e,{states:Object.assign(Object.assign({},s.states||{}),{[t]:i})})}_renderWizardReview(){const{inside:e,outside:t}=this._wizardTimeline(),i=[{at:this._plan.startAnchor+"+00:00:00",name:this._t("cube.welcome"),id:""},...e.map(e=>({at:e.boundary,name:e.moment.name||this._t("cube.unnamed"),id:e.moment.id}))];return H`
      <ol class="review">
        ${i.map(e=>{const t=this._statesAt(e.id);return H`
        <li>
          ...
          <div class="review-devices">
            ${this._wizard.entities.map(e=>{var i;const s=t[e],a=void 0===s?"pending":null===s?"none":Za(s)?"off":"on";return H`
            <span class="review-device ${a}">
              <span class="device-dot ${a}"></span>
              ${(null===(i=this.hass.states[e])||void 0===i?void 0:i.attributes.friendly_name)||e}
              ${s?this._parameterSummary(s):q}
            </span>`})}
          </div>
        </li>`})}
        <li class="review-end">
      ...
      ${t.length?H`<p class="wizard-warning">
            <span class="mark">⚠</span>
            ${this._t("wizard.review.outside","{names}",t.map(e=>e.moment.name||this._t("cube.unnamed")).join(", "))}
          </p>`:q}

      ${this._renderWizardProblems()}
    `}_parameterSummary(e){var t;const i=e.service_data||{},s=[],a=null!==(t=i.brightness_pct)&&void 0!==t?t:void 0!==i.brightness?Math.round(i.brightness/255*100):void 0;return void 0!==a&&s.push(a+"%"),void 0!==i.color_temp_kelvin&&s.push(i.color_temp_kelvin+"K"),void 0!==i.temperature&&s.push(i.temperature+"°"),s.length?H`<em class="review-param">${s.join(" · ")}</em>`:q}_finishWizard(){const e=this._wizard,t=[{at:this._plan.startAnchor+"+00:00:00",name:this._t("cube.welcome"),id:""},...this._wizardTimeline().inside.map(e=>({at:e.boundary,name:e.moment.name||this._t("cube.unnamed"),id:e.moment.id}))],i=qo(this._t("group.default")),s=t.map((s,a)=>{var o;const n=this._statesAt(s.id),r={};return e.entities.forEach(e=>{const t=n[e];t&&(r[e]=t)}),{id:`${i}#${a}`,name:s.name,start:s.at,stop:a+1<t.length?t[a+1].at:this._plan.endAnchor+"+01:30:00",devices:r,enforce:null===(o=e.hold)||void 0===o||o}});this._updatePlan({groups:[{track:i,name:this._t("group.default"),entities:e.entities,cubes:s}],detaches:[]}),this._selected=s[0].id,this._wizardStep=null,this._offerWizard=!1}static get styles(){return r`
      :host {
        --plan-radius: 14px;
    ...
    `}};t([le({attribute:!1})],pn.prototype,"hass",void 0),t([ce()],pn.prototype,"_params",void 0),t([ce()],pn.prototype,"_plan",void 0),t([ce()],pn.prototype,"_selected",void 0),t([ce()],pn.prototype,"_error",void 0),t([ce()],pn.prototype,"_help",void 0),t([ce()],pn.prototype,"_wizardStep",void 0),t([ce()],pn.prototype,"_offerWizard",void 0),t([ce()],pn.prototype,"_wizard",void 0),t([ce()],pn.prototype,"_wizardAdvanced",void 0),t([ce()],pn.prototype,"_history",void 0),t([ce()],pn.prototype,"_future",void 0),t([ce()],pn.prototype,"_keys",void 0),t([ce()],pn.prototype,"_book",void 0),t([ce()],pn.prototype,"_bookOpen",void 0),t([ce()],pn.prototype,"_newGroup",void 0),t([ce()],pn.prototype,"_draftGroups",void 0),t([ce()],pn.prototype,"_prefs",void 0),t([ce()],pn.prototype,"_plainColours",void 0),t([ce()],pn.prototype,"_settingsOpen",void 0),t([ce()],pn.prototype,"_helpKey",void 0),t([ce()],pn.prototype,"_membersAdvanced",void 0),t([ce()],pn.prototype,"_report",void 0),t([ce()],pn.prototype,"_saved",void 0),pn=t([re("dialog-scheduler-plan")],pn);var mn=Object.freeze({__proto__:null,get DialogSchedulerPlan(){return pn}});
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */class _n extends da{constructor(e){if(super(e),this.et=q,e.type!==na)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===q||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}_n.directiveName="unsafeHTML",_n.resultType=1;const gn=ra(_n);var vn=window&&window.__assign||function(){return(vn=Object.assign||function(e){for(var t,i=1,s=arguments.length;i<s;i++)for(var a in t=arguments[i])Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a]);return e}).apply(this,arguments)};var fn={second:45,minute:45,hour:22,day:5};const bn=(e,t,i)=>{if(i===Pe.am_pm||!i&&t.time_format===Pe.am_pm){const t=Ie(e.getHours()).am_pm;return`${Ie(e.getHours()).hours}:${String(e.getMinutes()).padStart(2,"0")} ${t}`}return i===Pe.twenty_four||!i&&t.time_format===Pe.twenty_four?`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`:(()=>{try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}return!1})()?e.toLocaleTimeString(t.language,{hour:"numeric",minute:"2-digit",hour12:Le(t)}):Le(t)?bn(e,t,Pe.am_pm):bn(e,t,Pe.twenty_four)};let yn=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=function(e,t){const i=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1},s=(e,t)=>{switch(t){case"year":return e.getFullYear();case"month":return ko[e.getMonth()];case"day":return e.getDate()}};return e.getFullYear()==(new Date).getFullYear()?i()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}`:i()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):`${s(e,"month")} ${s(e,"day")}, ${s(e,"year")}`}(e,this._hass.locale):s>7?a=Yi("ui.components.date.next_week_day",this._hass,"{weekday}",Ds(e,"long",this._hass)):1==s?a=Yi("ui.components.date.tomorrow",this._hass):s>0&&(a=Ds(e,"long",this._hass));let o=Yi("ui.components.time.absolute",this._hass,"{time}",bn(e,this._hass.locale));return 12==e.getHours()&&0==e.getMinutes()?o=Yi("ui.components.time.at_noon",this._hass):0==e.getHours()&&0==e.getMinutes()&&(o=Yi("ui.components.time.at_midnight",this._hass)),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=ds("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=ds("ui.common.and",this._hass);return`${new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(this._hass.locale.language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=vn(vn({},fn),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var d=new Date(e),l=new Date(t),c=d.getFullYear()-l.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var h=12*c+d.getMonth()-l.getMonth();if(Math.round(Math.abs(h))>0)return{value:Math.round(h),unit:"month"};var u=a/604800;return{value:Math.round(u),unit:"week"}}(e);return new Intl.RelativeTimeFormat(this._hass.language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return H``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),H`
      ${rs(this.relativeTime(this.datetime))}
    `}};t([le()],yn.prototype,"_hass",void 0),t([le()],yn.prototype,"datetime",void 0),yn=t([re("scheduler-relative-time")],yn);let wn=class extends oe{render(){var e,t,i,s,a;try{const o=this.hass.states[this.schedule.entity_id];if(!o)return H``;const n=["off","completed"].includes(o.state),r=this.schedule.entries[0].slots[this.schedule.next_entries[0]||0].actions[0];let d=Ua(r,this.config.customize);if("entity"==(null===(e=this.config.display_options)||void 0===e?void 0:e.icon)){let e=[(null===(t=r.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Qi(r.service))&&(e=r.service),e&&(d=ga(e,this.config.customize,this.hass))}const l=![(null===(i=r.target)||void 0===i?void 0:i.entity_id)||[]].flat().every(e=>Object.keys(this.hass.states).includes(e));return l&&(d="mdi:help"),H`
      <ha-icon
        icon="${d}"
      ...
      <div class="state">
        ${!1!==this.config.show_toggle_switches?H`<ha-switch
    ...
    `}catch(e){return H`
      ...
      `}}renderDisplayItem(e){const t=e=>{const t=e.split("<relative-time></relative-time>");if(t.length>1){const e=this.schedule.timestamps[this.schedule.next_entries[0]||0];return H`
          ${t[0]?gn(t[0]):""}
          ...
          ${t[1]?gn(t[1]):""}
        `}if(null!==e.match(/^(<tag>[^<]*<\/tag>)+$/)){let t=e.split(/<tag>([^<]*)<\/tag>/).filter(e=>e);return H`
          <div class="tags">
            ${null==t?void 0:t.map(e=>H`<span class="tag">${e}</span>`)}
          </div>`}return gn(e)};return Ns(this.schedule,e,this.hass,this.config.customize).filter(e=>e.length).map(e=>H`${t(e)}<br/>`)}_handleItemClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_handleIconClick(e){const t=new CustomEvent("editClick",{detail:{schedule_id:this.schedule_id}});this.dispatchEvent(t)}_toggleEnableDisable(e){const t=e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return r`
      :host {
        display: flex;
        align-items: center;
        flex-direction: row;
    ...
    `}};t([le()],wn.prototype,"hass",void 0),t([le()],wn.prototype,"schedule_id",void 0),t([le()],wn.prototype,"schedule",void 0),t([le()],wn.prototype,"config",void 0),wn=t([re("scheduler-item-row")],wn);const kn=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday],xn=(e,t=new Date)=>{const i=kn[t.getDay()],s=i===_e.Friday||i===_e.Saturday,a=e.findIndex(e=>e.weekdays.includes(i)),o=a>=0?a:e.findIndex(e=>s?e.weekdays.includes(_e.Weekend):e.weekdays.includes(_e.Workday)),n=o>=0?o:e.findIndex(e=>e.weekdays.includes(_e.Daily)),r=n>=0?n:0;return{entry:e[r],index:r}},$n=[_e.Sunday,_e.Monday,_e.Tuesday,_e.Wednesday,_e.Thursday,_e.Friday,_e.Saturday],Sn=(e,t)=>{const i=$n[t.getDay()],s=i===_e.Friday||i===_e.Saturday;return!!e.weekdays.includes(_e.Daily)||(!!e.weekdays.includes(i)||(!(!s||!e.weekdays.includes(_e.Weekend))||!(s||!e.weekdays.includes(_e.Workday))))};let jn=null;const On=e=>{jn=e},zn="scheduler-overview-slot-select";let Cn=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this.selectedSlot=null,this._onExternalSelect=e=>{var t;(null===(t=e.detail)||void 0===t?void 0:t.source)!==this&&null!==this.selectedSlot&&(this.selectedSlot=null,this.dispatchEvent(new CustomEvent("slot-selected",{detail:{index:null},bubbles:!0,composed:!0})))},this._handleKeyDown=e=>{var t,i;if(!this.editable)return;if(null===this.selectedSlot)return;const s="ArrowLeft"===e.key||"ArrowRight"===e.key;if("Delete"!==e.key&&"Backspace"!==e.key&&!s)return;const a=e.composedPath()[0];if(a instanceof HTMLElement&&(["input","textarea","select"].includes(a.tagName.toLowerCase())||a.isContentEditable))return;if(s)return e.preventDefault(),void this._nudgeSelected("ArrowRight"===e.key?1:-1);const o=this._slots;if(o.length<=2)return;const n=this.selectedSlot,r=n===o.length-1?n-1:n;if(void 0===(null===(t=o[r])||void 0===t?void 0:t.stop)||void 0===(null===(i=o[r+1])||void 0===i?void 0:i.stop))return;e.preventDefault();let d=[...o.slice(0,r),Object.assign(Object.assign({},o[r+1]),{start:o[r].start,stop:o[r+1].stop}),...o.slice(r+2)];d=Wa(d),this._liveSlots=d,this.selectedSlot=null,this.dispatchEvent(new CustomEvent("slot-selected",{detail:{index:null},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("slots-changed",{detail:{slots:d},bubbles:!0,composed:!0}))}}get _slots(){return this._liveSlots||this.slots}get _contentWidth(){return this.viewportWidth*this.zoom}connectedCallback(){super.connectedCallback(),document.addEventListener(zn,this._onExternalSelect),window.addEventListener("keydown",this._handleKeyDown)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(zn,this._onExternalSelect),window.removeEventListener("keydown",this._handleKeyDown)}_nudgeSelected(e){var t;const i=this._slots,s=this.selectedSlot,a="rtl"===getComputedStyle(this).direction?e<0:e>0,o=s<i.length-1?s:s-1;if(o<0||!(null===(t=i[o])||void 0===t?void 0:t.stop)||!i[o+1])return;if([we.Sunrise,we.Sunset].includes(De(i[o+1].start).mode))return;const n=60*this._dragStepSize,r=Te(i[o].stop,this.hass),d=o>0?Te(i[o-1].stop||i[o-1].start,this.hass)+n:n,l=(Te(i[o+1].stop||i[o+1].start,this.hass)||86400)-n,c=Math.min(Math.max(r+(a?n:-n),d),l);if(c===r)return;const h={mode:we.Fixed,hours:Math.floor(c/3600),minutes:Math.round(c%3600/60)},u=Re(Ee(h,this._dragStepSize)),p=Object.assign([...i],{[o]:Object.assign(Object.assign({},i[o]),{stop:u}),[o+1]:Object.assign(Object.assign({},i[o+1]),{start:u})});this._liveSlots=p,this.dispatchEvent(new CustomEvent("slots-changed",{detail:{slots:p},bubbles:!0,composed:!0}))}updated(e){var t;e.has("slots")&&(this._liveSlots=void 0);const i=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(".content-inner");i&&(i.style.direction=getComputedStyle(this).direction)}_handleWheel(e){if(!this.viewportWidth||!this.editable)return;const t=e.ctrlKey||e.metaKey||Math.abs(e.deltaY)>=Math.abs(e.deltaX);e.preventDefault();const i=e.currentTarget.getBoundingClientRect(),s=e.clientX-i.left;if(t){const t=Math.pow(2,-e.deltaY/60);this.dispatchEvent(new CustomEvent("overview-zoom",{detail:{anchorPx:s,factor:t},bubbles:!0,composed:!0}))}else this.dispatchEvent(new CustomEvent("overview-pan",{detail:{deltaPx:e.deltaX},bubbles:!0,composed:!0}))}_touchDistance(e){const t=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.hypot(t,i)}_handlePinchStart(e){if(2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect();this._pinch={distance:this._touchDistance(e.touches),midpointX:(e.touches[0].clientX+e.touches[1].clientX)/2-t.left}}_handlePinchMove(e){if(!this._pinch||2!==e.touches.length)return;e.preventDefault();const t=this._touchDistance(e.touches),i=t/this._pinch.distance;this.dispatchEvent(new CustomEvent("overview-zoom",{detail:{anchorPx:this._pinch.midpointX,factor:i},bubbles:!0,composed:!0})),this._pinch.distance=t}_handlePinchEnd(e){e.touches.length<2&&(this._pinch=void 0)}render(){var e;if(!this.hass||!(null===(e=this.slots)||void 0===e?void 0:e.length)||!this.viewportWidth)return H``;const t=this._slots,i=oo(t,this.hass,this._contentWidth,2),s=Le(this.hass.locale),{boundaries:a,maxTier:o}=no(t,i,s,2),n="rtl"===getComputedStyle(this).direction?"50%":"-50%",r=15+13*o;return H`
      <div
        class="viewport"
        @wheel=${this._handleWheel}
        @touchstart=${this._handlePinchStart}
      ...
      >
        <div
          class="zoom-content"
          style=${la({width:this._contentWidth+"px",transform:`translateX(${-this.panPx}px)`})}
        >
          <div class="content-inner">
            <div class="boundaries" style=${la({height:r+"px"})}>
              ${a.map(e=>H`
                <div
                  class="boundary ${e.align}"
                  style=${la(Object.assign(Object.assign({},"end"===e.align?{insetInlineEnd:this._contentWidth-e.position+"px"}:{insetInlineStart:e.position+"px"}),"middle"===e.align?{transform:`translateX(${n})`}:{}))}
                >
                  <span class="boundary-label ${e.state}" style=${la(e.color?{color:e.color}:{})}>${e.label}</span>
                  <span class="boundary-line" style=${la({height:4+13*e.tier+"px"})}></span>
                </div>
              `)}
            </div>
            <div class="bar">
              ${t.map((e,s)=>{const a=e.actions.length?Za(e.actions[0])?"off":Ka(e.actions[0])?"on":"":"empty",o=e.actions.length?so(e.actions[0]):null,n=t[s+1];return H`
                  <div
                    class="seg ${a} ${this.selectedSlot===s?"selected":""}"
                    style=${la(Object.assign({width:i[s]+"px"},o?{background:`rgba(${o.rgb.join(", ")}, ${o.alpha})`}:{}))}
                    @pointerdown=${e=>this._handleSegPointerDown(e,s)}
                  ></div>
                  ${s<t.length-1&&e.stop?H`
                    <div
                    ...
                    >
                      <span><ha-svg-icon .path=${ta}></ha-svg-icon></span>
                    </div>
                  `:""}
                `})}
              ${void 0!==this.now?H`
                <div
                  class="now-line"
                  style=${la({insetInlineStart:(3600*this.now.getHours()+60*this.now.getMinutes()+this.now.getSeconds())/86400*this._contentWidth+"px"})}
                ></div>
              `:""}
              ${this._createRange?H`
                <div
                  class="create-overlay"
                  style=${la({insetInlineStart:this._createRange.ts0/86400*this._contentWidth+"px",width:(this._createRange.ts1-this._createRange.ts0)/86400*this._contentWidth+"px"})}
                ></div>
              `:""}
            </div>
          </div>
    ...
    `}};t([le({attribute:!1})],Cn.prototype,"hass",void 0),t([le({attribute:!1})],Cn.prototype,"config",void 0),t([le({attribute:!1})],Cn.prototype,"slots",void 0),t([le({type:Number})],Cn.prototype,"zoom",void 0),t([le({type:Number})],Cn.prototype,"panPx",void 0),t([le({type:Number})],Cn.prototype,"viewportWidth",void 0),t([le({type:Boolean})],Cn.prototype,"editable",void 0),t([le({attribute:!1})],Cn.prototype,"now",void 0),t([ce()],Cn.prototype,"selectedSlot",void 0),t([ce()],Cn.prototype,"_liveSlots",void 0),t([ce()],Cn.prototype,"_createRange",void 0),Cn=t([re("scheduler-overview-bar")],Cn);let En=class extends oe{_fire(e){this.dispatchEvent(new CustomEvent("action-changed",{detail:{action:e}}))}_setOnOff(e){const t=Qi(this.entityId);this._fire({service:`${t}.${e?"turn_on":"turn_off"}`,service_data:{},target:{entity_id:this.entityId}})}_setParam(e,t){if(!this.action)return;const i=Object.assign(Object.assign({},this.action.service_data),{[e]:t});"color_temp_kelvin"===e&&delete i.rgb_color,this._fire(Object.assign(Object.assign({},this.action),{service_data:i}))}_setColor(e){if(!this.action)return;const t=[1,3,5].map(t=>parseInt(e.substr(t,2),16)),i=Object.assign(Object.assign({},this.action.service_data),{rgb_color:t});delete i.color_temp_kelvin,this._fire(Object.assign(Object.assign({},this.action),{service_data:i}))}_renderParams(){var e,t,i,s;const a=this.action;if(!a||"light"!==Qi(a.service)||!Ka(a))return q;const o=(null===(t=null===(e=this.hass.states[this.entityId])||void 0===e?void 0:e.attributes)||void 0===t?void 0:t.supported_color_modes)||[],n=o.includes("color_temp"),r=["hs","rgb","rgbw","rgbww","xy"].some(e=>o.includes(e)),d=a.service_data||{},l=d.rgb_color,c=Array.isArray(l)&&l.length>=3?"#"+l.slice(0,3).map(e=>Math.round(e).toString(16).padStart(2,"0")).join(""):"#ffb46b";return H`
      <div class="params">
        <label>
    ...
    `}render(){if(!this.hass||!this.entityId)return H``;const e=!!this.action&&Ka(this.action),t=!!this.action&&Za(this.action);return H`
    ...
    `}};t([le({attribute:!1})],En.prototype,"hass",void 0),t([le({attribute:!1})],En.prototype,"action",void 0),t([le()],En.prototype,"entityId",void 0),En=t([re("scheduler-overview-action-panel")],En);let An=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this.spanDays=1,this._saveState=null,this._selectedSlot=null,this._undoStack=[]}render(){var e,t,i;try{const s=this.hass.states[this.schedule.entity_id];if(!s)return H``;const a=["off","completed"].includes(s.state),{entry:o,index:n}=xn(this.schedule.entries,this.date),r=this.date||new Date,d=Sn(o,r),l=new Date(r.getTime()+864e5),c=2===this.spanDays?xn(this.schedule.entries,l):null,h=!!c&&Sn(c.entry,l),u=2===this.spanDays?this.viewportWidth/2:this.viewportWidth,p=null===(e=o.slots.find(e=>e.actions.length))||void 0===e?void 0:e.actions[0];let m="mdi:calendar-clock";if(p){let e=[(null===(t=p.target)||void 0===t?void 0:t.entity_id)||[]].flat().shift();["script","notify"].includes(Qi(p.service))&&(e=p.service),e&&(m=ga(e,this.config.customize,this.hass))}const _=p?Ls(["script","notify"].includes(Qi(p.service))?p.service:[(null===(i=p.target)||void 0===i?void 0:i.entity_id)||[]].flat()[0]||"",this.hass,this.config.customize):this.schedule.name||this.schedule.entity_id;return H`
      ...
      `}catch(e){return H``}}_handleSlotSelected(e){e.stopPropagation(),this._selectedSlot=e.detail.index}_renderActionPanel(e,t){var i,s,a,o;const n=this._selectedSlot;if(!this.editable||null===n||!e[n])return"";const r=e[n].actions[0];if(r&&!Ka(r)&&!Za(r))return"";const d=[(null===(i=null==r?void 0:r.target)||void 0===i?void 0:i.entity_id)||[]].flat()[0]||[(null===(o=null===(a=null===(s=e.find(e=>e.actions.length))||void 0===s?void 0:s.actions[0])||void 0===a?void 0:a.target)||void 0===o?void 0:o.entity_id)||[]].flat()[0];return d?H`
    ...
    `}};t([le()],An.prototype,"hass",void 0),t([le()],An.prototype,"schedule_id",void 0),t([le()],An.prototype,"schedule",void 0),t([le()],An.prototype,"config",void 0),t([le({attribute:!1})],An.prototype,"date",void 0),t([le({type:Number})],An.prototype,"zoom",void 0),t([le({type:Number})],An.prototype,"panPx",void 0),t([le({type:Number})],An.prototype,"viewportWidth",void 0),t([le({type:Boolean})],An.prototype,"editable",void 0),t([le({attribute:!1})],An.prototype,"now",void 0),t([le({type:Number})],An.prototype,"spanDays",void 0),t([ce()],An.prototype,"_saveState",void 0),t([ce()],An.prototype,"_selectedSlot",void 0),An=t([re("scheduler-overview-row")],An);let Dn=class extends oe{_t(e,t,i){return Yi("ui.panel.plan."+e,this.hass,t||[],i||[])}_when(e,t=!0){var i;return e?new Intl.DateTimeFormat((null===(i=this.hass.locale)||void 0===i?void 0:i.language)||"en",Object.assign(Object.assign({},t?{weekday:"short"}:{}),{hour:"2-digit",minute:"2-digit"})).format(e):"—"}render(){var e;const t=this.hass.states[this.schedule.entity_id],i=!t||["off","completed"].includes(t.state);let s,a;try{const e=Go(this.schedule);s=en(e,this.hass),a=Po(e.endAnchor+"+00:00:00",this.hass)}catch(e){return q}const o=new Date,n=s.stretches.filter(e=>e.from&&e.to),r=n.find(e=>e.from<=o&&e.to>o),d=n.find(e=>e.from>o),l=new Set(s.stretches.flatMap(e=>e.devices.map(e=>e.entity_id)));return H`
      <div class="row ${i?"disabled":""}">
        <ha-svg-icon .path=${Bs} @click=${this._edit}></ha-svg-icon>

        <div class="info" @click=${this._edit}>
          <div class="name">
            ${this.schedule.name||this._t("title")}
            ${i?H`<span class="off-badge">${this._t("row.paused")}</span>`:q}
          </div>

          <div class="band">
            ${this._t("row.band",["{from}","{to}"],[this._when(s.opens),this._when(a)])}
          </div>

          <div class="parts">
            ${n.map(e=>H`
            <span class="part ${e===r?"now":""}">
              <span class="part-at">${this._when(e.from,!1)}</span>
              ${e.name}
            </span>`)}
          </div>

          <div class="foot">
            ${this._t("row.summary",["{parts}","{devices}"],[String(n.length),String(l.size)])}
            ${r?H`<span class="dot-sep">·</span>${this._t("row.now","{name}",r.name)}`:d?H`<span class="dot-sep">·</span>${this._t("row.next",["{name}","{time}"],[d.name,this._when(d.from)])}`:q}
          </div>
        </div>

        <div class="state">
          ${!1!==(null===(e=this.config)||void 0===e?void 0:e.show_toggle_switches)?H`<ha-switch
              ?checked=${!i}
              @change=${this._toggle}
            ></ha-switch>`:q}
        </div>
      </div>
    `}_edit(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("editClick",{bubbles:!0,composed:!0}))}_toggle(e){const t=e.target.checked;this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:this.schedule.entity_id})}static get styles(){return r`
      :host { display: block; }
      .row {
        display: flex;
        align-items: flex-start;
    ...
    `}};t([le()],Dn.prototype,"hass",void 0),t([le()],Dn.prototype,"schedule_id",void 0),t([le()],Dn.prototype,"schedule",void 0),t([le()],Dn.prototype,"config",void 0),Dn=t([re("scheduler-plan-row")],Dn);let Tn=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.minZoom=1,this.maxZoom=48,this.spanDays=1,this._width=0}get _contentWidth(){return this._width*this.zoom}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=Math.max(0,t.contentRect.width-158);e!==this._width&&(this._width=e,this.dispatchEvent(new CustomEvent("viewport-width-changed",{detail:{width:e},bubbles:!0,composed:!0})))}}),this._resizeObserver.observe(this)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this._resizeObserver)||void 0===e||e.disconnect()}_fireZoom(e){this.dispatchEvent(new CustomEvent("overview-zoom",{detail:e,bubbles:!0,composed:!0}))}_fireReset(){this.dispatchEvent(new CustomEvent("overview-zoom-reset",{bubbles:!0,composed:!0}))}_handleWheel(e){if(!this._width||2===this.spanDays)return;const t=e.ctrlKey||e.metaKey||Math.abs(e.deltaY)>=Math.abs(e.deltaX);e.preventDefault();const i=e.currentTarget.getBoundingClientRect(),s=e.clientX-i.left;if(t){const t=Math.pow(2,-e.deltaY/60);this._fireZoom({anchorPx:s,factor:t})}else this.dispatchEvent(new CustomEvent("overview-pan",{detail:{deltaPx:e.deltaX},bubbles:!0,composed:!0}))}_handlePanStart(e){this.zoom<=this.minZoom||(e.currentTarget.setPointerCapture(e.pointerId),this._panDrag={pointerId:e.pointerId,startX:e.clientX})}_handlePanMove(e){if(!this._panDrag||this._panDrag.pointerId!==e.pointerId)return;const t=e.clientX-this._panDrag.startX;this._panDrag.startX=e.clientX,this.dispatchEvent(new CustomEvent("overview-pan",{detail:{deltaPx:-t},bubbles:!0,composed:!0}))}_handlePanEnd(){this._panDrag=void 0}_touchDistance(e){const t=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.hypot(t,i)}_handlePinchStart(e){if(2!==e.touches.length)return;e.preventDefault();const t=this.getBoundingClientRect();this._pinch={distance:this._touchDistance(e.touches),midpointX:(e.touches[0].clientX+e.touches[1].clientX)/2-t.left-158}}_handlePinchMove(e){if(!this._pinch||2!==e.touches.length)return;e.preventDefault();const t=this._touchDistance(e.touches),i=t/this._pinch.distance;this._fireZoom({anchorPx:this._pinch.midpointX,factor:i}),this._pinch.distance=t}_handlePinchEnd(e){e.touches.length<2&&(this._pinch=void 0)}render(){if(!this.hass)return H``;const e=Le(this.hass.locale),t=2===this.spanDays?[...ao(this._contentWidth/2,e),...ao(this._contentWidth/2,e)].map(e=>Object.assign(Object.assign({},e),{widthPct:e.widthPct/2})):ao(this._contentWidth,e),i=Math.round(100*this.zoom),s=void 0!==this.now&&1===this.spanDays?Math.round(this.now.getHours()+this.now.getMinutes()/60)%24:null;return H`
      ...
      >
        ...
        <div
          ...
          style=${la({cursor:this.zoom>this.minZoom?"grab":"default"})}
        ...
        >
          <div class="ruler" style=${la({width:this._contentWidth+"px",transform:`translateX(${-this.panPx}px)`})}>
            ${2===this.spanDays?H`<div class="day-split">
                ${(this.dayLabels||[]).map(e=>H`<span class="day-name">${e}</span>`)}
              </div>`:""}
            ${t.map(t=>{const i={mode:we.Fixed,hours:t.hour,minutes:0},a=Re(i,{seconds:!1,am_pm:e}),o="left"===t.align?"left":"right"===t.align?"right":"",n=t.hour===s||0===t.hour&&24===s;return H`
                <span class="${o} ${n?"now":""}" style=${la({width:t.widthPct+"%"})}>${a}</span>
              `})}
          </div>
        </div>
      </div>
    ...
    `}updated(){var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".ruler");t&&(t.style.direction=getComputedStyle(this).direction)}};t([le({attribute:!1})],Tn.prototype,"hass",void 0),t([le({attribute:!1})],Tn.prototype,"now",void 0),t([le({type:Number})],Tn.prototype,"zoom",void 0),t([le({type:Number})],Tn.prototype,"panPx",void 0),t([le({type:Number})],Tn.prototype,"minZoom",void 0),t([le({type:Number})],Tn.prototype,"maxZoom",void 0),t([le({type:Number})],Tn.prototype,"spanDays",void 0),t([le({attribute:!1})],Tn.prototype,"dayLabels",void 0),t([ce()],Tn.prototype,"_width",void 0),Tn=t([re("scheduler-overview-ruler")],Tn);const Mn=()=>({type:ge.Or,items:[],track_changes:!1}),Pn=e=>({service:Qi(e)+".turn_on",service_data:{},target:{entity_id:e}}),Ln=e=>({service:Qi(e)+".turn_off",service_data:{},target:{entity_id:e}});let Nn=class extends oe{constructor(){super(...arguments),this.zoom=1,this.panPx=0,this.viewportWidth=0,this.editable=!0,this._picking=!1,this._entityId=null,this._slots=[],this._selectedSlot=null,this._saving=!1}_reset(){this._picking=!1,this._entityId=null,this._slots=[],this._selectedSlot=null}_startPicking(){this._picking=!0}_handleEntityPicked(e){var t;const i=null===(t=e.detail)||void 0===t?void 0:t.value,s=Array.isArray(i)?i[i.length-1]:i;s&&(this._entityId=s,this._picking=!1,this._slots=[{start:"00:00:00",stop:"08:00:00",actions:[Ln(s)],conditions:Mn()},{start:"08:00:00",stop:"16:00:00",actions:[Pn(s)],conditions:Mn()},{start:"16:00:00",stop:"00:00:00",actions:[Ln(s)],conditions:Mn()}],this._selectedSlot=null)}_handleSlotsChanged(e){e.stopPropagation(),this._slots=e.detail.slots}_handleSlotSelected(e){e.stopPropagation(),this._selectedSlot=e.detail.index}_handleActionChanged(e){const t=this._selectedSlot;null!==t&&(this._slots=Object.assign([...this._slots],{[t]:Object.assign(Object.assign({},this._slots[t]),{actions:[e.detail.action]})}))}async _save(){if(!this._slots.length)return;this._saving=!0;const e={entries:[{weekdays:[_e.Daily],slots:this._slots}],repeat_type:ye.Repeat,next_entries:[],timestamps:[],enabled:!0};try{await Ma(this.hass,e),this._reset()}catch(e){Ha(e,this,this.hass)}finally{this._saving=!1}}render(){var e,t;if(!this.hass)return H``;const i=this._selectedSlot;return H`
      <div class="row">
        <div class="device">
          ${null!==this._entityId||this._picking?this._picking?H`
            <scheduler-entity-picker
              .hass=${this.hass}
              .config=${this.config}
          ...
          `:H`
            <div class="draft-device">
              ...
              <ha-icon-button .path=${Zs} @click=${this._reset} class="cancel"></ha-icon-button>
              <ha-icon-button
    ...
    `}};t([le({attribute:!1})],Nn.prototype,"hass",void 0),t([le({attribute:!1})],Nn.prototype,"config",void 0),t([le({type:Number})],Nn.prototype,"zoom",void 0),t([le({type:Number})],Nn.prototype,"panPx",void 0),t([le({type:Number})],Nn.prototype,"viewportWidth",void 0),t([le({type:Boolean})],Nn.prototype,"editable",void 0),t([ce()],Nn.prototype,"_picking",void 0),t([ce()],Nn.prototype,"_entityId",void 0),t([ce()],Nn.prototype,"_slots",void 0),t([ce()],Nn.prototype,"_selectedSlot",void 0),t([ce()],Nn.prototype,"_saving",void 0),Nn=t([re("scheduler-overview-add-row")],Nn);let In=class extends oe{constructor(){super(...arguments),this.date=new Date,this.spanDays=1}_select(e){this.dispatchEvent(new CustomEvent("date-changed",{detail:{date:e},bubbles:!0,composed:!0}))}_toggleSpan(){this.dispatchEvent(new CustomEvent("span-changed",{detail:{spanDays:2===this.spanDays?1:2},bubbles:!0,composed:!0}))}render(){if(!this.hass)return H``;const e=new Date;e.setHours(0,0,0,0);const t=Ts(this.hass),i=(e.getDay()-t+7)%7,s=new Date(e.getTime()-864e5*i),a=Array.from({length:7},(e,t)=>new Date(s.getTime()+864e5*t)),o=new Date(this.date);return o.setHours(0,0,0,0),H`
      <div class="daybar">
        <div class="days">
          ${a.map(t=>{var i;const s=t.getTime()===o.getTime(),a=t.getTime()===e.getTime(),n=t.toLocaleDateString((null===(i=this.hass.locale)||void 0===i?void 0:i.language)||void 0,{weekday:"short"});return H`
              <button
    ...
    `}};t([le({attribute:!1})],In.prototype,"hass",void 0),t([le({attribute:!1})],In.prototype,"date",void 0),t([le({type:Number})],In.prototype,"spanDays",void 0),In=t([re("scheduler-overview-daybar")],In);e.SchedulerCard=class extends oe{constructor(){super(...arguments),this._config={},this.showDiscovered=!1,this.overviewMode=!0,this._overviewZoom=1,this._overviewPanPx=0,this._overviewViewportWidth=0,this._now=new Date,this._viewDate=new Date,this._spanDays=1,this.translationsLoaded=!1,this.connectionError=!1,this._handleUndoKeyDown=e=>{if("z"!==e.key.toLowerCase()||!e.ctrlKey&&!e.metaKey||e.shiftKey)return;const t=e.composedPath()[0];if(t instanceof HTMLElement&&(["input","textarea","select"].includes(t.tagName.toLowerCase())||t.isContentEditable))return;const i=(()=>{const e=jn;return jn=null,e})();i&&(e.preventDefault(),i())}}get _quickAddEnabled(){return!1!==this._config.show_quick_add}get _overviewEditingEnabled(){return!1!==this._config.overview_editing}get _isToday(){const e=new Date(this._viewDate);e.setHours(0,0,0,0);const t=new Date;return t.setHours(0,0,0,0),e.getTime()===t.getTime()}_dayLabel(e){var t,i;return new Date(this._viewDate.getTime()+24*e*3600*1e3).toLocaleDateString((null===(i=null===(t=this.hass)||void 0===t?void 0:t.locale)||void 0===i?void 0:i.language)||void 0,{weekday:"long"})}async setConfig(e){e=(e=>{let t=[];Xe(e,"include")&&!et(e.include)&&t.push("'include' must be a list of strings"),Xe(e,"exclude")&&!et(e.exclude)&&t.push("'exclude' must be a list of strings"),Xe(e,"discover_existing")&&!Ge(e.discover_existing)&&t.push("'discover_existing' must be a boolean"),!Xe(e,"title")||Ge(e.title)||Je(e.title)||t.push("'title' must be a boolean or string"),Xe(e,"time_step")&&(!Ye(e.time_step)||Number(e.time_step)<1||Number(e.time_step)>30)&&t.push("'time_step' must be a number between 1 and 30"),Xe(e,"show_header_toggle")&&!Ge(e.show_header_toggle)&&t.push("'show_header_toggle' must be a boolean"),Xe(e,"show_add_button")&&!Ge(e.show_add_button)&&t.push("'show_add_button' must be a boolean"),Xe(e,"show_toggle_switches")&&!Ge(e.show_toggle_switches)&&t.push("'show_toggle_switches' must be a boolean"),Xe(e,"default_view")&&!["overview","list"].includes(e.default_view)&&t.push("'default_view' must be either 'overview' or 'list'");for(const i of["show_view_toggle","show_clock","overview_editing","show_quick_add"])Xe(e,i)&&!Ge(e[i])&&t.push(`'${i}' must be a boolean`);if(Xe(e,"display_options")&&(Qe(e.display_options)?(!Xe(e.display_options,"primary_info")||Je(e.display_options.primary_info)||et(e.display_options.primary_info)||t.push("in 'display_options': 'primary_info' must be a string or list of strings"),!Xe(e.display_options,"secondary_info")||Je(e.display_options.secondary_info)||et(e.display_options.secondary_info)||t.push("in 'display_options': 'secondary_info' must be a string or list of strings"),!Xe(e.display_options,"icon")||Je(e.display_options.icon)&&["action","entity"].includes(e.display_options.icon)||t.push("in 'display_options': 'icon' must be a set to either 'action' or 'entity' ")):t.push("'display_options' must be a struct")),!Xe(e,"sort_by")||Je(e.sort_by)||et(e.sort_by)||t.push("'sort_by' must be a string or list of strings"),Xe(e,"customize")&&!Qe(e.customize))t.push("'customize' must be a struct");else if(Xe(e,"customize")){let i=Object.entries(e.customize).map(([e,t])=>tt(e,t)).filter(Ke);i.length&&t.push(...i)}if(!Xe(e,"tags")||Je(e.tags)||et(e.tags)||t.push("'tags' must be a string or list of strings"),!Xe(e,"exclude_tags")||Je(e.tags)||et(e.tags)||t.push("'exclude_tags' must be a string or list of strings"),t.length)throw new Error(`Invalid configuration provided (${t.length} error${t.length>1?"s":""}): ${t.join(", ")}.`);return e})(e),this._config=Object.assign({},e),e.default_view&&(this.overviewMode=e.default_view===pe.Overview)}async firstUpdated(){await(async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-generic-picker"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()})();document.querySelector("home-assistant")._loadFragmentTranslations(this.hass.language,"config"),await Vs(this.hass).then(e=>{e=Object.fromEntries(Object.entries(e).filter(([e])=>as(e,this._config))),this._config=Object.assign(Object.assign({},this._config),{customize:Object.assign(Object.assign({},e),this._config.customize||{})})})}willUpdate(){this.hass.loadBackendTranslation("services")}__checkSubscribed(){void 0===this.__unsubs&&this.isConnected&&void 0!==this.hass&&(this.__unsubs=this.hassSubscribe())}connectedCallback(){super.connectedCallback(),this.__checkSubscribed(),window.addEventListener("keydown",this._handleUndoKeyDown),this._clockInterval=window.setInterval(()=>{this._now=new Date},3e4)}disconnectedCallback(){if(super.disconnectedCallback(),window.removeEventListener("keydown",this._handleUndoKeyDown),this._clockInterval&&clearInterval(this._clockInterval),this.__unsubs){for(;this.__unsubs.length;){const e=this.__unsubs.pop();e instanceof Promise?e.then(e=>e()):e()}this.__unsubs=void 0}}updated(e){super.updated(e),e.has("hass")&&this.__checkSubscribed()}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.handleScheduleItemUpdated(e),{type:"scheduler_updated"})]}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!this.translationsLoaded&&ds("component.input_boolean.services.turn_on.name",this.hass,!1).length&&ds("ui.panel.config.automation.editor.conditions.type.sun.sunrise",this.hass,!1).length?(this.translationsLoaded=!0,!0):!t||1!=e.size||!this.schedules||Object.values(this.schedules).some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}render(){let e=[...this.schedules||[]],t=e.filter(e=>os(e,this._config)),i=e.filter(e=>!os(e,this._config));const s=this.showDiscovered?e.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")}):t.some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")});return H`
      <ha-card>
        <div class="card-header">
          ...
          ${this.overviewMode&&!1!==this._config.show_clock?H`<div class="clock">${this._formatClock()}</div>`:""}
          ...
          ${!1!==this._config.show_view_toggle?H`
          <ha-icon-button
            class="view-toggle"
          ...
          `:""}
          ${Object.keys(this.schedules||{}).length&&this._config.show_header_toggle?H`
          <ha-switch
            ?checked=${s}
    ...
    ${this.overviewMode&&!this.connectionError&&(t.length||this._quickAddEnabled)?H`
    ...
    ${this.connectionError?H`
      ...
      `:Object.keys(e).length?t.map(e=>this._renderRow(e)):H`
        <div>
          ${Yi("ui.panel.overview.no_entries",this.hass)}
        </div>
        `}

      ${this.overviewMode&&!this.connectionError&&this._quickAddEnabled?H`
      ...
      ${Object.keys(e).length>t.length&&!1!==this._config.discover_existing?this.showDiscovered?H`
        ...
        ${!1!==this._config.show_add_button?H`
        <div class="card-actions">
          ${this.connectionError?H`
          <ha-button appearance="plain" variant="warning" @click=${this._retryConnection}
            >${ds("ui.common.refresh",this.hass)}
          </ha-button>
            `:H`
          <ha-button appearance="plain" @click=${this._addClick}
            >${ds("ui.common.add",this.hass)}
          </ha-button>
          `}
        </div>`:""}
      </ha-card>
    `}async loadSchedules(){Oe(this.hass).then(e=>{this.schedules=Hs(e,this._config,this.hass)}).catch(e=>{this.schedules=[],this.connectionError=!0})}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{var s;if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let a=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(a+=1);const o=(([(null===(s=this._config.display_options)||void 0===s?void 0:s.secondary_info)||[]].flat().length||2)+1)/2;this.schedules&&(a+=this.showDiscovered?Object.keys(this.schedules).length*o:Object.values(this.schedules).filter(e=>os(e,this._config)).length*o),clearInterval(i),e(Math.round(a))},50)})}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}async handleScheduleItemUpdated(e){"scheduler_item_removed"!=e.event?Rs(this.hass,e.schedule_id).then(t=>{const i=this.schedules.findIndex(t=>t.schedule_id==e.schedule_id),s=i>=0?this.schedules[i]:null;let a=[...this.schedules||[]];!t||!1===this._config.discover_existing&&!os(t,this._config)?s&&(a=a.filter(t=>t.schedule_id!==e.schedule_id)):s?s.timestamps[s.next_entries[0]||0]==t.timestamps[t.next_entries[0]||0]?a=Object.assign(a,{[i]:t}):(a=Object.assign(a,{[i]:t}),a=Hs(a,this._config,this.hass)):a=Hs([...a,t],this._config,this.hass),this.schedules=[...a]}):this.schedules=(this.schedules||[]).filter(t=>t.schedule_id!==e.schedule_id)}_renderRow(e){return Jo(e)?H`
        <scheduler-plan-row
          .hass=${this.hass}
          .config=${this._config}

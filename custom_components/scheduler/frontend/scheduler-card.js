  ...
  ha-list-item.warning, ha-list-item.warning ha-icon {
    ...
    `}_renderWizardParts(){const e=new Set(this._wizard.moments.map(e=>e.name)),t=this._prefs.moments.filter(t=>!e.has(this._t("wizard.preset."+t.key)));return H`
      <div class="wizard-parts">
        ...
        <ol class="part-list">
          ${this._wizard.moments.map((e,t)=>H`
          <li class="part-row">
    ...
    `}_renderWizardPart(e){const t=this._wizard.moments.findIndex(t=>t.id==e.id),i=t>0?this._wizard.moments[t-1]:null,s=i?this._formatMoment(this._momentBoundary(i)):this._formatMoment(this._plan.startAnchor+"+00:00:00"),a=this._moment(this._momentBoundary(e)),o=this._momentCaution(e),n=!!(a&&this._bandStart&&this._bandEnd&&(a<=this._bandStart||a>=this._bandEnd)&&"sunset"!=e.when);return H`
      <div class="wizard-part">
        <p class="part-from">
          ${this._t("wizard.part.starts","{time}",i?`${i.name||this._t("cube.unnamed")} · ${s}`:s)}
        </p>
        ...
        <div class="field">
          ...
          <span class="field-resolved ${n?"wrong":""}">
            ${a?this._t("wizard.part.ends_at","{time}",this._formatMoment(this._momentBoundary(e))):this._t("wizard.part.ends_unknown")}
          </span>
          ${o&&a?H`<p class="wizard-warning ${n?"blocking":""}">
              <span class="mark">${n?"✕":"⚠"}</span>${o}
            </p>`:q}
        </div>
